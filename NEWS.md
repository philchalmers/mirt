...
- `empirical.plot()` gains an `org.data` argument to substitute unscored data in 
  when building emprical tranelines. Useful for simple distractor analysis visualization

...
- latent mean and variance terms in the Information matrix have been completely removed since they
  are not appropriate for computing unbiased standard errors or to be used in Wald tests. 
  Provides better condition number behaviour and second-order convergence tests as well

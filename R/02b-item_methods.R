...
Experimental_itemtypes <- function() c('experimental', 'grsmIRT', 'fivePL')

Valid_iteminputs <- function() c('Rasch', '2PL', '3PL', '3PLu', '4PL', '5PL',
...
ordinal_itemtypes <- function() c('dich', 'fivePL', 'graded', 'gpcm', 'sequential',

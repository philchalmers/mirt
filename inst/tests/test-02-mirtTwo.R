...
test_that('poly', {
    ...
    expect_equal(cfs, c(0.996,  1.005,  0.500, -0.512, -1.006, -1.000,  0.859,  1.005,  0.500, 
                        -0.512, -1.006, -0.769,  1.033,  1.005,  0.500, -0.512, -1.006,
                       -0.560,  0.946,  1.005,  0.500, -0.512, -1.006, -0.258,  0.991,  1.005,
                        0.500, -0.512, -1.006, -0.097,  0.902,  1.005,  0.500, -0.512,
                       -1.006,  0.167,  0.944,  1.005,  0.500, -0.512, -1.006,  0.346,  1.086, 
                        1.005,  0.500, -0.512, -1.006,  0.463,  0.889,  1.005,  0.500,
                       -0.512, -1.006,  0.765,  0.963,  1.005,  0.500, -0.512, -1.006,  0.980,  0.000,  1.000),
                 tollerance = 1e-2)    

...
test_that('poly', {
    ...
    expect_true(mirt:::closeEnough(abs(as.numeric(fm2[1:6,c('F1','F2')])) -
                                       abs(c(2.04735356450138, 1.96958947300338, 0.888153658043133, 
                                             1.67462458142634, 1.90609525357363, 0.145358843835871, 
                                             1.38473299800782, 0.085714004734617, 0.509817280807723, 
                                             0.926769201831192, 1.38319400786452, 1.32309187462193)),
                                   -1e-2, 1e-2))

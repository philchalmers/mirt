...
test_that('dich data', {
    ...
    cfs <- cfs[cfs != 0 & cfs != 1]
    expect_equal(cfs, c(1.1073, -1.0015, 1.153, -0.4998, -1.5158, 1.1235, 0.6414, 1.6411, 0.9848, 0.0717, 0.0694, 1.1502, 0.2449, 1.1029, 2, -0.9345, 1.6, 1.1502, -0.1396, 2.0786, -0.4023, 1.1264, 0.0704, 3.0944, 2.027, -0.4557, 0.997, 0.6156, 3.0811, 2.0627, -0.454, 0.8424, 0.6371, 2.4515, 0.9724, -0.9835, 1.0168, 0.5666, 2.0248, -0.0308, 0.8398, 0.759, -1.0135, 0.938, 0.5235, -1.3634, 0.8795, 0.4951, 1.5456, 0.9501, 0.7663, 0.0282),
                 tollerance = 1e-2)   

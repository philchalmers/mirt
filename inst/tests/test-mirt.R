...
test_that('dich', {
    ...
    expect_is(modm1, 'ExploratoryClass')          
    expect_is(modm2, 'ExploratoryClass')
    expect_is(modm3, 'ExploratoryClass')
    expect_is(modm4, 'ExploratoryClass')
    expect_is(modm5, 'ExploratoryClass')
...
test_that('poly', {
    ...
    expect_is(modp1, 'ExploratoryClass')          
    expect_is(modp2, 'ExploratoryClass')
    expect_is(modp3, 'ExploratoryClass')
    expect_is(modp4, 'ExploratoryClass')

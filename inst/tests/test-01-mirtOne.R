...
test_that('dich', {
    ...
    expect_equal(cfs, c(8.348, 11.635, 0.135, 0.893, 16.264, 3.85, 0.338, 0.877, 10.558, 5.953, 0.369, 0.933, 3.801, 4.059, 0.127, 0.703, 1.677, 3.265, 0.154, 0.91, 0, 1), tolerance = 1e-2)

...
test_that('confirmatory mods', {
    ...
    expect_equal(cfs, c(1.2752, 1.0234, 1.5271, 0, NA, NA, -0.9988, -1.1692, -0.8284, 0, NA, NA, 1, NA, NA, 0.5483, 0.3408, 0.7559, 0, NA, NA, -1.5089, -1.6352, -1.3825, 0, NA, NA, 1, NA, NA, 1.5097, NaN, NaN, 0, NA, NA, 1.7338, NaN, NaN, 0, NA, NA, 1, NA, NA, 1.0105, 0.9144, 1.1065, 0.8366, 0.7066, 0.9665, 0.0172, -0.1068, 0.1411, 0, NA, NA, 1, NA, NA, 0, NA, NA, 1.3883, 1.1576, 1.619, 3.0219, 2.7582, 3.2857, 2.0395, 1.8358, 2.2432, -0.5384, -0.6548, -0.4221, 0, NA, NA, 0.5644, 0.4885, 0.6403, 2.5901, 2.4236, 2.7566, 1.0599, 0.9555, 1.1643, -0.9355, -1.0362, -0.8349, 0, NA, NA, 1.0821, 0.9655, 1.1986, 2.0256, 1.8839, 2.1673, -0.0284, -0.1318, 0.075, 0, NA, NA, 1.0554, 0.8325, 1.2783, 1.0251, 0.9049, 1.1453, 0, NA, NA, 1, NA, NA, 0, NA, NA, 0, NA, NA, 1, NA, NA, 0.0751, NA, NA, 1, NA, NA),
                 tolerance = 1e-2)
    ...
    expect_equal(cfs, c(1.3379, 0, -1.0273, 0, 1, 0.5679, 0, -1.5183, 0, 1, 1.3811, 0, 1.6586, 0, 1, 0.9987, 0.8173, 0.0147, 0, 1, 0, 1.3452, 3.0019, 2.0285, -0.5264, 0, 0.5585, 2.5923, 1.0614, -0.933, 0, 1.0986, 2.0455, -0.0231, 0, 1.0399, 1.0287, 0, 1, 0, 0, 1, 1e-04, 1),
                 tolerance = 1e-2)

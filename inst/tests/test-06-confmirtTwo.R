...
test_that('confirmatory mods', {
    ...
    expect_equal(cfs, c(1.4404, 0.9703, 1.9104, 0, NA, NA, -0.928, -1.1255, -0.7304, 0, NA, NA, 1, NA, NA, 0.5379, 0.3519, 0.7239, 0, NA, NA, -1.4507, -1.5758, -1.3257, 0, NA, NA, 1, NA, NA, 0.7851, 0.7269, 0.8434, 0, NA, NA, 1.3396, 1.1905, 1.4886, 0, NA, NA, 1, NA, NA, 1.3087, NaN, NaN, 0.5335, 0.1941, 0.873, 0.0461, -0.0738, 0.166, 0, NA, NA, 1, NA, NA, 0, NA, NA, 1.4021, 1.1785, 1.6257, 2.8563, 2.6504, 3.0622, 1.8527, 1.7066, 1.9988, -0.4618, -0.5829, -0.3407, 0, NA, NA, 0.4311, 0.3106, 0.5515, 2.5296, 2.364, 2.6951, 0.9916, 0.8918, 1.0914, -1.0149, -1.1183, -0.9116, 0, NA, NA, 0.8428, 0.642, 1.0437, 1.8889, 1.7424, 2.0354, 0.079, -0.0173, 0.1753, 0, NA, NA, 0.9901, 0.7463, 1.2338, 1.0208, 0.8503, 1.1913, 0, NA, NA, 1, NA, NA, 0, NA, NA, 0, NA, NA, 1, NA, NA, 0.44, NA, NA, 1, NA, NA),
                 tolerance = 1e-2)
    ...
    mod.quad <- suppressWarnings(mirt(dataset, model.quad, verbose = FALSE, draws = 10, method = 'MHRM'))
    expect_is(mod.quad, 'ConfirmatoryClass')
    expect_equal(mod.quad@df, 1510)
    cfs <- as.numeric(do.call(c, coef(mod.quad, digits=4)))
    expect_equal(cfs, c(0.871, 0.7172, 1.0248, 0.2957, NaN, NaN, -1.0208, -1.1598, -0.8818, 0, NA, NA, 1, NA, NA, 0.4826, NaN, NaN, -0.0556, NaN, NaN, -1.3805, NaN, NaN, 0, NA, NA, 1, NA, NA, 0.7484, 0.5265, 0.9704, 0.2752, NaN, NaN, 1.0777, NaN, NaN, 0, NA, NA, 1, NA, NA, 1.5858, 1.3878, 1.7839, 0.4895, NaN, NaN, -0.2305, -0.3194, -0.1417, 0, NA, NA, 1, NA, NA, 1.0549, NaN, NaN, 0, NA, NA, 2.5958, NaN, NaN, 1.6652, NaN, NaN, -0.4206, -0.5231, -0.3181, 0.3504, 0.2936, 0.4073, 0, NA, NA, 2.5036, 2.3433, 2.6639, 0.9778, 0.8808, 1.0748, -1.0013, -1.1031, -0.8995, 0.7009, 0.5795, 0.8223, 0, NA, NA, 1.8259, 1.7006, 1.9513, 0.0738, -0.0159, 0.1634, 0.9391, NaN, NaN, 0, NA, NA, 1.0044, 0.9215, 1.0873, 0, NA, NA, 1, NA, NA, 0, NA, NA, 1, NA, NA),
                 tolerance = 1e-2)
    ...
    expect_equal(cfs, c(1.7616, NaN, NaN, 0, NA, NA, 0.4541, 0.2335, 0.6747, -1.0423, -1.189, -0.8956, 0, NA, NA, 1, NA, NA, 0.533, 0.3471, 0.7188, 0, NA, NA, 0, NA, NA, -1.4486, -1.5776, -1.3197, 0, NA, NA, 1, NA, NA, 0.7591, 0.6681, 0.8501, 0, NA, NA, 0, NA, NA, 1.3316, 1.2102, 1.453, 0, NA, NA, 1, NA, NA, 1.2975, 1.0146, 1.5804, 0, NA, NA, 0, NA, NA, 0.0434, -0.0693, 0.1561, 0, NA, NA, 1, NA, NA, 0, NA, NA, 1.4591, NaN, NaN, -0.2748, NaN, NaN, 2.9675, NaN, NaN, 1.9248, NaN, NaN, -0.44, -0.5637, -0.3162, 0, NA, NA, 0.4784, 0.3611, 0.5956, 0, NA, NA, 2.5502, 2.3795, 2.7209, 1.0036, 0.8983, 1.1089, -1.0209, -1.1248, -0.9169, 0, NA, NA, 0.8376, 0.6631, 1.012, 0, NA, NA, 1.892, 1.7321, 2.0519, 0.0855, -0.0178, 0.1888, 0, NA, NA, 0.905, 0.8179, 0.9922, 0, NA, NA, 1.0025, 0.8866, 1.1183, 0, NA, NA, 1, NA, NA, 0, NA, NA, 0, NA, NA, 1, NA, NA, 0, NA, NA, 1, NA, NA),
                 tolerance = 1e-2)

...
test_that('mixed dich', {
    ...
    expect_equal(cfs, c(1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -1.6998, -1.8444, -1.5553, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -2.1137, -2.2649, -1.9625, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -1.7067, -1.8513, -1.5621, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -1.0486, -1.1934, -0.9039, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -0.3117, -0.469, -0.1544, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -1.2454, -1.3889, -1.1019, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -1.6861, -1.8306, -1.5417, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -2.1287, -2.2802, -1.9771, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, -2.0322, -2.1816, -1.8828, 0, NA, NA, 1, NA, NA, 1.109, 0.9781, 1.2398, 2.2479, 2.1117, 2.3842, 1, NA, NA, 1.6213, 1.358, 1.8847, 0, NA, NA, 1, NA, NA, 0, NA, NA, 0.124, NA, NA),
                 tolerance = 1e-2)
...
test_that('polytomous', {
    ...
    expect_equal(cfs, c(-0.1601, 0.8223, 0.5184, 1.1262, 0, 1, 2, 3, 0, 2.8303, 1.7347, 3.9259, 5.3709, 4.2186, 6.5232, 4.1417, 3.1204, 5.163, -0.1601, 0.8402, 0.5711, 1.1094, 0, 1, 2, 3, 0, 1.7885, 1.3101, 2.2669, 2.7338, 2.3147, 3.1529, 1.0821, -0.1601, 2.5353, 1.409, 3.6616, 0, 1, 2, 3, 0, 5.2316, 3.3755, 7.0876, 7.6801, 5.2949, 10.0652, 5.7051, 4.2908, 7.1194, -0.1601, 0.6943, 0.4433, 0.9453, 0, 1, 2, 3, 0, 2.1432, 1.5978, 2.6887, 3.0122, 2.4892, 3.5353, 1.9308, 1.6538, 2.2079, 0, 1),
                 tolerance = 1e-2)

...
test_that('polytomous', {
    ...
    expect_equal(cfs, c(-0.1617, -0.38, 0.0565, 0.8287, 0.4672, 1.1903, 0, NA, NA, 2.8314, 1.7068, 3.9559, 5.3694, 4.1408, 6.5979, 4.1331, 2.9386, 5.3275, -0.1617, -0.38, 0.0565, 0.8375, 0.5618, 1.1132, 0, NA, NA, 1.7767, 1.2468, 2.3067, 2.7154, 2.086, 3.3448, 1.0623, 0.3492, 1.7754, -0.1617, -0.38, 0.0565, 2.5641, 0.8586, 4.2697, 0, NA, NA, 5.2528, 2.0196, 8.4861, 7.6976, 3.0734, 12.3219, 5.6962, 1.7939, 9.5985, -0.1617, -0.38, 0.0565, 0.6946, 0.4289, 0.9604, 0, NA, NA, 2.1363, 1.5667, 2.7059, 3.0002, 2.3536, 3.6468, 1.9153, 1.2117, 2.6188, 0, NA, NA, 1, NA, NA),
                 tollerance = 1e-2)

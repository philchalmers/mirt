...
test_that('mixed dich', {
    ...
    expect_equal(cfs, c(1, NA, -0.5633, 0.0786, 0, NA, 1, NA, 1, NA, -0.9845, 0.0864, 0, NA, 1, NA, 1, NA, -0.5703, 0.0787, 0, NA, 1, NA, 1, NA, 0.0948, 0.0779, 0, NA, 1, NA, 1, NA, 0.8438, 0.0947, 0, NA, 1, NA, 1, NA, -0.1039, 0.0765, 0, NA, 1, NA, 1, NA, -0.5494, 0.0785, 0, NA, 1, NA, 1, NA, -0.9998, 0.0868, 0, NA, 1, NA, 1, NA, -0.9013, 0.0845, 0, NA, 1, NA, 1, NA, 2.8784, 0.1873, 0, NA, 1, NA, 0, NA, 0.3088, 0.0614, 0.8778, 0.3955),
                 tollerance = 1e-2)
})   
...
test_that('polytomous', {
    ...
    cfs <- as.numeric(do.call(c, coef(rmod1, digits=4)))
    expect_equal(cfs, c(1.0496, 0.2083, 4.8724, 0.5148, 2.6461, 0.2588, -1.4624, 0.1554, 1.2359, 0.2568, 2.9326, 0.2573, 0.908, 0.1511, -2.2632, 0.2562, 2.3007, 0.5225, 5.2471, 0.6991, 2.2219, 0.3286, -1.9481, 0.4041, 1.0981, 0.2221, 3.3521, 0.3235, 0.996, 0.1667, -1.6822, 0.1765, 0, NA, 1, NA, 1e-04, 1e-04),
                 tollerance = 1e-2)

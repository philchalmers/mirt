...
test_that('one factor', {    
    ...
    cfs <- cfs[cfs != 0 & cfs != 1]    
    expect_equal(cfs, c(1.1424, 0.5617, 1.3256, -0.6515, 0.9936, -0.2013, 1.0489, 0.8861, 1.1449, 0.3377, 0.4314, 0.4963, 1.2258, 1.1574, 0.916, -0.4202, 0.8163, -1.0169, 0.801, -1.0892, 0.9487, 1.2343, 1.5886, -0.1901, 1.1991, 0.5381, 1.1292, 0.4323, 0.8934, -0.1175),
                 tollerance = 1e-2)

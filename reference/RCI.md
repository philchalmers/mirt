...
#> $items
#>                 a1    a2      d g u
#> Item.pre_1   1.221 0.000 -0.220 0 1
#> Item.pre_2   1.046 0.000  1.161 0 1
#> Item.pre_3   0.978 0.000 -0.112 0 1
#> Item.pre_4   1.304 0.000  0.293 0 1
#> Item.pre_5   1.173 0.000  0.402 0 1
#> Item.pre_6   1.187 0.000  0.490 0 1
#> Item.pre_7   1.122 0.000  0.218 0 1
#> Item.pre_8   1.041 0.000 -0.930 0 1
#> Item.pre_9   0.765 0.000 -0.441 0 1
#> Item.pre_10  1.253 0.000 -0.666 0 1
#> Item.pre_11  0.813 0.000 -0.276 0 1
#> Item.pre_12  1.127 0.000 -0.086 0 1
#> Item.pre_13  1.450 0.000 -0.097 0 1
#> Item.pre_14  1.158 0.000  0.796 0 1
#> Item.pre_15  1.088 0.000 -0.506 0 1
#> Item.pre_16  1.862 0.000  0.474 0 1
#> Item.pre_17  0.911 0.000  1.207 0 1
#> Item.pre_18  1.041 0.000  0.768 0 1
#> Item.pre_19  1.397 0.000  0.170 0 1
#> Item.pre_20  0.774 0.000 -0.247 0 1
#> Item.post_1  0.000 1.221 -0.220 0 1
#> Item.post_2  0.000 1.046  1.161 0 1
#> Item.post_3  0.000 0.978 -0.112 0 1
#> Item.post_4  0.000 1.304  0.293 0 1
#> Item.post_5  0.000 1.173  0.402 0 1
#> Item.post_6  0.000 1.187  0.490 0 1
#> Item.post_7  0.000 1.122  0.218 0 1
#> Item.post_8  0.000 1.041 -0.930 0 1
#> Item.post_9  0.000 0.765 -0.441 0 1
#> Item.post_10 0.000 1.253 -0.666 0 1
#> Item.post_11 0.000 0.813 -0.276 0 1
#> Item.post_12 0.000 1.127 -0.086 0 1
#> Item.post_13 0.000 1.450 -0.097 0 1
#> Item.post_14 0.000 1.158  0.796 0 1
#> Item.post_15 0.000 1.088 -0.506 0 1
#> Item.post_16 0.000 1.862  0.474 0 1
#> Item.post_17 0.000 0.911  1.207 0 1
#> Item.post_18 0.000 1.041  0.768 0 1
#> Item.post_19 0.000 1.397  0.170 0 1
#> Item.post_20 0.000 0.774 -0.247 0 1
#> 
#> $means
#>  thetapre thetapost 
#>     0.000    -0.556 
...
#> Item.pre_1      0.583           0.340
#> Item.pre_2      0.524           0.274
#> Item.pre_3      0.498           0.248
#> Item.pre_4      0.608           0.370
#> Item.pre_5      0.568           0.322
#> Item.pre_6      0.572           0.327
#> Item.pre_7      0.550           0.303
#> Item.pre_8      0.522           0.272
#> Item.pre_9      0.410           0.168
#> Item.pre_10     0.593           0.351
#> Item.pre_11     0.431           0.186
#> Item.pre_12     0.552           0.305
#> Item.pre_13     0.649           0.421
#> Item.pre_14     0.562           0.316
#> Item.pre_15     0.539           0.290
#> Item.pre_16     0.738           0.545
#> Item.pre_17     0.472           0.223
#> Item.pre_18     0.522           0.272
#> Item.pre_19     0.634           0.402
#> Item.pre_20     0.414           0.171
#> Item.post_1               0.597 0.356
#> Item.post_2               0.537 0.289
#> Item.post_3               0.512 0.262
#> Item.post_4               0.622 0.387
#> Item.post_5               0.581 0.338
#> Item.post_6               0.586 0.343
#> Item.post_7               0.564 0.318
#> Item.post_8               0.535 0.286
#> Item.post_9               0.422 0.178
#> Item.post_10              0.606 0.368
#> Item.post_11              0.444 0.197
#> Item.post_12              0.566 0.320
#> Item.post_13              0.662 0.438
#> Item.post_14              0.576 0.332
#> Item.post_15              0.552 0.305
#> Item.post_16              0.750 0.563
#> Item.post_17              0.485 0.235
#> Item.post_18              0.535 0.287
#> Item.post_19              0.648 0.420
#> Item.post_20              0.426 0.182
#> 
...
#>   pre.score post.score converged   diff    SE      z     p
#> 1    -0.054     -1.591      TRUE -1.537 0.617 -2.493 0.013
#> 2     0.507     -1.563      TRUE -2.071 0.627 -3.304 0.001
#> 3     1.753     -0.125      TRUE -1.878 0.658 -2.855 0.004
...
#>   pre.score post.score converged   diff    SE      z     p
#> 1    10.254      3.487      TRUE -6.767 2.454 -2.493 0.013
#> 2    13.100      3.570      TRUE -9.531 2.364 -3.304 0.001
#> 3    17.406      9.877      TRUE -7.530 2.340 -2.855 0.004
...
d <- rbind(d,d)
data.frame(a=a, d=d)
#>          a.1       a.2         d.1         d.2         d.3         d.4
#> 1  1.1406087 0.0000000  2.38286353  1.74137638  1.44079443  0.60694226
#> 2  0.8032164 0.0000000  0.18594834 -0.69016200 -1.18488292 -1.67394003
#> 3  1.2619169 0.0000000  0.83020708 -0.03990745 -0.49787075 -1.19772952
#> 4  0.8962095 0.0000000  1.41940652  0.54856983  0.08205558 -0.44991667
#> 5  1.2957224 0.0000000  0.83226958  0.48307348 -0.45440204 -1.07322710
#> 6  0.9079571 0.0000000  1.93210824  1.20707791  0.37419647  0.03437443
#> 7  1.2780726 0.0000000  1.31760795  0.51706504 -0.09547840 -0.79555521
#> 8  1.0229562 0.0000000  0.62123607  0.02757232 -0.82126021 -1.40132719
#> 9  1.2613973 0.0000000  1.22044721  0.30074177 -0.18612670 -0.58670507
#> 10 0.9991881 0.0000000 -0.47164450 -1.40208508 -1.72045831 -2.29497973
#> 11 1.1527953 0.0000000  0.30740145 -0.68686355 -1.34312861 -1.70586118
#> 12 1.0068240 0.0000000  0.08785812 -0.42504985 -1.00981898 -1.44840441
#> 13 1.0690364 0.0000000  0.26363433 -0.16628178 -0.66150425 -1.18255688
#> 14 1.2146778 0.0000000  0.21370230 -0.47936618 -0.80130464 -1.33253706
#> 15 1.4027127 0.0000000  1.32584892  0.75154887 -0.19299454 -0.85435557
#> 16 0.9992725 0.0000000  1.41397039  0.75820872 -0.23903108 -1.15720139
#> 17 1.5190717 0.0000000  0.16123202 -0.29254170 -1.17085330 -1.64075970
#> 18 0.9911182 0.0000000 -0.04863582 -0.60093287 -1.58703216 -2.21725505
#> 19 0.9292297 0.0000000  1.29038031  0.67442673  0.27802901 -0.42884107
#> 20 0.7529359 0.0000000  0.89084063  0.32287799 -0.54286545 -1.50668603
#> 21 0.0000000 1.1406087  2.38286353  1.74137638  1.44079443  0.60694226
#> 22 0.0000000 0.8032164  0.18594834 -0.69016200 -1.18488292 -1.67394003
#> 23 0.0000000 1.2619169  0.83020708 -0.03990745 -0.49787075 -1.19772952
#> 24 0.0000000 0.8962095  1.41940652  0.54856983  0.08205558 -0.44991667
#> 25 0.0000000 1.2957224  0.83226958  0.48307348 -0.45440204 -1.07322710
#> 26 0.0000000 0.9079571  1.93210824  1.20707791  0.37419647  0.03437443
#> 27 0.0000000 1.2780726  1.31760795  0.51706504 -0.09547840 -0.79555521
#> 28 0.0000000 1.0229562  0.62123607  0.02757232 -0.82126021 -1.40132719
#> 29 0.0000000 1.2613973  1.22044721  0.30074177 -0.18612670 -0.58670507
#> 30 0.0000000 0.9991881 -0.47164450 -1.40208508 -1.72045831 -2.29497973
#> 31 0.0000000 1.1527953  0.30740145 -0.68686355 -1.34312861 -1.70586118
#> 32 0.0000000 1.0068240  0.08785812 -0.42504985 -1.00981898 -1.44840441
#> 33 0.0000000 1.0690364  0.26363433 -0.16628178 -0.66150425 -1.18255688
#> 34 0.0000000 1.2146778  0.21370230 -0.47936618 -0.80130464 -1.33253706
#> 35 0.0000000 1.4027127  1.32584892  0.75154887 -0.19299454 -0.85435557
#> 36 0.0000000 0.9992725  1.41397039  0.75820872 -0.23903108 -1.15720139
#> 37 0.0000000 1.5190717  0.16123202 -0.29254170 -1.17085330 -1.64075970
#> 38 0.0000000 0.9911182 -0.04863582 -0.60093287 -1.58703216 -2.21725505
#> 39 0.0000000 0.9292297  1.29038031  0.67442673  0.27802901 -0.42884107
#> 40 0.0000000 0.7529359  0.89084063  0.32287799 -0.54286545 -1.50668603
...
#> Item.pre_1  500 4 2.442 1.074   0.411         0.353       0.848
#> Item.pre_2  500 4 1.138 1.642   0.436         0.348       0.848
#> Item.pre_3  500 4 2.208 1.325   0.576         0.517       0.842
#> Item.pre_4  500 5 2.280 1.653   0.446         0.358       0.848
#> Item.pre_5  500 5 1.910 1.664   0.579         0.504       0.842
#> Item.pre_6  500 5 2.676 1.562   0.499         0.421       0.845
#> Item.pre_7  500 5 2.228 1.619   0.575         0.502       0.842
#> Item.pre_8  500 5 1.764 1.639   0.495         0.412       0.846
#> Item.pre_9  500 5 2.190 1.680   0.557         0.478       0.843
#> Item.pre_10 500 5 0.896 1.395   0.468         0.396       0.846
#> Item.pre_11 500 5 1.372 1.576   0.540         0.465       0.844
#> Item.pre_12 500 5 1.582 1.675   0.539         0.459       0.844
#> Item.pre_13 500 5 1.706 1.745   0.483         0.394       0.847
#> Item.pre_14 500 5 1.592 1.680   0.570         0.494       0.842
#> Item.pre_15 500 5 2.266 1.626   0.583         0.510       0.842
#> Item.pre_16 500 5 2.148 1.511   0.485         0.408       0.846
#> Item.pre_17 500 5 1.584 1.691   0.600         0.526       0.841
#> Item.pre_18 500 5 1.198 1.431   0.488         0.416       0.846
#> Item.pre_19 500 5 2.430 1.632   0.414         0.325       0.849
#> Item.pre_20 500 5 1.896 1.552   0.496         0.418       0.845
#> 
#> $proportions
#>                 0     1     2     3     4
#> Item.pre_1  0.128 0.068 0.038 0.766    NA
#> Item.pre_2  0.654    NA 0.086 0.074 0.186
#> Item.pre_3     NA 0.500 0.086 0.120 0.294
#> Item.pre_4  0.232 0.166 0.092 0.110 0.400
#> Item.pre_5  0.352 0.080 0.168 0.106 0.294
#> Item.pre_6  0.158 0.112 0.148 0.060 0.522
#> Item.pre_7  0.244 0.138 0.114 0.154 0.350
#> Item.pre_8  0.368 0.118 0.160 0.090 0.264
#> Item.pre_9  0.260 0.158 0.108 0.080 0.394
#> Item.pre_10 0.622 0.152 0.048 0.064 0.114
#> Item.pre_11 0.452 0.186 0.108 0.046 0.208
#> Item.pre_12 0.448 0.102 0.120 0.080 0.250
#> Item.pre_13 0.450 0.064 0.112 0.078 0.296
#> Item.pre_14 0.440 0.128 0.080 0.104 0.248
#> Item.pre_15 0.258 0.086 0.150 0.144 0.362
#> Item.pre_16 0.224 0.130 0.194 0.178 0.274
#> Item.pre_17 0.464 0.072 0.138 0.068 0.258
#> Item.pre_18 0.502 0.122 0.168 0.092 0.116
#> Item.pre_19 0.226 0.108 0.096 0.150 0.420
#> Item.pre_20 0.316 0.096 0.180 0.192 0.216
#> 
...
#>                   COV = thetapre*thetapost, thetapost*thetapost
#>                   MEAN = thetapost
#>                   CONSTRAIN = (1,21,a1,a2),(1,21,d1),(1,21,d2),(1,21,d3),(1,21,d4),(2,22,a1,a2),(2,22,d1),(2,22,d2),(2,22,d3),(2,22,d4),(3,23,a1,a2),(3,23,d1),(3,23,d2),(3,23,d3),(3,23,d4),(4,24,a1,a2),(4,24,d1),(4,24,d2),(4,24,d3),(4,24,d4),(5,25,a1,a2),(5,25,d1),(5,25,d2),(5,25,d3),(5,25,d4),(6,26,a1,a2),(6,26,d1),(6,26,d2),(6,26,d3),(6,26,d4),(7,27,a1,a2),(7,27,d1),(7,27,d2),(7,27,d3),(7,27,d4),(8,28,a1,a2),(8,28,d1),(8,28,d2),(8,28,d3),(8,28,d4),(9,29,a1,a2),(9,29,d1),(9,29,d2),(9,29,d3),(9,29,d4),(10,30,a1,a2),(10,30,d1),(10,30,d2),(10,30,d3),(10,30,d4),(11,31,a1,a2),(11,31,d1),(11,31,d2),(11,31,d3),(11,31,d4),(12,32,a1,a2),(12,32,d1),(12,32,d2),(12,32,d3),(12,32,d4),(13,33,a1,a2),(13,33,d1),(13,33,d2),(13,33,d3),(13,33,d4),(14,34,a1,a2),(14,34,d1),(14,34,d2),(14,34,d3),(14,34,d4),(15,35,a1,a2),(15,35,d1),(15,35,d2),(15,35,d3),(15,35,d4),(16,36,a1,a2),(16,36,d1),(16,36,d2),(16,36,d3),(16,36,d4),(17,37,a1,a2),(17,37,d1),(17,37,d2),(17,37,d3),(17,37,d4),(18,38,a1,a2),(18,38,d1),(18,38,d2),(18,38,d3),(18,38,d4),(19,39,a1,a2),(19,39,d1),(19,39,d2),(19,39,d3),(19,39,d4),(20,40,a1,a2),(20,40,d1),(20,40,d2),(20,40,d3),(20,40,d4)
...
#> $Item.pre_1
#>        a1 a2    d1    d2    d3    d4
#> par 1.149  0 2.401 1.810 1.514 0.643
#> SE  0.096 NA 0.129 0.114 0.109 0.097
#> 
#> $Item.pre_2
#>        a1 a2    d1     d2     d3     d4
#> par 0.813  0 0.097 -0.654 -1.220 -1.663
#> SE  0.078 NA 0.079  0.081  0.089  0.098
#> 
#> $Item.pre_3
#>        a1 a2    d1     d2     d3     d4
#> par 1.255  0 0.877 -0.009 -0.423 -1.132
#> SE  0.095 NA 0.099  0.094  0.095  0.101
#> 
#> $Item.pre_4
#>        a1 a2    d1    d2    d3     d4
#> par 0.870  0 1.339 0.490 0.083 -0.470
#> SE  0.076 NA 0.092 0.083 0.081  0.082
#> 
#> $Item.pre_5
#>        a1 a2   d1    d2     d3     d4
#> par 1.309  0 0.86 0.474 -0.457 -1.047
#> SE  0.098 NA 0.10 0.097  0.097  0.102
#> 
#> $Item.pre_6
#>        a1 a2    d1    d2    d3    d4
#> par 1.128  0 2.097 1.292 0.527 0.176
#> SE  0.091 NA 0.118 0.102 0.093 0.091
#> 
#> $Item.pre_7
#>        a1 a2    d1    d2     d3     d4
#> par 1.245  0 1.336 0.562 -0.050 -0.778
#> SE  0.093 NA 0.104 0.096  0.094  0.097
#> 
#> $Item.pre_8
#>        a1 a2    d1    d2     d3     d4
#> par 0.860  0 0.660 0.102 -0.707 -1.224
#> SE  0.077 NA 0.083 0.080  0.083  0.090
#> 
#> $Item.pre_9
#>        a1 a2    d1    d2     d3     d4
#> par 1.238  0 1.200 0.387 -0.116 -0.566
#> SE  0.094 NA 0.103 0.095  0.093  0.095
#> 
#> $Item.pre_10
#>        a1 a2     d1     d2     d3     d4
#> par 0.975  0 -0.463 -1.386 -1.724 -2.320
#> SE  0.089 NA  0.085  0.097  0.105  0.123
#> 
#> $Item.pre_11
#>        a1 a2    d1     d2     d3     d4
#> par 1.249  0 0.318 -0.634 -1.325 -1.658
#> SE  0.096 NA 0.094  0.096  0.104  0.111
#> 
#> $Item.pre_12
#>        a1 a2    d1     d2     d3     d4
#> par 1.148  0 0.199 -0.349 -1.007 -1.393
#> SE  0.093 NA 0.090  0.090  0.096  0.102
#> 
#> $Item.pre_13
#>        a1 a2    d1     d2     d3     d4
#> par 0.922  0 0.188 -0.174 -0.658 -1.094
#> SE  0.083 NA 0.082  0.082  0.085  0.090
#> 
#> $Item.pre_14
#>        a1 a2    d1     d2     d3     d4
#> par 1.200  0 0.248 -0.413 -0.788 -1.400
#> SE  0.095 NA 0.092  0.092  0.095  0.104
#> 
#> $Item.pre_15
#>        a1 a2    d1    d2     d3     d4
#> par 1.426  0 1.342 0.765 -0.108 -0.803
#> SE  0.102 NA 0.112 0.105  0.101  0.104
#> 
#> $Item.pre_16
#>        a1 a2    d1    d2     d3     d4
#> par 0.986  0 1.531 0.732 -0.209 -1.229
#> SE  0.079 NA 0.098 0.087  0.084  0.094
#> 
#> $Item.pre_17
#>        a1 a2    d1     d2     d3     d4
#> par 1.422  0 0.217 -0.163 -0.988 -1.416
#> SE  0.108 NA 0.100  0.100  0.106  0.112
#> 
#> $Item.pre_18
#>        a1 a2     d1     d2     d3     d4
#> par 0.929  0 -0.060 -0.585 -1.506 -2.202
#> SE  0.082 NA  0.082  0.084  0.097  0.117
#> 
#> $Item.pre_19
#>        a1 a2    d1    d2    d3     d4
#> par 0.821  0 1.335 0.691 0.264 -0.402
#> SE  0.075 NA 0.091 0.083 0.080  0.081
#> 
#> $Item.pre_20
#>        a1 a2    d1    d2     d3     d4
#> par 0.751  0 0.888 0.327 -0.521 -1.486
#> SE  0.071 NA 0.082 0.078  0.079  0.092
#> 
#> $Item.post_1
#>     a1    a2    d1    d2    d3    d4
#> par  0 1.149 2.401 1.810 1.514 0.643
#> SE  NA 0.096 0.129 0.114 0.109 0.097
#> 
#> $Item.post_2
#>     a1    a2    d1     d2     d3     d4
#> par  0 0.813 0.097 -0.654 -1.220 -1.663
#> SE  NA 0.078 0.079  0.081  0.089  0.098
#> 
#> $Item.post_3
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.255 0.877 -0.009 -0.423 -1.132
#> SE  NA 0.095 0.099  0.094  0.095  0.101
#> 
#> $Item.post_4
#>     a1    a2    d1    d2    d3     d4
#> par  0 0.870 1.339 0.490 0.083 -0.470
#> SE  NA 0.076 0.092 0.083 0.081  0.082
#> 
#> $Item.post_5
#>     a1    a2   d1    d2     d3     d4
#> par  0 1.309 0.86 0.474 -0.457 -1.047
#> SE  NA 0.098 0.10 0.097  0.097  0.102
#> 
#> $Item.post_6
#>     a1    a2    d1    d2    d3    d4
#> par  0 1.128 2.097 1.292 0.527 0.176
#> SE  NA 0.091 0.118 0.102 0.093 0.091
#> 
#> $Item.post_7
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.245 1.336 0.562 -0.050 -0.778
#> SE  NA 0.093 0.104 0.096  0.094  0.097
#> 
#> $Item.post_8
#>     a1    a2    d1    d2     d3     d4
#> par  0 0.860 0.660 0.102 -0.707 -1.224
#> SE  NA 0.077 0.083 0.080  0.083  0.090
#> 
#> $Item.post_9
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.238 1.200 0.387 -0.116 -0.566
#> SE  NA 0.094 0.103 0.095  0.093  0.095
#> 
#> $Item.post_10
#>     a1    a2     d1     d2     d3     d4
#> par  0 0.975 -0.463 -1.386 -1.724 -2.320
#> SE  NA 0.089  0.085  0.097  0.105  0.123
#> 
#> $Item.post_11
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.249 0.318 -0.634 -1.325 -1.658
#> SE  NA 0.096 0.094  0.096  0.104  0.111
#> 
#> $Item.post_12
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.148 0.199 -0.349 -1.007 -1.393
#> SE  NA 0.093 0.090  0.090  0.096  0.102
#> 
#> $Item.post_13
#>     a1    a2    d1     d2     d3     d4
#> par  0 0.922 0.188 -0.174 -0.658 -1.094
#> SE  NA 0.083 0.082  0.082  0.085  0.090
#> 
#> $Item.post_14
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.200 0.248 -0.413 -0.788 -1.400
#> SE  NA 0.095 0.092  0.092  0.095  0.104
#> 
#> $Item.post_15
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.426 1.342 0.765 -0.108 -0.803
#> SE  NA 0.102 0.112 0.105  0.101  0.104
#> 
#> $Item.post_16
#>     a1    a2    d1    d2     d3     d4
#> par  0 0.986 1.531 0.732 -0.209 -1.229
#> SE  NA 0.079 0.098 0.087  0.084  0.094
#> 
#> $Item.post_17
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.422 0.217 -0.163 -0.988 -1.416
#> SE  NA 0.108 0.100  0.100  0.106  0.112
#> 
#> $Item.post_18
#>     a1    a2     d1     d2     d3     d4
#> par  0 0.929 -0.060 -0.585 -1.506 -2.202
#> SE  NA 0.082  0.082  0.084  0.097  0.117
#> 
#> $Item.post_19
#>     a1    a2    d1    d2    d3     d4
#> par  0 0.821 1.335 0.691 0.264 -0.402
#> SE  NA 0.075 0.091 0.083 0.080  0.081
#> 
#> $Item.post_20
#>     a1    a2    d1    d2     d3     d4
#> par  0 0.751 0.888 0.327 -0.521 -1.486
#> SE  NA 0.071 0.082 0.078  0.079  0.092
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0 -0.553      1  0.760  1.094
#> SE      NA  0.048     NA  0.045  0.096
#> 
coef(mod, simplify=TRUE)
#> $items
#>                 a1    a2     d1     d2     d3     d4
#> Item.pre_1   1.149 0.000  2.401  1.810  1.514  0.643
#> Item.pre_2   0.813 0.000  0.097 -0.654 -1.220 -1.663
#> Item.pre_3   1.255 0.000  0.877 -0.009 -0.423 -1.132
#> Item.pre_4   0.870 0.000  1.339  0.490  0.083 -0.470
#> Item.pre_5   1.309 0.000  0.860  0.474 -0.457 -1.047
#> Item.pre_6   1.128 0.000  2.097  1.292  0.527  0.176
#> Item.pre_7   1.245 0.000  1.336  0.562 -0.050 -0.778
#> Item.pre_8   0.860 0.000  0.660  0.102 -0.707 -1.224
#> Item.pre_9   1.238 0.000  1.200  0.387 -0.116 -0.566
#> Item.pre_10  0.975 0.000 -0.463 -1.386 -1.724 -2.320
#> Item.pre_11  1.249 0.000  0.318 -0.634 -1.325 -1.658
#> Item.pre_12  1.148 0.000  0.199 -0.349 -1.007 -1.393
#> Item.pre_13  0.922 0.000  0.188 -0.174 -0.658 -1.094
#> Item.pre_14  1.200 0.000  0.248 -0.413 -0.788 -1.400
#> Item.pre_15  1.426 0.000  1.342  0.765 -0.108 -0.803
#> Item.pre_16  0.986 0.000  1.531  0.732 -0.209 -1.229
#> Item.pre_17  1.422 0.000  0.217 -0.163 -0.988 -1.416
#> Item.pre_18  0.929 0.000 -0.060 -0.585 -1.506 -2.202
#> Item.pre_19  0.821 0.000  1.335  0.691  0.264 -0.402
#> Item.pre_20  0.751 0.000  0.888  0.327 -0.521 -1.486
#> Item.post_1  0.000 1.149  2.401  1.810  1.514  0.643
#> Item.post_2  0.000 0.813  0.097 -0.654 -1.220 -1.663
#> Item.post_3  0.000 1.255  0.877 -0.009 -0.423 -1.132
#> Item.post_4  0.000 0.870  1.339  0.490  0.083 -0.470
#> Item.post_5  0.000 1.309  0.860  0.474 -0.457 -1.047
#> Item.post_6  0.000 1.128  2.097  1.292  0.527  0.176
#> Item.post_7  0.000 1.245  1.336  0.562 -0.050 -0.778
#> Item.post_8  0.000 0.860  0.660  0.102 -0.707 -1.224
#> Item.post_9  0.000 1.238  1.200  0.387 -0.116 -0.566
#> Item.post_10 0.000 0.975 -0.463 -1.386 -1.724 -2.320
#> Item.post_11 0.000 1.249  0.318 -0.634 -1.325 -1.658
#> Item.post_12 0.000 1.148  0.199 -0.349 -1.007 -1.393
#> Item.post_13 0.000 0.922  0.188 -0.174 -0.658 -1.094
#> Item.post_14 0.000 1.200  0.248 -0.413 -0.788 -1.400
#> Item.post_15 0.000 1.426  1.342  0.765 -0.108 -0.803
#> Item.post_16 0.000 0.986  1.531  0.732 -0.209 -1.229
#> Item.post_17 0.000 1.422  0.217 -0.163 -0.988 -1.416
#> Item.post_18 0.000 0.929 -0.060 -0.585 -1.506 -2.202
#> Item.post_19 0.000 0.821  1.335  0.691  0.264 -0.402
#> Item.post_20 0.000 0.751  0.888  0.327 -0.521 -1.486
#> 
#> $means
#>  thetapre thetapost 
#>     0.000    -0.553 
...
#>           thetapre thetapost
#> thetapre      1.00     0.760
#> thetapost     0.76     1.094
#> 
summary(mod)
#>              thetapre thetapost    h2
#> Item.pre_1      0.560           0.313
#> Item.pre_2      0.431           0.186
#> Item.pre_3      0.593           0.352
#> Item.pre_4      0.455           0.207
#> Item.pre_5      0.610           0.372
#> Item.pre_6      0.553           0.305
#> Item.pre_7      0.590           0.349
#> Item.pre_8      0.451           0.203
#> Item.pre_9      0.588           0.346
#> Item.pre_10     0.497           0.247
#> Item.pre_11     0.592           0.350
#> Item.pre_12     0.559           0.313
#> Item.pre_13     0.476           0.227
#> Item.pre_14     0.576           0.332
#> Item.pre_15     0.642           0.412
#> Item.pre_16     0.501           0.251
#> Item.pre_17     0.641           0.411
#> Item.pre_18     0.479           0.229
#> Item.pre_19     0.435           0.189
#> Item.pre_20     0.404           0.163
#> Item.post_1               0.577 0.333
#> Item.post_2               0.447 0.200
#> Item.post_3               0.611 0.373
#> Item.post_4               0.471 0.222
#> Item.post_5               0.627 0.393
#> Item.post_6               0.570 0.325
#> Item.post_7               0.608 0.369
#> Item.post_8               0.467 0.218
#> Item.post_9               0.605 0.366
#> Item.post_10              0.514 0.264
#> Item.post_11              0.609 0.371
#> Item.post_12              0.576 0.332
#> Item.post_13              0.493 0.243
#> Item.post_14              0.593 0.352
#> Item.post_15              0.659 0.434
#> Item.post_16              0.518 0.269
#> Item.post_17              0.658 0.433
#> Item.post_18              0.496 0.246
#> Item.post_19              0.451 0.203
#> Item.post_20              0.419 0.176
#> 
#>              SE.thetapre SE.thetapost
#> Item.pre_1         0.032             
#> Item.pre_2         0.033             
...
#> Item.post_20                    0.033
#> 
#> SS loadings:  5.758 6.123 
#> Proportion Var:  0.144 0.153 
#> 
#> Factor correlations: 
#> 
#>           thetapre thetapost
...
#>   pre.score post.score converged   diff    SE      z     p
#> 1     0.092      0.232      TRUE  0.140 0.546  0.256 0.798
#> 2     0.397      1.243      TRUE  0.846 0.547  1.546 0.122
#> 3     1.519      1.359      TRUE -0.161 0.572 -0.281 0.779
RCI(modM, predat = change)
#>   pre.score post.score converged   diff    SE      z     p
#> 1     0.141     -2.397      TRUE -2.539 0.648 -3.918     0
#> 2     0.329     -0.751      TRUE -1.080 0.555 -1.944 0.052
#> 3     1.630     -0.132      TRUE -1.762 0.573 -3.076 0.002

# expected total-score metric reported instead
RCI(modM, predat = nochange, expected.scores=TRUE)
#>   pre.score post.score converged   diff    SE      z     p
#> 1    39.724     41.026      TRUE  1.302 8.985  0.256 0.798
#> 2    44.732     56.636      TRUE 11.904 8.169  1.546 0.122
#> 3    61.212     58.181      TRUE -3.031 7.259 -0.281 0.779
RCI(modM, predat = change, expected.scores=TRUE)
#>   pre.score post.score converged    diff    SE      z     p
#> 1    40.533      8.937      TRUE -31.596 7.003 -3.918     0
#> 2    43.614     25.586      TRUE -18.028 8.485 -1.944 0.052
#> 3    62.528     35.062      TRUE -27.466 8.025 -3.076 0.002

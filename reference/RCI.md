...
#>   pre.score post.score converged   diff    SE      z     p
#> 1    10.254      3.488      TRUE -6.767 2.454 -2.493 0.013
...
#> $Item.pre_1
#>        a1 a2    d1    d2    d3    d4
#> par 1.149  0 2.400 1.810 1.514 0.642
#> SE  0.096 NA 0.129 0.114 0.109 0.097
#> 
#> $Item.pre_2
#>        a1 a2    d1     d2     d3     d4
#> par 0.813  0 0.096 -0.655 -1.220 -1.664
#> SE  0.078 NA 0.079  0.081  0.089  0.098
#> 
#> $Item.pre_3
#>        a1 a2    d1     d2     d3     d4
#> par 1.255  0 0.877 -0.010 -0.424 -1.133
#> SE  0.095 NA 0.099  0.094  0.095  0.101
#> 
#> $Item.pre_4
#>        a1 a2    d1    d2    d3     d4
#> par 0.870  0 1.339 0.490 0.083 -0.471
#> SE  0.076 NA 0.092 0.083 0.081  0.082
#> 
#> $Item.pre_5
#>        a1 a2   d1    d2     d3     d4
#> par 1.310  0 0.86 0.474 -0.457 -1.047
#> SE  0.098 NA 0.10 0.097  0.097  0.102
#> 
#> $Item.pre_6
#>        a1 a2    d1    d2    d3    d4
#> par 1.129  0 2.096 1.292 0.527 0.176
#> SE  0.091 NA 0.118 0.102 0.093 0.091
#> 
#> $Item.pre_7
#>        a1 a2    d1    d2     d3     d4
#> par 1.245  0 1.335 0.562 -0.050 -0.779
...
#> $Item.pre_9
#>        a1 a2    d1    d2     d3     d4
#> par 1.238  0 1.199 0.386 -0.117 -0.566
#> SE  0.094 NA 0.103 0.095  0.093  0.095
#> 
#> $Item.pre_10
#>        a1 a2     d1     d2     d3     d4
#> par 0.975  0 -0.464 -1.387 -1.724 -2.321
#> SE  0.089 NA  0.085  0.097  0.105  0.123
#> 
#> $Item.pre_11
#>        a1 a2    d1     d2     d3     d4
#> par 1.249  0 0.317 -0.635 -1.326 -1.658
#> SE  0.096 NA 0.094  0.096  0.104  0.111
#> 
#> $Item.pre_12
#>        a1 a2    d1     d2     d3     d4
#> par 1.148  0 0.198 -0.349 -1.007 -1.393
#> SE  0.093 NA 0.090  0.090  0.096  0.102
#> 
#> $Item.pre_13
#>        a1 a2    d1     d2     d3     d4
#> par 0.922  0 0.187 -0.174 -0.658 -1.094
#> SE  0.083 NA 0.082  0.082  0.085  0.090
#> 
#> $Item.pre_14
#>        a1 a2    d1     d2     d3     d4
#> par 1.200  0 0.247 -0.413 -0.789 -1.401
#> SE  0.095 NA 0.092  0.092  0.095  0.104
#> 
#> $Item.pre_15
#>        a1 a2    d1    d2     d3     d4
#> par 1.426  0 1.342 0.764 -0.109 -0.803
#> SE  0.102 NA 0.112 0.105  0.101  0.104
#> 
#> $Item.pre_16
#>        a1 a2    d1    d2     d3     d4
#> par 0.986  0 1.531 0.732 -0.210 -1.229
#> SE  0.079 NA 0.098 0.087  0.084  0.094
#> 
#> $Item.pre_17
#>        a1 a2    d1     d2     d3     d4
#> par 1.423  0 0.216 -0.164 -0.989 -1.416
...
#> $Item.pre_19
#>        a1 a2    d1    d2    d3     d4
#> par 0.821  0 1.335 0.690 0.264 -0.402
#> SE  0.075 NA 0.091 0.083 0.080  0.081
#> 
#> $Item.pre_20
#>        a1 a2    d1    d2     d3     d4
#> par 0.751  0 0.888 0.326 -0.521 -1.487
#> SE  0.071 NA 0.082 0.078  0.079  0.092
#> 
#> $Item.post_1
#>     a1    a2    d1    d2    d3    d4
#> par  0 1.149 2.400 1.810 1.514 0.642
#> SE  NA 0.096 0.129 0.114 0.109 0.097
#> 
#> $Item.post_2
#>     a1    a2    d1     d2     d3     d4
#> par  0 0.813 0.096 -0.655 -1.220 -1.664
#> SE  NA 0.078 0.079  0.081  0.089  0.098
#> 
#> $Item.post_3
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.255 0.877 -0.010 -0.424 -1.133
#> SE  NA 0.095 0.099  0.094  0.095  0.101
#> 
#> $Item.post_4
#>     a1    a2    d1    d2    d3     d4
#> par  0 0.870 1.339 0.490 0.083 -0.471
#> SE  NA 0.076 0.092 0.083 0.081  0.082
#> 
#> $Item.post_5
#>     a1    a2   d1    d2     d3     d4
#> par  0 1.310 0.86 0.474 -0.457 -1.047
#> SE  NA 0.098 0.10 0.097  0.097  0.102
#> 
#> $Item.post_6
#>     a1    a2    d1    d2    d3    d4
#> par  0 1.129 2.096 1.292 0.527 0.176
#> SE  NA 0.091 0.118 0.102 0.093 0.091
#> 
#> $Item.post_7
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.245 1.335 0.562 -0.050 -0.779
...
#> $Item.post_9
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.238 1.199 0.386 -0.117 -0.566
#> SE  NA 0.094 0.103 0.095  0.093  0.095
#> 
#> $Item.post_10
#>     a1    a2     d1     d2     d3     d4
#> par  0 0.975 -0.464 -1.387 -1.724 -2.321
#> SE  NA 0.089  0.085  0.097  0.105  0.123
#> 
#> $Item.post_11
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.249 0.317 -0.635 -1.326 -1.658
#> SE  NA 0.096 0.094  0.096  0.104  0.111
#> 
#> $Item.post_12
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.148 0.198 -0.349 -1.007 -1.393
#> SE  NA 0.093 0.090  0.090  0.096  0.102
#> 
#> $Item.post_13
#>     a1    a2    d1     d2     d3     d4
#> par  0 0.922 0.187 -0.174 -0.658 -1.094
#> SE  NA 0.083 0.082  0.082  0.085  0.090
#> 
#> $Item.post_14
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.200 0.247 -0.413 -0.789 -1.401
#> SE  NA 0.095 0.092  0.092  0.095  0.104
#> 
#> $Item.post_15
#>     a1    a2    d1    d2     d3     d4
#> par  0 1.426 1.342 0.764 -0.109 -0.803
#> SE  NA 0.102 0.112 0.105  0.101  0.104
#> 
#> $Item.post_16
#>     a1    a2    d1    d2     d3     d4
#> par  0 0.986 1.531 0.732 -0.210 -1.229
#> SE  NA 0.079 0.098 0.087  0.084  0.094
#> 
#> $Item.post_17
#>     a1    a2    d1     d2     d3     d4
#> par  0 1.423 0.216 -0.164 -0.989 -1.416
...
#> $Item.post_19
#>     a1    a2    d1    d2    d3     d4
#> par  0 0.821 1.335 0.690 0.264 -0.402
#> SE  NA 0.075 0.091 0.083 0.080  0.081
#> 
#> $Item.post_20
#>     a1    a2    d1    d2     d3     d4
#> par  0 0.751 0.888 0.326 -0.521 -1.487
#> SE  NA 0.071 0.082 0.078  0.079  0.092
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0 -0.552      1  0.760  1.094
#> SE      NA  0.048     NA  0.045  0.096
#> 
coef(mod, simplify=TRUE)
#> $items
#>                 a1    a2     d1     d2     d3     d4
#> Item.pre_1   1.149 0.000  2.400  1.810  1.514  0.642
#> Item.pre_2   0.813 0.000  0.096 -0.655 -1.220 -1.664
#> Item.pre_3   1.255 0.000  0.877 -0.010 -0.424 -1.133
#> Item.pre_4   0.870 0.000  1.339  0.490  0.083 -0.471
#> Item.pre_5   1.310 0.000  0.860  0.474 -0.457 -1.047
#> Item.pre_6   1.129 0.000  2.096  1.292  0.527  0.176
#> Item.pre_7   1.245 0.000  1.335  0.562 -0.050 -0.779
#> Item.pre_8   0.860 0.000  0.660  0.102 -0.707 -1.224
#> Item.pre_9   1.238 0.000  1.199  0.386 -0.117 -0.566
#> Item.pre_10  0.975 0.000 -0.464 -1.387 -1.724 -2.321
#> Item.pre_11  1.249 0.000  0.317 -0.635 -1.326 -1.658
#> Item.pre_12  1.148 0.000  0.198 -0.349 -1.007 -1.393
#> Item.pre_13  0.922 0.000  0.187 -0.174 -0.658 -1.094
#> Item.pre_14  1.200 0.000  0.247 -0.413 -0.789 -1.401
#> Item.pre_15  1.426 0.000  1.342  0.764 -0.109 -0.803
#> Item.pre_16  0.986 0.000  1.531  0.732 -0.210 -1.229
#> Item.pre_17  1.423 0.000  0.216 -0.164 -0.989 -1.416
#> Item.pre_18  0.929 0.000 -0.060 -0.585 -1.506 -2.202
#> Item.pre_19  0.821 0.000  1.335  0.690  0.264 -0.402
#> Item.pre_20  0.751 0.000  0.888  0.326 -0.521 -1.487
#> Item.post_1  0.000 1.149  2.400  1.810  1.514  0.642
#> Item.post_2  0.000 0.813  0.096 -0.655 -1.220 -1.664
#> Item.post_3  0.000 1.255  0.877 -0.010 -0.424 -1.133
#> Item.post_4  0.000 0.870  1.339  0.490  0.083 -0.471
#> Item.post_5  0.000 1.310  0.860  0.474 -0.457 -1.047
#> Item.post_6  0.000 1.129  2.096  1.292  0.527  0.176
#> Item.post_7  0.000 1.245  1.335  0.562 -0.050 -0.779
#> Item.post_8  0.000 0.860  0.660  0.102 -0.707 -1.224
#> Item.post_9  0.000 1.238  1.199  0.386 -0.117 -0.566
#> Item.post_10 0.000 0.975 -0.464 -1.387 -1.724 -2.321
#> Item.post_11 0.000 1.249  0.317 -0.635 -1.326 -1.658
#> Item.post_12 0.000 1.148  0.198 -0.349 -1.007 -1.393
#> Item.post_13 0.000 0.922  0.187 -0.174 -0.658 -1.094
#> Item.post_14 0.000 1.200  0.247 -0.413 -0.789 -1.401
#> Item.post_15 0.000 1.426  1.342  0.764 -0.109 -0.803
#> Item.post_16 0.000 0.986  1.531  0.732 -0.210 -1.229
#> Item.post_17 0.000 1.423  0.216 -0.164 -0.989 -1.416
#> Item.post_18 0.000 0.929 -0.060 -0.585 -1.506 -2.202
#> Item.post_19 0.000 0.821  1.335  0.690  0.264 -0.402
#> Item.post_20 0.000 0.751  0.888  0.326 -0.521 -1.487
#> 
#> $means
#>  thetapre thetapost 
#>     0.000    -0.552 

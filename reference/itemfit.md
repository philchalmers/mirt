...
#> $`theta = -0.7497`
#>       Observed  Expected z.Residual
#> cat_0      135 128.19072  0.6014131
#> cat_1       65  71.80928 -0.8035462
#> 
#> $`theta = -0.4577`
#>       Observed Expected  z.Residual
#> cat_0      115 114.2782  0.06752011
#> cat_1       85  85.7218 -0.07795953
#> 
#> $`theta = -0.193`
#>       Observed  Expected z.Residual
#> cat_0       87 101.13957  -1.405969
#> cat_1      113  98.86043   1.422083
#> 
#> $`theta = 0.0765`
#>       Observed Expected z.Residual
#> cat_0       83  87.7275 -0.5047354
#> cat_1      117 112.2725  0.4461645
#> 
#> $`theta = 0.3374`
#>       Observed  Expected z.Residual
#> cat_0       65  75.15333 -1.1712089
#> cat_1      135 124.84667  0.9086989
#> 
#> $`theta = 0.6728`
#>       Observed  Expected z.Residual
#> cat_0       53  60.18187 -0.9257732
#> cat_1      147 139.81813  0.6073733
#> 
#> $`theta = 1.0787`
#>       Observed  Expected  z.Residual
#> cat_0       45  44.57924  0.06301919
#> cat_1      155 155.42076 -0.03375084
#> 
#> $`theta = 1.9249`
#>       Observed  Expected  z.Residual
#> cat_0       21  21.91506 -0.19546939
#> cat_1      179 178.08494  0.06857037
#> 
...
#> $`theta = -0.9751`
#>       Observed  Expected z.Residual
#> cat_0       99 89.203380  1.0372552
#> cat_1       78 87.319103 -0.9972854
#> cat_2       14 20.552208 -1.4453014
#> cat_3        5  2.585006  1.5020534
#> cat_4        6  2.340304  2.3922625
#> 
#> $`theta = -0.4747`
#>       Observed  Expected  z.Residual
#> cat_0       54 55.810787 -0.24238638
#> cat_1       93 90.110919  0.30434836
#> cat_2       36 34.983073  0.17193355
#> cat_3        7  7.257588 -0.09561565
#> cat_4        9 10.837633 -0.55820221
#> 
#> $`theta = -0.2825`
#>       Observed Expected z.Residual
#> cat_0       41 43.95425 -0.4456010
#> cat_1      102 86.00269  1.7250079
#> cat_2       34 40.46173 -1.0158431
#> cat_3        6 10.17257 -1.3082426
#> cat_4       16 18.40877 -0.5614133
#> 
#> $`theta = -0.151`
#>       Observed Expected z.Residual
#> cat_0       33 36.30417 -0.5483834
#> cat_1       75 81.02016 -0.6688239
#> cat_2       42 43.47614 -0.2238731
#> cat_3       13 12.46702  0.1509491
#> cat_4       36 25.73251  2.0240601
#> 
#> $`theta = -0.0334`
#>       Observed Expected z.Residual
#> cat_0       19 29.93240 -1.9982264
#> cat_1       86 75.13519  1.2534305
#> cat_2       53 45.34888  1.1361656
#> cat_3       13 14.62660 -0.4253146
#> cat_4       28 33.95692 -1.0222513
#> 
#> $`theta = 0.0651`
#>       Observed Expected z.Residual
#> cat_0       22 25.02024 -0.6038036
#> cat_1       68 69.30467 -0.1567179
#> cat_2       56 46.15883  1.4485032
#> cat_3       17 16.42861  0.1409716
#> cat_4       36 42.08766 -0.9383669
#> 
#> $`theta = 0.1642`
#>       Observed Expected z.Residual
#> cat_0       19 20.52948 -0.3375636
#> cat_1       64 62.79335  0.1522733
#> cat_2       47 46.18177  0.1204035
#> cat_3       22 18.15020  0.9036454
#> cat_4       47 51.34520 -0.6064006
#> 
#> $`theta = 0.2767`
#>       Observed Expected z.Residual
#> cat_0        5 16.04562 -2.7574765
#> cat_1       65 54.92377  1.3596215
#> cat_2       49 45.20489  0.5644577
#> cat_3       19 19.88220 -0.1978485
#> cat_4       61 62.94353 -0.2449710
#> 
#> $`theta = 0.4165`
#>       Observed Expected z.Residual
#> cat_0        9 11.43308 -0.7195735
#> cat_1       43 45.00328 -0.2986205
#> cat_2       48 42.59379  0.8283614
#> cat_3       24 21.54280  0.5294066
#> cat_4       75 78.42705 -0.3869788
#> 
#> $`theta = 0.7405`
#>       Observed   Expected z.Residual
#> cat_0        5   4.631342  0.1713048
#> cat_1       22  25.205952 -0.6385656
#> cat_2       42  32.985312  1.5696052
#> cat_3       24  23.067040  0.1942528
#> cat_4      109 116.110354 -0.6598660
#> 

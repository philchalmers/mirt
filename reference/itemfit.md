...
#> $`theta = -1.7718`
#>       Observed  Expected z.Residual
#> cat_1      178 166.44926  0.8953008
#> cat_2       22  33.55074 -1.9941546
#> 
#> $`theta = -1.0782`
#>       Observed  Expected z.Residual
#> cat_1      147 142.51602  0.3756054
#> cat_2       53  57.48398 -0.5914121
#> 
#> $`theta = -0.7497`
#>       Observed  Expected z.Residual
#> cat_1      138 128.19072  0.8663808
#> cat_2       62  71.80928 -1.1575688
#> 
#> $`theta = -0.4577`
#>       Observed Expected z.Residual
#> cat_1      109 114.2782 -0.4937469
#> cat_2       91  85.7218  0.5700861
#> 
#> $`theta = -0.193`
#>       Observed  Expected z.Residual
#> cat_1       91 101.13957  -1.008228
#> cat_2      109  98.86043   1.019784
#> 
#> $`theta = 0.0765`
#>       Observed Expected z.Residual
#> cat_1       77  87.7275  -1.145330
#> cat_2      123 112.2725   1.012423
#> 
#> $`theta = 0.3374`
#>       Observed  Expected z.Residual
#> cat_1       74  75.15333 -0.1330391
#> cat_2      126 124.84667  0.1032203
#> 
#> $`theta = 0.6728`
#>       Observed  Expected z.Residual
#> cat_1       47  60.18187  -1.699199
#> cat_2      153 139.81813   1.114796
#> 
#> $`theta = 1.0787`
#>       Observed  Expected z.Residual
#> cat_1       47  44.57924  0.3625653
#> cat_2      153 155.42076 -0.1941771
#> 
#> $`theta = 1.9249`
#>       Observed  Expected   z.Residual
#> cat_1       22  21.91506  0.018144094
#> cat_2      178 178.08494 -0.006364921
#> 
...
#> $`theta = -0.9751`
#>       Observed  Expected z.Residual
#> cat_1       96 89.203274  0.7196302
#> cat_2       81 87.319279 -0.6762581
#> cat_3       14 20.552190 -1.4452982
#> cat_4        5  2.584993  1.5020654
#> cat_5        6  2.340264  2.3923098
#> 
#> $`theta = -0.4747`
#>       Observed  Expected z.Residual
#> cat_1       52 55.810605 -0.5100768
#> cat_2       98 90.111135  0.8310464
#> cat_3       34 34.983142 -0.1662214
#> cat_4        6  7.257589 -0.4668126
#> cat_5        9 10.837528 -0.5581731
#> 
#> $`theta = -0.2825`
#>       Observed Expected z.Residual
#> cat_1       45 43.95405  0.1577652
#> cat_2       95 86.00287  0.9701688
#> cat_3       34 40.46184 -1.0158593
#> cat_4        9 10.17259 -0.3676465
#> cat_5       16 18.40864 -0.5613857
#> 
#> $`theta = -0.151`
#>       Observed Expected z.Residual
#> cat_1       33 36.30398 -0.5483529
#> cat_2       74 81.02032 -0.7799379
#> cat_3       45 43.47628  0.2310896
#> cat_4       11 12.46706 -0.4154939
#> cat_5       36 25.73237  2.0240925
#> 
#> $`theta = -0.0334`
#>       Observed Expected z.Residual
#> cat_1       19 29.93222 -1.9981990
#> cat_2       90 75.13532  1.7148795
#> cat_3       48 45.34903  0.3936594
#> cat_4       12 14.62666 -0.6868010
#> cat_5       30 33.95678 -0.6790139
#> 
#> $`theta = 0.0651`
#>       Observed Expected z.Residual
#> cat_1       23 25.02007 -0.4038516
#> cat_2       62 69.30476 -0.8774538
#> cat_3       63 46.15898  2.4787928
#> cat_4       17 16.42868  0.1409549
#> cat_5       34 42.08752 -1.2466326
#> 
#> $`theta = 0.1642`
#>       Observed Expected  z.Residual
#> cat_1       19 20.52933 -0.33753058
#> cat_2       63 62.79341  0.02607073
#> cat_3       45 46.18193 -0.17392181
#> cat_4       23 18.15027  1.13834925
#> cat_5       49 51.34506 -0.32726919
#> 
#> $`theta = 0.2767`
#>       Observed Expected   z.Residual
#> cat_1        4 16.04548 -3.007099726
#> cat_2       66 54.92379  1.494551513
#> cat_3       47 45.20504  0.266969704
#> cat_4       19 19.88229 -0.197868736
#> cat_5       63 62.94340  0.007134114
#> 
#> $`theta = 0.4164`
#>       Observed Expected z.Residual
#> cat_1       11 11.43297 -0.1280506
#> cat_2       44 45.00327 -0.1495531
#> cat_3       48 42.59391  0.8283409
#> cat_4       26 21.54290  0.9602843
#> cat_5       70 78.42694 -0.9515622
#> 
#> $`theta = 0.7405`
#>       Observed   Expected z.Residual
#> cat_1        4   4.631286 -0.2933428
#> cat_2       23  25.205901 -0.4393746
#> cat_3       43  32.985379  1.7437081
#> cat_4       22  23.067149 -0.2221919
#> cat_5      110 116.110285 -0.5670562
#> 

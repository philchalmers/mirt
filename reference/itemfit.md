...
#> cat_1      183 158.63869   1.934176
#> cat_2       17  41.36131  -3.787943
#> 
#> $`theta = -0.9416`
#>       Observed  Expected z.Residual
#> cat_1      149 138.43172  0.8982277
#> cat_2       51  61.56828 -1.3468702
#> 
#> $`theta = -0.6475`
#>       Observed  Expected z.Residual
#> cat_1      132 124.64146  0.6591135
#> cat_2       68  75.35854 -0.8476670
#> 
#> $`theta = -0.3921`
#>       Observed  Expected  z.Residual
#> cat_1      112 111.77447  0.02133235
#> cat_2       88  88.22553 -0.02401114
#> 
#> $`theta = -0.1393`
#>       Observed  Expected z.Residual
#> cat_1       88  98.63125  -1.070476
#> cat_2      112 101.36875   1.055923
#> 
#> $`theta = 0.0936`
#>       Observed Expected  z.Residual
#> cat_1       86  86.5533 -0.05947283
#> cat_2      114 113.4467  0.05194748
#> 
#> $`theta = 0.346`
#>       Observed  Expected z.Residual
#> cat_1       61  73.91477  -1.502177
#> cat_2      139 126.08523   1.150150
#> 
#> $`theta = 0.6087`
#>       Observed  Expected z.Residual
#> cat_1       54  61.64828 -0.9740998
#> cat_2      146 138.35172  0.6502370
#> 
#> $`theta = 0.9646`
#>       Observed Expected z.Residual
#> cat_1       41  47.0127 -0.8769235
#> cat_2      159 152.9873  0.4861179
#> 
#> $`theta = 1.5621`
#>       Observed  Expected z.Residual
#> cat_1       24  28.27768 -0.8044264
#> cat_2      176 171.72232  0.3264336
#> 
...
#> $`theta = -1.7718`
#>       Observed  Expected z.Residual
#> cat_1      176 166.44926  0.7402803
#> cat_2       24  33.55074 -1.6488687
#> 
#> $`theta = -1.0782`
#>       Observed  Expected z.Residual
#> cat_1      150 142.51602  0.6269036
#> cat_2       50  57.48398 -0.9870955
#> 
#> $`theta = -0.7497`
#>       Observed  Expected z.Residual
#> cat_1      135 128.19072  0.6014131
#> cat_2       65  71.80928 -0.8035462
#> 
#> $`theta = -0.4577`
#>       Observed Expected  z.Residual
#> cat_1      115 114.2782  0.06752011
#> cat_2       85  85.7218 -0.07795953
#> 
#> $`theta = -0.193`
#>       Observed  Expected z.Residual
#> cat_1       87 101.13957  -1.405969
#> cat_2      113  98.86043   1.422083
#> 
#> $`theta = 0.0765`
#>       Observed Expected z.Residual
#> cat_1       83  87.7275 -0.5047354
#> cat_2      117 112.2725  0.4461645
#> 
#> $`theta = 0.3374`
#>       Observed  Expected z.Residual
#> cat_1       65  75.15333 -1.1712089
#> cat_2      135 124.84667  0.9086989
#> 
#> $`theta = 0.6728`
#>       Observed  Expected z.Residual
#> cat_1       53  60.18187 -0.9257732
#> cat_2      147 139.81813  0.6073733
#> 
#> $`theta = 1.0787`
#>       Observed  Expected  z.Residual
#> cat_1       45  44.57924  0.06301919
#> cat_2      155 155.42076 -0.03375084
#> 
#> $`theta = 1.9249`
#>       Observed  Expected  z.Residual
#> cat_1       21  21.91506 -0.19546939
#> cat_2      179 178.08494  0.06857037
#> 
...
#> $`theta = -1.4692`
#>       Observed  Expected z.Residual
#> cat_1       98 65.020718  4.0899247
#> cat_2       76 88.468143 -1.3255872
#> cat_3       12 26.774054 -2.8552400
#> cat_4        7  6.656543  0.1331215
#> cat_5        7 13.080542 -1.6812388
#> 
#> $`theta = -0.8519`
#>       Observed  Expected z.Residual
#> cat_1       65 45.508938  2.8892636
#> cat_2       87 88.222767 -0.1301827
#> cat_3       29 35.896766 -1.1511126
#> cat_4        6  9.834511 -1.2227385
#> cat_5       13 20.537019 -1.6631481
#> 
#> $`theta = -0.5476`
#>       Observed Expected z.Residual
#> cat_1       35 37.54994 -0.4161270
#> cat_2       97 85.03642  1.2973549
#> cat_3       34 40.25662 -0.9861003
#> cat_4        5 11.70198 -1.9591763
#> cat_5       29 25.45504  0.7026267
#> 
#> $`theta = -0.3145`
#>       Observed Expected z.Residual
#> cat_1       27 32.21053 -0.9180857
#> cat_2       91 81.40120  1.0639013
#> cat_3       40 43.28252 -0.4989437
#> cat_4       15 13.23174  0.4861130
#> cat_5       27 29.87400 -0.5258232
#> 
#> $`theta = -0.0993`
#>       Observed Expected z.Residual
#> cat_1       23 27.84181 -0.9176111
#> cat_2       73 77.27754 -0.4865943
#> cat_3       60 45.69537  2.1161218
#> cat_4       12 14.68759 -0.7012737
#> cat_5       32 34.49770 -0.4252515
#> 
#> $`theta = 0.1116`
#>       Observed Expected  z.Residual
#> cat_1       23 24.05321 -0.21474860
#> cat_2       73 72.66989  0.03872444
#> cat_3       50 47.59720  0.34827910
#> cat_4       16 16.11821 -0.02944308
#> cat_5       38 39.56149 -0.24825845
#> 
#> $`theta = 0.3293`
#>       Observed Expected   z.Residual
#> cat_1       18 20.61824 -0.576612407
#> cat_2       69 67.48888  0.183942450
#> cat_3       49 48.98546  0.002077898
#> cat_4       24 17.55297  1.538809131
#> cat_5       40 45.35445 -0.795069543
#> 
#> $`theta = 0.5568`
#>       Observed Expected  z.Residual
#> cat_1        6 17.49926 -2.74890777
#> cat_2       60 61.79242 -0.22801909
#> cat_3       56 49.73600  0.88821096
#> cat_4       19 18.94936  0.01163316
#> cat_5       59 52.02296  0.96732827
#> 
#> $`theta = 0.8512`
#>       Observed Expected z.Residual
#> cat_1        7 14.09896 -1.8906068
#> cat_2       45 54.28449 -1.2601441
#> cat_3       48 49.58044 -0.2244513
#> cat_4       26 20.49440  1.2161493
#> cat_5       74 61.54171  1.5880848
#> 
#> $`theta = 1.4358`
#>       Observed  Expected z.Residual
#> cat_1        6  9.087564 -1.0242177
#> cat_2       25 40.094053 -2.3837784
#> cat_3       44 45.694100 -0.2506161
#> cat_4       21 22.208083 -0.2563547
#> cat_5      104 82.916200  2.3154169
#> 
...
#> 5   Item_5  1.121    3.943 1.094   3.495
...
#> 2   Item_2  0.997   -0.107 1.004   0.145 146.660     103      0.015  0.003
#> 3   Item_3  0.917   -3.282 0.919  -3.385 114.783     103      0.008  0.201
#> 4   Item_4  0.884   -4.448 0.896  -4.291 121.470     102      0.010  0.092
#> 5   Item_5  1.006    0.235 1.009   0.349 204.449     103      0.023  0.000
#> 6   Item_6  0.880   -4.515 0.895  -4.216  93.810     103      0.000  0.730
#> 7   Item_7  0.852   -5.852 0.866  -5.667 129.879     102      0.012  0.033
#> 8   Item_8  0.862   -5.636 0.870  -5.607 120.880     102      0.010  0.098
#> 9   Item_9  0.855   -5.841 0.867  -5.722  96.813     102      0.000  0.627
...
#> 1   Item_1 51.562    36    0.015 0.045 52.364    36    0.015 0.038
#> 2   Item_2 70.395    36    0.022 0.001 66.866    36    0.021 0.001
#> 3   Item_3 58.397    36    0.018 0.011 57.929    36    0.017 0.012
#> 4   Item_4 41.208    36    0.009 0.253 39.767    36    0.007 0.306
#> 5   Item_5 99.176    36    0.030 0.000 85.800    36    0.026 0.000
#> 6   Item_6 33.193    36    0.000 0.603 33.995    36    0.000 0.564
#> 7   Item_7 68.952    36    0.021 0.001 76.216    35    0.024 0.000
#> 8   Item_8 53.451    36    0.016 0.031 56.312    36    0.017 0.017
#> 9   Item_9 61.383    36    0.019 0.005 64.540    36    0.020 0.002
#> 10 Item_10 44.450    36    0.011 0.158 46.605    36    0.012 0.111
itemfit(raschfit, empirical.plot=1, Theta=thetas)

itemfit(raschfit, 'X2', return.tables=TRUE, which.items=1, Theta=thetas)
#> $`theta = -0.9751`
#>       Observed  Expected z.Residual
#> cat_1       99 89.203380  1.0372552
#> cat_2       78 87.319103 -0.9972854
#> cat_3       14 20.552208 -1.4453014
#> cat_4        5  2.585006  1.5020534
#> cat_5        6  2.340304  2.3922625
#> 
#> $`theta = -0.4747`
#>       Observed  Expected  z.Residual
#> cat_1       54 55.810787 -0.24238638
#> cat_2       93 90.110919  0.30434836
#> cat_3       36 34.983073  0.17193355
#> cat_4        7  7.257588 -0.09561565
#> cat_5        9 10.837633 -0.55820221
#> 
#> $`theta = -0.2825`
#>       Observed Expected z.Residual
#> cat_1       41 43.95425 -0.4456010
#> cat_2      102 86.00269  1.7250079
#> cat_3       34 40.46173 -1.0158431
#> cat_4        6 10.17257 -1.3082426
#> cat_5       16 18.40877 -0.5614133
#> 
#> $`theta = -0.151`
#>       Observed Expected z.Residual
#> cat_1       33 36.30417 -0.5483834
#> cat_2       75 81.02016 -0.6688239
#> cat_3       42 43.47614 -0.2238731
#> cat_4       13 12.46702  0.1509491
#> cat_5       36 25.73251  2.0240601
#> 
#> $`theta = -0.0334`
#>       Observed Expected z.Residual
#> cat_1       19 29.93240 -1.9982264
#> cat_2       86 75.13519  1.2534305
#> cat_3       53 45.34888  1.1361656
#> cat_4       13 14.62660 -0.4253146
#> cat_5       28 33.95692 -1.0222513
#> 
#> $`theta = 0.0651`
#>       Observed Expected z.Residual
#> cat_1       22 25.02024 -0.6038036
#> cat_2       68 69.30467 -0.1567179
#> cat_3       56 46.15883  1.4485032
#> cat_4       17 16.42861  0.1409716
#> cat_5       36 42.08766 -0.9383669
#> 
#> $`theta = 0.1642`
#>       Observed Expected z.Residual
#> cat_1       19 20.52948 -0.3375636
#> cat_2       64 62.79335  0.1522733
#> cat_3       47 46.18177  0.1204035
#> cat_4       22 18.15020  0.9036454
#> cat_5       47 51.34520 -0.6064006
#> 
#> $`theta = 0.2767`
#>       Observed Expected z.Residual
#> cat_1        5 16.04562 -2.7574765
#> cat_2       65 54.92377  1.3596215
#> cat_3       49 45.20489  0.5644577
#> cat_4       19 19.88220 -0.1978485
#> cat_5       61 62.94353 -0.2449710
#> 
#> $`theta = 0.4165`
#>       Observed Expected z.Residual
#> cat_1        9 11.43308 -0.7195735
#> cat_2       43 45.00328 -0.2986205
#> cat_3       48 42.59379  0.8283614
#> cat_4       24 21.54280  0.5294066
#> cat_5       75 78.42705 -0.3869788
#> 
#> $`theta = 0.7405`
#>       Observed   Expected z.Residual
#> cat_1        5   4.631342  0.1713048
#> cat_2       22  25.205952 -0.6385656
#> cat_3       42  32.985312  1.5696052
#> cat_4       24  23.067040  0.1942528
#> cat_5      109 116.110354 -0.6598660
#> 

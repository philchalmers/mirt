...
#>  0.245  0.026  0.094  0.112  0.000  0.001 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.223  0.026  0.089  0.087  0.000  0.000 
...
#> $Item_1
#>        a1 a2     d g u
#> par 1.468  0 -1.07 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.565  0 -1.456 0 1
#> 
#> $Item_3
#>        a1 a2    d g u
#> par 1.043  0 1.47 0 1
#> 
#> $Item_4
#>        a1    a2     d g u
#> par 1.008 0.377 0.006 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2     d3
#> par  0 1.441 3.038 1.968 -0.418
#> 
#> $Item_6
#>     a1    a2   d1    d2     d3
#> par  0 0.586 2.47 1.099 -0.882
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 1.181 2.029 -0.022
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 0.879 0.979 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.492      1
...
#> Item_2 0.315       0.099
#> Item_3 0.522       0.273
#> Item_4 0.501 0.187 0.286
#> Item_5       0.646 0.418
#> Item_6       0.325 0.106
#> Item_7       0.570 0.325
#> Item_8       0.459 0.210
#> 
#> SS loadings:  1.05 1.094 
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.079  -0.021  -0.006  -0.003   0.018   0.061 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.011  0.008 -0.004 -0.064 -0.052  0.016 -0.007
#> Item_2  0.244        -0.030 -0.001 -0.049 -0.022  0.032 -0.021
#> Item_3  0.138  1.856         0.006 -0.079  0.059  0.006 -0.015
#> Item_4  0.036  0.003  0.066         0.061  0.026 -0.021 -0.014
#> Item_5  8.212  4.791 12.547  7.558        -0.043  0.055 -0.015
#> Item_6  5.467  0.982  6.928  1.349 11.213         0.037  0.050
#> Item_7  0.491  2.006  0.083  0.883 12.234  5.438        -0.012
#> Item_8  0.109  0.866  0.475  0.407  0.451  5.038  0.299       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.973 1.455  0 -1.162 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.341 0.399  0 -1.443 0 1
#> 
#> $Item_3
#>       a1    a2 a3     d g u
#> par 0.63 0.757  0 1.449 0 1
#> 
#> $Item_4
#>       a1    a2 a3    d g u
#> par 1.21 0.583  0 0.01 0 1
#> 
#> $Item_5
#>       a1 a2    a3    d1    d2     d3
#> par 1.05  0 0.922 3.015 1.955 -0.404
#> 
#> $Item_6
#>        a1 a2    a3    d1   d2     d3
#> par 0.382  0 0.481 2.488 1.11 -0.884
#> 
#> $Item_7
#>        a1 a2    a3    d1     d2
#> par 0.906  0 0.833 2.066 -0.017
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.588  0 0.649 0.985 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.398 0.596       0.514
#> Item_2 0.192 0.224       0.087
#> Item_3 0.320 0.385       0.251
#> Item_4 0.558 0.269       0.384
#> Item_5 0.477       0.418 0.403
#> Item_6 0.211       0.266 0.115
#> Item_7 0.431       0.396 0.343
#> Item_8 0.307       0.339 0.209
#> 
#> SS loadings:  1.162 0.626 0.518 
#> Proportion Var:  0.145 0.078 0.065 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.048  -0.015   0.008   0.009   0.034   0.079 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.010  0.003 -0.011  0.064 -0.046  0.024  0.008
#> Item_2  0.193        -0.022  0.007 -0.048  0.022  0.034 -0.015
#> Item_3  0.022  0.995         0.015  0.079  0.060  0.010 -0.005
#> Item_4  0.247  0.106  0.443         0.062  0.034 -0.023 -0.004
#> Item_5  8.094  4.543 12.552  7.670        -0.044  0.055 -0.015
#> Item_6  4.192  0.950  7.236  2.312 11.458        -0.037  0.048
#> Item_7  1.125  2.329  0.181  1.102 12.305  5.468        -0.016
#> Item_8  0.137  0.425  0.057  0.027  0.439  4.614  0.528       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> mod1 24876.20 24931.95 24923.50 25005.02 -12415.10               
#> mod3 24887.04 24957.34 24946.68 25049.47 -12414.52 1.158  6 0.979

...
#>  0.250  0.029  0.083  0.123  0.000  0.001 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.214  0.030  0.090  0.073  0.000  0.000 
...
#> $Item_1
#>        a1 a2     d g u
#> par 1.358  0 -0.98 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.582  0 -1.438 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.973  0 1.522 0 1
#> 
#> $Item_4
#>        a1    a2      d g u
#> par 0.913 0.456 -0.053 0 1
#> 
#> $Item_5
#>     a1    a2    d1  d2     d3
#> par  0 1.602 3.104 2.1 -0.507
#> 
#> $Item_6
#>     a1   a2    d1    d2     d3
#> par  0 0.47 2.519 0.941 -1.122
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 0.826 2.017 -0.014
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 0.994 1.039 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.345      1
...
#> Item_2 0.324       0.105
#> Item_3 0.496       0.246
#> Item_4 0.460 0.230 0.264
#> Item_5       0.685 0.470
#> Item_6       0.266 0.071
#> Item_7       0.436 0.190
#> Item_8       0.504 0.254
#> 
#> SS loadings:  0.952 1.038 
#> Proportion Var:  0.119 0.13 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.044  -0.021  -0.004  -0.001   0.021   0.062 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.002 -0.015 -0.003  0.033  0.036  0.017 -0.025
#> Item_2  0.011         0.008 -0.010  0.021 -0.034 -0.005 -0.006
#> Item_3  0.468  0.136         0.007 -0.020 -0.036 -0.016 -0.017
#> Item_4  0.016  0.209  0.096         0.062 -0.044  0.022  0.004
#> Item_5  2.156  0.867  0.833  7.752        -0.035  0.038  0.023
#> Item_6  2.609  2.311  2.645  3.897  7.317        -0.036  0.040
#> Item_7  0.589  0.041  0.492  1.000  5.700  5.306        -0.040
#> Item_8  1.220  0.083  0.558  0.026  1.096  3.209  3.194       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.782 0.879  0 -0.923 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.309 0.558  0 -1.453 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.522 0.945  0 1.574 0 1
#> 
#> $Item_4
#>        a1    a2 a3      d g u
#> par 1.354 0.519  0 -0.059 0 1
#> 
#> $Item_5
#>       a1 a2    a3    d1    d2     d3
#> par 1.01  0 1.166 3.039 2.053 -0.498
#> 
#> $Item_6
#>        a1 a2    a3   d1    d2     d3
#> par 0.294  0 0.404 2.53 0.946 -1.128
#> 
#> $Item_7
#>        a1 a2    a3    d1     d2
#> par 0.556  0 0.618 2.016 -0.014
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.569  0 0.906 1.059 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.378 0.425       0.323
#> Item_2 0.170 0.307       0.123
#> Item_3 0.259 0.469       0.287
#> Item_4 0.606 0.232       0.421
#> Item_5 0.440       0.508 0.451
#> Item_6 0.166       0.228 0.079
#> Item_7 0.294       0.326 0.193
#> Item_8 0.283       0.451 0.283
#> 
#> SS loadings:  0.993 0.549 0.619 
#> Proportion Var:  0.124 0.069 0.077 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.062  -0.026  -0.011  -0.010   0.005   0.038 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.006 -0.010 -0.004  0.028  0.033 -0.019 -0.024
#> Item_2  0.067        -0.006 -0.013  0.021 -0.034 -0.005 -0.003
#> Item_3  0.191  0.061         0.005 -0.021 -0.035 -0.016 -0.010
#> Item_4  0.028  0.315  0.043        -0.062 -0.044 -0.024  0.015
#> Item_5  1.549  0.881  0.842  7.729        -0.036  0.038 -0.024
#> Item_6  2.202  2.285  2.497  3.874  7.611        -0.037  0.037
#> Item_7  0.738  0.056  0.511  1.148  5.734  5.474        -0.041
#> Item_8  1.150  0.017  0.193  0.476  1.111  2.721  3.425       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> mod1 24900.29 24956.04 24947.59 25029.11 -12427.14               
#> mod3 24910.83 24981.12 24970.47 25073.25 -12426.41 1.462  6 0.962

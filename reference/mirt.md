...
#>  0.270  0.053  0.076  0.125  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.209  0.029  0.092  0.067  0.000  0.001 
...
#> $Item_1
#>        a1 a2      d g u
#> par 2.068  0 -1.227 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.678  0 -1.472 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.884  0 1.393 0 1
#> 
#> $Item_4
#>       a1    a2      d g u
#> par 0.72 0.577 -0.057 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2     d3
#> par  0 1.201 2.598 1.705 -0.448
#> 
#> $Item_6
#>     a1   a2    d1    d2     d3
#> par  0 0.47 2.497 1.103 -0.936
#> 
#> $Item_7
#>     a1    a2   d1    d2
#> par  0 0.982 1.96 0.012
#> 
#> $Item_8
#>     a1    a2    d g u
#> par  0 1.138 1.09 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.381      1
...
#> Item_2 0.370       0.137
#> Item_3 0.461       0.212
#> Item_4 0.372 0.298 0.227
#> Item_5       0.577 0.333
#> Item_6       0.266 0.071
#> Item_7       0.500 0.250
#> Item_8       0.556 0.309
#> 
#> SS loadings:  1.084 1.051 
#> Proportion Var:  0.135 0.131 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.047  -0.024  -0.002  -0.001   0.020   0.059 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.007 -0.011 -0.005  0.030  0.019 -0.041 -0.007
#> Item_2  0.086        -0.011 -0.023 -0.039 -0.038  0.025  0.003
#> Item_3  0.240  0.259         0.019 -0.034 -0.027  0.059  0.013
#> Item_4  0.053  1.080  0.748         0.021  0.043 -0.014  0.002
#> Item_5  1.758  3.051  2.303  0.917         0.033  0.025 -0.047
#> Item_6  0.692  2.951  1.483  3.693  6.391        -0.037 -0.014
#> Item_7  3.415  1.248  7.050  0.383  2.419  5.435         0.019
#> Item_8  0.108  0.013  0.316  0.008  4.431  0.382  0.750       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 1.089 1.966  0 -1.304 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.278 0.585  0 -1.465 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.536 0.641  0 1.373 0 1
#> 
#> $Item_4
#>        a1    a2 a3      d g u
#> par 1.305 0.413  0 -0.062 0 1
#> 
#> $Item_5
#>        a1 a2   a3    d1    d2     d3
#> par 0.898  0 0.74 2.579 1.695 -0.435
#> 
#> $Item_6
#>        a1 a2    a3  d1    d2     d3
#> par 0.364  0 0.296 2.5 1.106 -0.933
#> 
#> $Item_7
#>       a1 a2    a3    d1   d2
#> par 0.63  0 0.868 2.018 0.02
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.797  0 0.852 1.108 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.386 0.697       0.636
#> Item_2 0.152 0.321       0.126
#> Item_3 0.283 0.338       0.194
#> Item_4 0.597 0.189       0.393
#> Item_5 0.436       0.359 0.319
#> Item_6 0.206       0.168 0.071
#> Item_7 0.313       0.431 0.284
#> Item_8 0.386       0.413 0.320
#> 
#> SS loadings:  1.089 0.74 0.514 
#> Proportion Var:  0.136 0.092 0.064 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.046  -0.030   0.000  -0.003   0.011   0.059 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.008 -0.005 -0.003  0.030  0.018 -0.028  0.003
#> Item_2  0.114        -0.002 -0.011 -0.038 -0.036  0.035  0.012
#> Item_3  0.043  0.012         0.010 -0.038 -0.034  0.059  0.007
#> Item_4  0.024  0.222  0.204        -0.021 -0.043  0.007  0.006
#> Item_5  1.851  2.847  2.892  0.907         0.033  0.024 -0.046
#> Item_6  0.622  2.649  2.315  3.645  6.474        -0.037 -0.014
#> Item_7  1.571  2.515  7.076  0.087  2.379  5.608         0.009
#> Item_8  0.019  0.311  0.088  0.082  4.232  0.397  0.175       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> mod1 25010.85 25066.60 25058.15 25139.67 -12482.42               
#> mod3 25020.68 25090.98 25080.32 25183.11 -12481.34 2.166  6 0.904

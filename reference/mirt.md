...
#>  0.243  0.026  0.089  0.113  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.205  0.027  0.082  0.074  0.000  0.000 
...
#> $Item_1
#>        a1 a2     d g u
#> par 1.538  0 -1.07 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.316  0 -1.442 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 1.097  0 1.514 0 1
#> 
#> $Item_4
#>        a1    a2     d g u
#> par 0.925 0.635 0.056 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2     d3
#> par  0 1.698 3.128 2.013 -0.424
#> 
#> $Item_6
#>     a1    a2   d1    d2     d3
#> par  0 0.495 2.53 1.019 -0.987
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 0.971 1.972 -0.005
#> 
#> $Item_8
#>     a1   a2     d g u
#> par  0 0.98 0.942 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.358      1
...
#> Item_2 0.183       0.033
#> Item_3 0.542       0.294
#> Item_4 0.454 0.312 0.303
#> Item_5       0.706 0.499
#> Item_6       0.279 0.078
#> Item_7       0.495 0.246
#> Item_8       0.499 0.249
#> 
#> SS loadings:  0.982 1.168 
#> Proportion Var:  0.123 0.146 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.053  -0.026  -0.009  -0.007   0.003   0.060 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.015  0.004 -0.006 -0.044  0.044 -0.025 -0.028
#> Item_2  0.429        -0.021  0.003  0.052 -0.021 -0.009  0.001
#> Item_3  0.039  0.871        -0.005 -0.051 -0.009  0.060 -0.003
#> Item_4  0.068  0.016  0.047        -0.019 -0.053 -0.013 -0.004
#> Item_5  3.928  5.329  5.109  0.693        -0.021 -0.028  0.043
#> Item_6  3.793  0.884  0.180  5.685  2.683        -0.039  0.028
#> Item_7  1.289  0.165  7.231  0.348  3.219  6.025        -0.052
#> Item_8  1.533  0.003  0.016  0.033  3.624  1.556  5.337       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.761 1.823  0 -1.224 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.197 0.274  0 -1.446 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.549 0.796  0 1.459 0 1
#> 
#> $Item_4
#>        a1   a2 a3     d g u
#> par 1.261 0.63  0 0.063 0 1
#> 
#> $Item_5
#>        a1 a2  a3    d1   d2     d3
#> par 1.403  0 1.1 3.215 2.08 -0.417
#> 
#> $Item_6
#>        a1 a2    a3    d1    d2     d3
#> par 0.375  0 0.328 2.535 1.024 -0.984
#> 
#> $Item_7
#>        a1 a2    a3    d1    d2
#> par 0.775  0 0.516 1.955 0.002
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.755  0 0.645 0.953 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.292 0.699       0.574
#> Item_2 0.114 0.158       0.038
#> Item_3 0.281 0.406       0.244
#> Item_4 0.571 0.285       0.407
#> Item_5 0.569       0.446 0.523
#> Item_6 0.212       0.185 0.079
#> Item_7 0.399       0.266 0.230
#> Item_8 0.383       0.328 0.254
#> 
#> SS loadings:  1.177 0.76 0.411 
#> Proportion Var:  0.147 0.095 0.051 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.053  -0.026  -0.016  -0.010   0.004   0.054 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.005  0.004 -0.007 -0.044  0.046 -0.025 -0.023
#> Item_2  0.046        -0.020 -0.006  0.047 -0.023 -0.017 -0.006
#> Item_3  0.032  0.768         0.007 -0.053 -0.013  0.051 -0.009
#> Item_4  0.108  0.079  0.112        -0.020  0.054 -0.014  0.005
#> Item_5  3.787  4.509  5.616  0.808        -0.022 -0.028 -0.044
#> Item_6  4.173  1.064  0.322  5.743  2.934        -0.038 -0.028
#> Item_7  1.261  0.564  5.221  0.416  3.190  5.888        -0.052
#> Item_8  1.055  0.078  0.160  0.055  3.819  1.597  5.319       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik   X2 df     p
#> mod1 24926.65 24982.39 24973.95 25055.47 -12440.32              
#> mod3 24936.48 25006.77 24996.12 25098.90 -12439.24 2.17  6 0.903

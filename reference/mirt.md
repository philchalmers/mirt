...
#>  0.241  0.033  0.082  0.111  0.000  0.001 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.215  0.034  0.084  0.075  0.000  0.000 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.352  0 -0.955 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.513  0 -1.467 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 1.165  0 1.679 0 1
#> 
#> $Item_4
#>        a1    a2      d g u
#> par 1.155 0.296 -0.007 0 1
#> 
#> $Item_5
#>     a1    a2    d1   d2     d3
#> par  0 1.575 3.059 2.11 -0.376
#> 
#> $Item_6
#>     a1    a2    d1 d2     d3
#> par  0 0.419 2.403  1 -0.974
#> 
#> $Item_7
#>     a1    a2   d1     d2
#> par  0 0.937 1.91 -0.006
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 0.975 0.969 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.458      1
...
#> Item_2 0.289       0.083
#> Item_3 0.565       0.319
#> Item_4 0.556 0.142 0.329
#> Item_5       0.679 0.461
#> Item_6       0.239 0.057
#> Item_7       0.482 0.232
#> Item_8       0.497 0.247
#> 
#> SS loadings:  1.098 1.018 
#> Proportion Var:  0.137 0.127 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.059  -0.026  -0.007  -0.001   0.027   0.060 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.017 -0.004 -0.010  0.060 -0.029 -0.059  0.002
#> Item_2  0.548        -0.036  0.007 -0.018 -0.015  0.026 -0.016
#> Item_3  0.039  2.568         0.008 -0.039  0.028  0.029  0.038
#> Item_4  0.206  0.111  0.124         0.030 -0.025 -0.028 -0.015
#> Item_5  7.216  0.679  3.088  1.753        -0.028 -0.012 -0.043
#> Item_6  1.683  0.467  1.539  1.223  4.847         0.047  0.045
#> Item_7  6.943  1.397  1.738  1.595  0.610  8.838         0.026
#> Item_8  0.011  0.529  2.927  0.466  3.649  4.055  1.313       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.854 0.962  0 -0.924 0 1
#> 
#> $Item_2
#>       a1    a2 a3      d g u
#> par 0.36 0.394  0 -1.469 0 1
#> 
#> $Item_3
#>        a1   a2 a3     d g u
#> par 0.772 0.82  0 1.667 0 1
#> 
#> $Item_4
#>        a1    a2 a3     d g u
#> par 1.154 0.787  0 0.005 0 1
#> 
#> $Item_5
#>        a1 a2    a3    d1    d2     d3
#> par 1.169  0 0.942 2.996 2.067 -0.355
#> 
#> $Item_6
#>        a1 a2   a3    d1    d2     d3
#> par 0.208  0 0.43 2.426 1.013 -0.982
#> 
#> $Item_7
#>        a1 a2    a3    d1    d2
#> par 0.676  0 0.707 1.933 0.001
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.699  0 0.761 0.991 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.400 0.451       0.364
#> Item_2 0.202 0.221       0.090
#> Item_3 0.378 0.402       0.305
#> Item_4 0.524 0.357       0.402
#> Item_5 0.515       0.415 0.438
#> Item_6 0.118       0.243 0.073
#> Item_7 0.344       0.360 0.248
#> Item_8 0.351       0.382 0.269
#> 
#> SS loadings:  1.14 0.541 0.507 
#> Proportion Var:  0.142 0.068 0.063 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.061  -0.028  -0.012  -0.007   0.019   0.043 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.017  0.009 -0.011 -0.061 -0.022 -0.059  0.007
#> Item_2  0.569        -0.037  0.006 -0.023  0.015  0.024 -0.019
#> Item_3  0.145  2.754         0.009 -0.048  0.031  0.028  0.036
#> Item_4  0.241  0.077  0.163         0.027  0.025 -0.027 -0.012
#> Item_5  7.387  1.061  4.622  1.490        -0.029 -0.013 -0.043
#> Item_6  0.931  0.466  1.955  1.266  4.955        -0.047  0.043
#> Item_7  7.057  1.133  1.544  1.512  0.686  8.981        -0.023
#> Item_8  0.087  0.740  2.642  0.302  3.719  3.632  1.081       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df p
#> mod1 24839.26 24895.01 24886.56 24968.08 -12396.63           
#> mod3 24850.96 24921.25 24910.60 25013.38 -12396.48 0.298  6 1

...
#>  0.238  0.026  0.079  0.118  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.231  0.046  0.086  0.077  0.000  0.001 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.507  0 -0.986 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.574  0 -1.477 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 1.141  0 1.476 0 1
#> 
#> $Item_4
#>        a1    a2      d g u
#> par 1.112 0.564 -0.026 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2    d3
#> par  0 1.513 2.943 2.031 -0.51
#> 
#> $Item_6
#>     a1   a2    d1   d2     d3
#> par  0 0.49 2.458 1.13 -0.937
#> 
#> $Item_7
#>     a1    a2    d1   d2
#> par  0 0.911 2.063 0.02
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 1.018 1.005 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.419      1
...
#> Item_2 0.320       0.102
#> Item_3 0.557       0.310
#> Item_4 0.527 0.267 0.349
#> Item_5       0.664 0.441
#> Item_6       0.277 0.076
#> Item_7       0.472 0.223
#> Item_8       0.513 0.263
#> 
#> SS loadings:  1.13 1.076 
#> Proportion Var:  0.141 0.134 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.050  -0.026   0.003  -0.001   0.018   0.065 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.025  0.012  0.004 -0.031 -0.050  0.014 -0.005
#> Item_2  1.289        -0.041  0.004  0.065 -0.007 -0.041  0.002
#> Item_3  0.297  3.317        -0.004  0.043 -0.045  0.017 -0.010
#> Item_4  0.032  0.027  0.039        -0.030 -0.036  0.016  0.006
#> Item_5  1.889  8.575  3.725  1.821         0.033 -0.016  0.021
#> Item_6  4.967  0.105  4.012  2.641  6.671         0.043 -0.024
#> Item_7  0.416  3.372  0.579  0.517  0.969  7.378         0.020
#> Item_8  0.060  0.007  0.201  0.078  0.848  1.172  0.820       
...
#> $Item_1
#>        a1 a2 a3      d g u
#> par 0.895  2  0 -1.208 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.349 0.431  0 -1.471 0 1
#> 
#> $Item_3
#>        a1   a2 a3    d g u
#> par 0.752 0.74  0 1.44 0 1
#> 
#> $Item_4
#>        a1    a2 a3      d g u
#> par 1.339 0.675  0 -0.022 0 1
#> 
#> $Item_5
#>        a1 a2    a3    d1    d2     d3
#> par 1.225  0 0.942 2.977 2.057 -0.508
#> 
#> $Item_6
#>        a1 a2    a3   d1    d2     d3
#> par 0.236  0 0.622 2.54 1.176 -0.972
#> 
#> $Item_7
#>        a1 a2    a3   d1    d2
#> par 0.715  0 0.542 2.06 0.025
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.834  0 0.536 1.002 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.323 0.721       0.624
#> Item_2 0.195 0.241       0.096
#> Item_3 0.375 0.369       0.277
#> Item_4 0.590 0.298       0.437
#> Item_5 0.533       0.410 0.452
#> Item_6 0.129       0.341 0.133
#> Item_7 0.371       0.282 0.217
#> Item_8 0.423       0.272 0.253
#> 
#> SS loadings:  1.249 0.803 0.437 
#> Proportion Var:  0.156 0.1 0.055 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.045  -0.024   0.005   0.000   0.017   0.060 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.013  0.005  0.006 -0.024  0.045  0.019 -0.005
#> Item_2  0.361        -0.033  0.008  0.060  0.009 -0.045 -0.006
#> Item_3  0.057  2.165         0.005  0.017 -0.040 -0.007 -0.032
#> Item_4  0.065  0.118  0.043        -0.031  0.020  0.016 -0.005
#> Item_5  1.123  7.119  0.555  1.929        -0.033 -0.016  0.021
#> Item_6  4.086  0.155  3.142  0.815  6.407         0.041 -0.026
#> Item_7  0.724  4.023  0.102  0.520  1.003  6.626         0.022
#> Item_8  0.050  0.081  2.085  0.055  0.922  1.318  0.958       
anova(mod1,mod3)
#>          AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> mod1 24767.7 24823.45 24815.00 24896.52 -12360.85               
#> mod3 24771.4 24841.70 24831.04 24933.83 -12356.70 8.295  6 0.217

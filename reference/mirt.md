...
#>  0.261  0.035  0.077  0.134  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.217  0.034  0.086  0.075  0.000  0.000 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.361  0 -0.988 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.482  0 -1.458 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.976  0 1.559 0 1
#> 
#> $Item_4
#>        a1    a2     d g u
#> par 1.374 0.552 -0.03 0 1
#> 
#> $Item_5
#>     a1    a2    d1   d2     d3
#> par  0 1.452 2.909 1.92 -0.512
#> 
#> $Item_6
#>     a1    a2    d1    d2     d3
#> par  0 0.472 2.574 1.056 -0.967
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 1.045 1.881 -0.036
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 1.092 0.931 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.298      1
...
#> Item_2 0.272       0.074
#> Item_3 0.497       0.247
#> Item_4 0.609 0.245 0.431
#> Item_5       0.649 0.421
#> Item_6       0.267 0.071
#> Item_7       0.523 0.274
#> Item_8       0.540 0.291
#> 
#> SS loadings:  1.082 1.118 
#> Proportion Var:  0.135 0.14 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.056  -0.025   0.007   0.002   0.027   0.050 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.020  0.003  0.003  0.036 -0.028 -0.021 -0.036
#> Item_2  0.834        -0.024 -0.016  0.036  0.023  0.024 -0.004
#> Item_3  0.018  1.188         0.003  0.027  0.030  0.015  0.031
#> Item_4  0.020  0.527  0.016         0.027 -0.056 -0.025  0.018
#> Item_5  2.662  2.661  1.465  1.424        -0.041 -0.051 -0.029
#> Item_6  1.544  1.082  1.804  6.196 10.323         0.033  0.050
#> Item_7  0.900  1.125  0.462  1.295 10.257  4.258         0.011
#> Item_8  2.537  0.033  1.883  0.615  1.668  5.055  0.258       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.584 1.417  0 -1.045 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.243 0.386  0 -1.452 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.546 0.771  0 1.543 0 1
#> 
#> $Item_4
#>        a1    a2 a3     d g u
#> par 1.412 1.055  0 -0.03 0 1
#> 
#> $Item_5
#>        a1 a2    a3    d1    d2     d3
#> par 1.151  0 0.731 2.849 1.883 -0.487
#> 
#> $Item_6
#>        a1 a2    a3    d1    d2     d3
#> par 0.181  0 0.614 2.655 1.101 -0.997
#> 
#> $Item_7
#>        a1 a2   a3    d1     d2
#> par 0.714  0 0.78 1.893 -0.031
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.859  0 0.825 0.967 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.255 0.619       0.448
#> Item_2 0.138 0.219       0.067
#> Item_3 0.280 0.396       0.236
#> Item_4 0.576 0.430       0.517
#> Item_5 0.528       0.335 0.391
#> Item_6 0.100       0.338 0.124
#> Item_7 0.356       0.389 0.278
#> Item_8 0.414       0.397 0.329
#> 
#> SS loadings:  1.081 0.773 0.536 
#> Proportion Var:  0.135 0.097 0.067 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.040  -0.018  -0.003   0.002   0.023   0.054 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.020 -0.003 -0.003  0.033  0.023 -0.017 -0.038
#> Item_2  0.817        -0.020 -0.014  0.029  0.024  0.021 -0.010
#> Item_3  0.020  0.773        -0.003 -0.020  0.035 -0.013  0.011
#> Item_4  0.015  0.383  0.023        -0.011  0.048 -0.021  0.007
#> Item_5  2.209  1.670  0.777  0.227        -0.040  0.054 -0.028
#> Item_6  1.082  1.158  2.509  4.515  9.740        -0.032  0.033
#> Item_7  0.574  0.853  0.316  0.880 11.511  4.220        -0.016
#> Item_8  2.933  0.218  0.236  0.098  1.588  2.118  0.528       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik     X2 df     p
#> mod1 24891.40 24947.15 24938.70 25020.22 -12422.70                
#> mod3 24888.93 24959.22 24948.57 25051.35 -12415.46 14.473  6 0.025
...
#> -1.39551 -0.32164  0.01535  0.33518  1.36794 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.01848    0.01503  -1.229    0.219    
#> covdata$X1   0.51260    0.01509  33.961   <2e-16 ***
#> covdata$X2  -0.98880    0.01534 -64.451   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.475 on 997 degrees of freedom
#> Multiple R-squared:  0.8358, Adjusted R-squared:  0.8355 
#> F-statistic:  2538 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[2]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.29087 -0.29649 -0.01164  0.28398  1.37078 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.01073    0.01413   0.759    0.448    
#> covdata$X1   0.50525    0.01419  35.596   <2e-16 ***
#> covdata$X2  -0.99828    0.01443 -69.193   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4467 on 997 degrees of freedom
#> Multiple R-squared:  0.8532, Adjusted R-squared:  0.8529 
#> F-statistic:  2897 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[3]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.41831 -0.32482  0.01564  0.30945  1.37141 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.0007157  0.0147259   0.049    0.961    
#> covdata$X1   0.5210850  0.0147891  35.234   <2e-16 ***
#> covdata$X2  -0.9883780  0.0150325 -65.750   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4654 on 997 degrees of freedom
#> Multiple R-squared:  0.8422, Adjusted R-squared:  0.8418 
#> F-statistic:  2660 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[4]]
#> 
...
#> Residuals:
#>     Min      1Q  Median      3Q     Max 
#> -1.3574 -0.3122  0.0069  0.3208  1.5359 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.00262    0.01463   0.179    0.858    
#> covdata$X1   0.51589    0.01469  35.112   <2e-16 ***
#> covdata$X2  -1.00221    0.01494 -67.106   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.43119 -0.31657 -0.02469  0.32105  1.41725 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.002286   0.014916  -0.153    0.878    
#> covdata$X1   0.504627   0.014980  33.686   <2e-16 ***
#> covdata$X2  -1.012624   0.015227 -66.504   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4715 on 997 degrees of freedom
#> Multiple R-squared:  0.8422, Adjusted R-squared:  0.8419 
#> F-statistic:  2660 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[6]]
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.40122 -0.31834  0.00206  0.30935  1.37821 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.0007952  0.0147257  -0.054    0.957    
#> covdata$X1   0.5015744  0.0147889  33.916   <2e-16 ***
#> covdata$X2  -0.9895702  0.0150322 -65.830   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4654 on 997 degrees of freedom
#> Multiple R-squared:  0.8403, Adjusted R-squared:   0.84 
#> F-statistic:  2624 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[7]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.34905 -0.30275 -0.00746  0.32451  1.90321 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.0001855  0.0145752   0.013     0.99    
#> covdata$X1   0.5197689  0.0146378  35.509   <2e-16 ***
#> covdata$X2  -1.0160815  0.0148786 -68.291   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4607 on 997 degrees of freedom
#> Multiple R-squared:  0.8504, Adjusted R-squared:  0.8501 
#> F-statistic:  2834 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[8]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.33028 -0.32230 -0.02018  0.31727  1.46745 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.01049    0.01488   0.705    0.481    
#> covdata$X1   0.50197    0.01494  33.594   <2e-16 ***
#> covdata$X2  -1.01258    0.01519 -66.669   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4703 on 997 degrees of freedom
#> Multiple R-squared:  0.8426, Adjusted R-squared:  0.8423 
#> F-statistic:  2668 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[9]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.56851 -0.30812  0.00182  0.30207  1.54987 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.001013   0.014668  -0.069    0.945    
#> covdata$X1   0.497077   0.014731  33.745   <2e-16 ***
#> covdata$X2  -0.996567   0.014973 -66.558   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4636 on 997 degrees of freedom
#> Multiple R-squared:  0.8425, Adjusted R-squared:  0.8421 
#> F-statistic:  2666 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[10]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.66703 -0.31220 -0.00087  0.32298  1.51385 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.00319    0.01455   0.219    0.826    
#> covdata$X1   0.52790    0.01461  36.133   <2e-16 ***
#> covdata$X2  -1.01323    0.01485 -68.229   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4598 on 997 degrees of freedom
#> Multiple R-squared:  0.8511, Adjusted R-squared:  0.8508 
#> F-statistic:  2850 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
...
averageMI(par, SEpar)
#>                par SEpar       t      df     p
#> (Intercept)  0.001 0.017   0.032 143.933 0.244
#> covdata$X1   0.511 0.018  28.078    76.6     0
#> covdata$X2  -1.002 0.019 -52.805  63.762     0
...
#> Item_1           0.996          0.000            0.000  1 0 0 1
#> Item_2           0.996          0.000            0.000  1 0 0 1
#> Item_3           0.996          0.000            0.000  1 0 0 1
#> Item_4           0.996          0.000            0.000  1 0 0 1
#> Item_5           0.996          0.000            0.000  1 0 0 1
#> Item_6           0.996          0.000            0.000  1 0 0 1
#> Item_7           0.996          0.000            0.000  1 0 0 1
#> Item_8           0.996          0.000            0.000  1 0 0 1
#> Item_9           0.996          0.000            0.000  1 0 0 1
#> Item_10          0.996          0.000            0.000  1 0 0 1
#> Item_11          0.000          0.000            0.023  1 0 0 1
#> Item_12          0.000          0.000            0.023  1 0 0 1
#> Item_13          0.000          0.000            0.023  1 0 0 1
#> Item_14          0.000          0.000            0.023  1 0 0 1
#> Item_15          0.000          0.000            0.023  1 0 0 1
#> Item_16          0.000          0.000            0.023  1 0 0 1
#> Item_17          0.000          0.000            0.023  1 0 0 1
#> Item_18          0.000          0.000            0.023  1 0 0 1
#> Item_19          0.000          0.000            0.023  1 0 0 1
#> Item_20          0.000          0.000            0.023  1 0 0 1
#> Item_21          0.000         -1.033            0.000  1 0 0 1
#> Item_22          0.000         -1.033            0.000  1 0 0 1
#> Item_23          0.000         -1.033            0.000  1 0 0 1
#> Item_24          0.000         -1.033            0.000  1 0 0 1
#> Item_25          0.000         -1.033            0.000  1 0 0 1
#> Item_26          0.000         -1.033            0.000  1 0 0 1
#> Item_27          0.000         -1.033            0.000  1 0 0 1
#> Item_28          0.000         -1.033            0.000  1 0 0 1
#> Item_29          0.000         -1.033            0.000  1 0 0 1
#> Item_30          0.000         -1.033            0.000  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> par          0.996         -1.033            0.023  1  0     -999      999
...
#>           AIC    SABIC       HQ      BIC    logLik     X2 df     p
#> lltm 34859.07 34866.00 34866.54 34878.70 -17425.54                
#> mod  34879.88 34933.56 34937.70 35032.02 -17408.94 33.195 27 0.191
...
itemfit(lltm)
#>       item   S_X2 df.S_X2 RMSEA.S_X2 p.S_X2
#> 1   Item_1 42.218      21      0.032  0.004
#> 2   Item_2 37.261      21      0.028  0.016
#> 3   Item_3 25.521      21      0.015  0.225
#> 4   Item_4 27.552      21      0.018  0.153
#> 5   Item_5 37.765      21      0.028  0.014
#> 6   Item_6 19.865      21      0.000  0.530
#> 7   Item_7 28.895      21      0.019  0.117
#> 8   Item_8 32.021      21      0.023  0.058
#> 9   Item_9 19.273      21      0.000  0.568
#> 10 Item_10 25.798      21      0.015  0.214
#> 11 Item_11 30.671      21      0.021  0.079
#> 12 Item_12 23.143      21      0.010  0.336
#> 13 Item_13 22.952      21      0.010  0.347
#> 14 Item_14 26.897      21      0.017  0.174
#> 15 Item_15 25.728      21      0.015  0.217
#> 16 Item_16 24.944      21      0.014  0.250
#> 17 Item_17 15.894      21      0.000  0.776
#> 18 Item_18 21.695      21      0.006  0.417
#> 19 Item_19 27.640      21      0.018  0.151
#> 20 Item_20 36.243      21      0.027  0.021
#> 21 Item_21 21.617      21      0.005  0.422
#> 22 Item_22 28.633      21      0.019  0.123
#> 23 Item_23 34.674      21      0.026  0.031
#> 24 Item_24 26.028      21      0.015  0.205
#> 25 Item_25 28.757      21      0.019  0.120
#> 26 Item_26 16.219      21      0.000  0.757
#> 27 Item_27 25.771      21      0.015  0.215
#> 28 Item_28 25.514      21      0.015  0.226
#> 29 Item_29 20.269      21      0.000  0.504
#> 30 Item_30 34.925      21      0.026  0.029
...
#>    Sum.Scores           F1     SE_F1 observed  expected     std.res
#> 0           0 -2.773475986 0.5838788        4  1.518288 2.014068357
#> 1           1 -2.459023094 0.5391205        3  4.554152 0.728265396
#> 2           2 -2.187704713 0.5038309        8  8.678484 0.230312635
#> 3           3 -1.948213750 0.4758555       10 13.474313 0.946489179
#> 4           4 -1.732627317 0.4535004       16 18.618738 0.606899807
#> 5           5 -1.535303046 0.4355031       27 23.871776 0.640258762
#> 6           6 -1.352131175 0.4209356       29 29.052267 0.009696935
#> 7           7 -1.180044252 0.4091146       32 34.018600 0.346092386
#> 8           8 -1.016695292 0.3995343       45 38.655958 1.020370296
#> 9           9 -0.860243425 0.3918178       46 42.868589 0.478267038
#> 10         10 -0.709208127 0.3856836       45 46.575450 0.230847965
#> 11         11 -0.562367613 0.3809212       48 49.707988 0.242254365
#> 12         12 -0.418686010 0.3773754       50 52.209217 0.305748844
#> 13         13 -0.277259408 0.3749347       54 54.033550 0.004564122
#> 14         14 -0.137274290 0.3735236       57 55.147026 0.249521632
#> 15         15  0.002026115 0.3730978       53 55.527743 0.339217252
#> 16         16  0.141370768 0.3736418       58 55.166334 0.381515015
#> 17         17  0.281487565 0.3751673       50 54.066423 0.553030051
#> 18         18  0.423130088 0.3777151       63 52.244996 1.487949578
#> 19         19  0.567106558 0.3813568       42 49.732653 1.096497696
#> 20         20  0.714313496 0.3862008       55 46.573752 1.234706259
#> 21         21  0.865777282 0.3923991       38 42.826509 0.737525131
#> 22         22  1.022708033 0.4001590       42 38.563242 0.553429268
#> 23         23  1.186572268 0.4097595       27 33.871060 1.180617797
#> 24         24  1.359194131 0.4215746       23 28.853569 1.089735183
#> 25         25  1.542900483 0.4361072       27 23.634431 0.692286507
#> 26         26  1.740734035 0.4540369       21 18.363966 0.615131095
#> 27         27  1.956773135 0.4762878       10 13.230335 0.888100515
#> 28         28  2.196618683 0.5041169        9  8.476507 0.179805129
#> 29         29  2.468136763 0.5392114        6  4.420833 0.751062546
#> 30         30  2.782555400 0.5837204        2  1.463249 0.443724472
M2(lltm) # goodness of fit
#>            M2  df     p RMSEA RMSEA_5 RMSEA_95 SRMSR TLI CFI
#> stats 459.399 461 0.512     0       0    0.011  0.03   1   1
head(personfit(lltm))
#>      outfit    z.outfit     infit     z.infit          Zh
#> 1 0.5909790 -1.26480067 0.7540553 -1.12317785  1.14048915
#> 2 0.9777909 -0.08914668 0.9795575 -0.09447836  0.14142935
#> 3 1.0218619  0.17540521 1.0075105  0.10007346 -0.06934174
#> 4 0.9480455 -0.19943223 0.9229679 -0.44895134  0.41181672
#> 5 0.8922050 -0.64431460 0.8984399 -0.67398094  0.68929460
#> 6 0.8092230 -0.64209179 0.9464484 -0.23481425  0.42901672
residuals(lltm)
#> LD matrix (lower triangle) and standardized residual correlations (upper triangle)
#> 
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.098  -0.048  -0.022  -0.001   0.048   0.097 
#> 
#>         Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8 Item_9 Item_10
#> Item_1         -0.048  0.067  0.036  0.057 -0.042 -0.054  0.033 -0.032  -0.028
#> Item_2   2.314        -0.053  0.039 -0.068 -0.078  0.058 -0.074 -0.055  -0.057
#> Item_3   4.436  2.766        -0.068 -0.062 -0.039 -0.052  0.034  0.056   0.034
#> Item_4   1.320  1.520  4.624        -0.079  0.043  0.058  0.039 -0.048  -0.043
#> Item_5   3.229  4.631  3.902  6.210         0.053  0.052 -0.034  0.041  -0.040
#> Item_6   1.806  6.040  1.513  1.839  2.760        -0.067 -0.048 -0.040   0.051
#> Item_7   2.875  3.418  2.719  3.380  2.748  4.550         0.050  0.054   0.056
#> Item_8   1.076  5.413  1.189  1.533  1.158  2.272  2.508         0.070   0.052
#> Item_9   1.017  3.011  3.189  2.310  1.667  1.560  2.930  4.844         -0.045
#> Item_10  0.797  3.235  1.153  1.816  1.634  2.566  3.140  2.727  1.991        
#> Item_11  2.295  2.464  1.809  3.153  3.028  3.305  4.444  2.462  2.003   4.092
#> Item_12  1.208  2.869  2.651  3.260  1.910  3.444  2.752  1.746  2.031   5.825
#> Item_13  3.679  4.364  3.266  4.101  4.803  3.709  6.040  4.449  3.611   8.246
#> Item_14  1.750  2.964  4.200  6.939  2.247  3.556  3.598  4.577  2.324   1.763
#> Item_15  1.996  5.561  2.396  4.102  3.960  4.004  5.720  2.116  2.643   2.880
#> Item_16  1.157  3.517  0.668  1.414  3.358  1.493  2.824  1.103  1.994   1.306
#> Item_17  1.600  0.855  1.070  1.190  1.050  1.504  6.955  0.988  3.456   1.013
#> Item_18  1.208  2.765  2.964  2.228  4.849  2.907  8.197  1.222  1.800   1.397
#> Item_19  0.300  2.196  1.311  1.650  2.731  1.424  2.138  0.927  1.686   0.719
#> Item_20  0.712  2.467  0.650  1.253  1.429  2.631  2.913  1.210  0.947   1.248
#> Item_21  2.007  1.657  4.470  1.761  2.285  2.067  5.666  1.748  5.531   1.994
#> Item_22  4.946  9.562  1.468  2.103  2.285  2.313  3.854  2.481  1.529   2.123
#> Item_23  2.005  7.340  1.822  1.345  1.818  2.127  8.156  2.256  2.807   1.692
#> Item_24  3.889  5.743  4.785  5.306  4.168  5.974  5.167  4.366  4.882   4.059
#> Item_25  1.358  1.479  2.097  2.725  5.855  5.865  4.255  0.502  2.053   2.872
#> Item_26  0.584  5.506  0.506  0.999  1.257  1.554  3.130  1.630  0.737   1.465
#> Item_27  2.874  2.504  1.847  3.222  1.942  3.073  9.360  4.761  2.051   1.793
#> Item_28  0.452  1.860  1.648  0.853  1.959  1.278  4.686  0.875  1.628   1.284
#> Item_29  0.584  0.967  1.108  1.625  1.268  3.768  4.175  1.289  4.719   1.265
#> Item_30  1.514  1.696  1.111  1.696  1.714  5.978  2.308  0.883  1.479   1.839
#>         Item_11 Item_12 Item_13 Item_14 Item_15 Item_16 Item_17 Item_18 Item_19
#> Item_1    0.048   0.035   0.061  -0.042  -0.045  -0.034   0.040   0.035   0.017
#> Item_2    0.050  -0.054  -0.066  -0.054  -0.075  -0.059  -0.029   0.053  -0.047
#> Item_3    0.043   0.051   0.057  -0.065   0.049  -0.026   0.033   0.054  -0.036
#> Item_4   -0.056   0.057   0.064  -0.083  -0.064   0.038  -0.034  -0.047  -0.041
#> Item_5   -0.055  -0.044   0.069   0.047   0.063   0.058   0.032   0.070   0.052
#> Item_6   -0.057  -0.059   0.061   0.060  -0.063  -0.039  -0.039  -0.054   0.038
#> Item_7   -0.067  -0.052  -0.078   0.060   0.076   0.053   0.083   0.091   0.046
#> Item_8    0.050   0.042  -0.067   0.068  -0.046   0.033   0.031   0.035  -0.030
#> Item_9    0.045  -0.045  -0.060   0.048  -0.051  -0.045   0.059  -0.042   0.041
#> Item_10  -0.064  -0.076  -0.091  -0.042   0.054  -0.036   0.032   0.037  -0.027
#> Item_11          -0.068  -0.063  -0.071   0.066  -0.045   0.055   0.063   0.047
#> Item_12   4.689          -0.080  -0.045  -0.048  -0.045  -0.035   0.047  -0.035
#> Item_13   3.956   6.407          -0.074  -0.087  -0.056   0.055   0.070   0.063
#> Item_14   5.054   2.062   5.421           0.056  -0.086   0.041  -0.045  -0.039
#> Item_15   4.407   2.339   7.533   3.161          -0.053   0.046   0.056   0.046
#> Item_16   2.037   2.026   3.123   7.476   2.787           0.032   0.047   0.028
#> Item_17   3.006   1.200   3.007   1.701   2.142   1.044           0.038   0.014
#> Item_18   3.938   2.193   4.842   2.062   3.150   2.231   1.427           0.031
#> Item_19   2.248   1.226   3.943   1.485   2.075   0.790   0.201   0.982        
#> Item_20   2.941   2.407   3.298   2.028   5.183   0.638   3.569   3.040   0.965
#> Item_21   2.329   2.654   3.548   3.507   3.468   1.534   1.919   2.478   1.181
#> Item_22   4.507   2.799   3.931   3.316   3.971   1.339   1.064   2.462   1.246
#> Item_23   2.119   2.070   4.811   2.640   2.727   5.882   2.510   3.228   0.785
#> Item_24   8.340   7.132   8.148   5.850   6.232   4.891   4.070   4.698   8.189
#> Item_25   3.912   7.152   4.796   2.902   2.230   0.818   0.504   2.492   1.374
#> Item_26   1.783   1.416   3.085   1.987   2.940   1.588   0.335   1.669   0.360
#> Item_27   3.487   2.221   6.799   2.242   4.297   5.131   1.529   2.870   4.257
#> Item_28   2.134   1.319   3.047   3.390   2.802   4.402   0.131   1.324   0.724
#> Item_29   5.530   6.215   3.025   1.872   2.295   0.580   0.335   1.669   3.271
#> Item_30   2.692   2.961   4.157   2.241   2.623   1.810   0.715   3.764   0.860
#>         Item_20 Item_21 Item_22 Item_23 Item_24 Item_25 Item_26 Item_27 Item_28
#> Item_1   -0.027  -0.045  -0.070  -0.045   0.062   0.037  -0.024  -0.054  -0.021
#> Item_2   -0.050  -0.041  -0.098  -0.086  -0.076  -0.038  -0.074  -0.050  -0.043
#> Item_3    0.025  -0.067  -0.038   0.043  -0.069  -0.046  -0.022  -0.043  -0.041
#> Item_4   -0.035   0.042  -0.046   0.037   0.073  -0.052   0.032  -0.057  -0.029
#> Item_5    0.038  -0.048  -0.048   0.043  -0.065   0.077   0.035  -0.044   0.044
#> Item_6   -0.051   0.045   0.048   0.046   0.077   0.077  -0.039   0.055   0.036
#> Item_7    0.054   0.075  -0.062   0.090  -0.072   0.065   0.056   0.097   0.068
#> Item_8    0.035  -0.042   0.050   0.047   0.066   0.022  -0.040   0.069  -0.030
#> Item_9    0.031  -0.074  -0.039  -0.053   0.070   0.045   0.027  -0.045  -0.040
#> Item_10  -0.035   0.045  -0.046  -0.041  -0.064  -0.054  -0.038   0.042   0.036
#> Item_11   0.054  -0.048  -0.067   0.046   0.091  -0.063  -0.042   0.059  -0.046
#> Item_12  -0.049  -0.052  -0.053   0.045  -0.084  -0.085  -0.038  -0.047   0.036
#> Item_13   0.057   0.060  -0.063   0.069   0.090   0.069  -0.056  -0.082   0.055
#> Item_14  -0.045  -0.059  -0.058  -0.051  -0.076  -0.054   0.045  -0.047  -0.058
#> Item_15   0.072  -0.059  -0.063  -0.052  -0.079  -0.047   0.054   0.066   0.053
#> Item_16   0.025   0.039  -0.037   0.077   0.070  -0.029   0.040   0.072   0.066
#> Item_17   0.060  -0.044  -0.033   0.050  -0.064  -0.022   0.018   0.039  -0.011
#> Item_18   0.055   0.050   0.050   0.057   0.069   0.050   0.041   0.054  -0.036
#> Item_19   0.031   0.034  -0.035   0.028  -0.090   0.037   0.019   0.065   0.027
#> Item_20          -0.034   0.039   0.046  -0.089  -0.029  -0.028   0.069  -0.026
#> Item_21   1.184           0.066  -0.038  -0.077   0.041  -0.087   0.052   0.033
#> Item_22   1.513   4.306           0.039   0.076   0.043   0.040   0.090   0.039
#> Item_23   2.141   1.414   1.510          -0.071   0.029   0.030   0.060   0.060
#> Item_24   7.892   5.957   5.754   4.998           0.063  -0.070   0.069  -0.067
#> Item_25   0.856   1.679   1.870   0.844   4.001          -0.025   0.048  -0.024
#> Item_26   0.805   7.547   1.619   0.898   4.942   0.632           0.065  -0.023
#> Item_27   4.715   2.755   8.156   3.628   4.785   2.328   4.164           0.040
#> Item_28   0.669   1.064   1.486   3.588   4.539   0.569   0.516   1.610        
#> Item_29   0.651   1.212   3.003   2.095   5.765   0.788   1.302   1.700   0.239
#> Item_30   2.384   6.072   1.982   1.431   5.502   0.648   1.307   1.591   0.878
#>         Item_29 Item_30
#> Item_1   -0.024  -0.039
#> Item_2    0.031   0.041
#> Item_3   -0.033  -0.033
...
#>               AIC SABIC       HQ      BIC    logLik X2 df   p
#> lltm     34859.07 34866 34866.54 34878.70 -17425.54          
#> lltm.int 34859.07 34866 34866.54 34878.71 -17425.54  0  0 NaN
...
#> Item_9        0.996          0.000            0.000  1 0 0 1
#> Item_10       0.996          0.000            0.000  1 0 0 1
#> Item_11       0.996          0.000           -0.973  1 0 0 1
#> Item_12       0.996          0.000           -0.973  1 0 0 1
#> Item_13       0.996          0.000           -0.973  1 0 0 1
#> Item_14       0.996          0.000           -0.973  1 0 0 1
#> Item_15       0.996          0.000           -0.973  1 0 0 1
#> Item_16       0.996          0.000           -0.973  1 0 0 1
#> Item_17       0.996          0.000           -0.973  1 0 0 1
#> Item_18       0.996          0.000           -0.973  1 0 0 1
#> Item_19       0.996          0.000           -0.973  1 0 0 1
#> Item_20       0.996          0.000           -0.973  1 0 0 1
#> Item_21       0.996         -2.029            0.000  1 0 0 1
#> Item_22       0.996         -2.029            0.000  1 0 0 1
#> Item_23       0.996         -2.029            0.000  1 0 0 1
#> Item_24       0.996         -2.029            0.000  1 0 0 1
#> Item_25       0.996         -2.029            0.000  1 0 0 1
#> Item_26       0.996         -2.029            0.000  1 0 0 1
#> Item_27       0.996         -2.029            0.000  1 0 0 1
#> Item_28       0.996         -2.029            0.000  1 0 0 1
#> Item_29       0.996         -2.029            0.000  1 0 0 1
#> Item_30       0.996         -2.029            0.000  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> $items
#>         difficultyeasy difficultyhard difficultymedium a1     d g u
#> Item_1            0.00          0.000            0.000  1 0.954 0 1
#> Item_2            0.00          0.000            0.000  1 1.073 0 1
#> Item_3            0.00          0.000            0.000  1 1.045 0 1
#> Item_4            0.00          0.000            0.000  1 1.073 0 1
#> Item_5            0.97          0.000            0.000  1 0.000 0 1
#> Item_6            0.97          0.000            0.000  1 0.000 0 1
#> Item_7            0.97          0.000            0.000  1 0.000 0 1
#> Item_8            0.97          0.000            0.000  1 0.000 0 1
#> Item_9            0.97          0.000            0.000  1 0.000 0 1
#> Item_10           0.97          0.000            0.000  1 0.000 0 1
#> Item_11           0.00          0.000            0.023  1 0.000 0 1
#> Item_12           0.00          0.000            0.023  1 0.000 0 1
#> Item_13           0.00          0.000            0.023  1 0.000 0 1
#> Item_14           0.00          0.000            0.023  1 0.000 0 1
#> Item_15           0.00          0.000            0.023  1 0.000 0 1
#> Item_16           0.00          0.000            0.023  1 0.000 0 1
#> Item_17           0.00          0.000            0.023  1 0.000 0 1
#> Item_18           0.00          0.000            0.023  1 0.000 0 1
#> Item_19           0.00          0.000            0.023  1 0.000 0 1
#> Item_20           0.00          0.000            0.023  1 0.000 0 1
#> Item_21           0.00         -1.033            0.000  1 0.000 0 1
#> Item_22           0.00         -1.033            0.000  1 0.000 0 1
#> Item_23           0.00         -1.033            0.000  1 0.000 0 1
#> Item_24           0.00         -1.033            0.000  1 0.000 0 1
#> Item_25           0.00         -1.033            0.000  1 0.000 0 1
#> Item_26           0.00         -1.033            0.000  1 0.000 0 1
#> Item_27           0.00         -1.033            0.000  1 0.000 0 1
#> Item_28           0.00         -1.033            0.000  1 0.000 0 1
#> Item_29           0.00         -1.033            0.000  1 0.000 0 1
#> Item_30           0.00         -1.033            0.000  1 0.000 0 1
#> 
#> $means
#> F1 
#>  0 
...
#>             AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> lltm   34859.07 34866.00 34866.54 34878.70 -17425.54               
#> lltm.4 34863.53 34877.38 34878.45 34902.79 -17423.76 3.543  4 0.471
...
#> , Max-Change = 0.1898, Max-Change = 0.1542, Max-Change = 0.1238, Max-Change = 0.1052, Max-Change = 0.0832, Max-Change = 0.0682, Max-Change = 0.0546, Max-Change = 0.0453, Max-Change = 0.0382, Max-Change = 0.0320, Max-Change = 0.0259, Max-Change = 0.0210, Max-Change = 0.0165, Max-Change = 0.0145, Max-Change = 0.0165, Max-Change = 0.0130, Max-Change = 0.0091, Max-Change = 0.0158, Max-Change = 0.0076, Max-Change = 0.0091, Max-Change = 0.0129, Max-Change = 0.0052, Max-Change = 0.0108, Max-Change = 0.0142, Max-Change = 0.0053, Max-Change = 0.0020, Max-Change = 0.0072, Max-Change = 0.0029, Max-Change = 0.0018, Max-Change = 0.0045, Max-Change = 0.0045, Max-Change = 0.0098, Max-Change = 0.0033, Max-Change = 0.0033, Max-Change = 0.0083, Max-Change = 0.0044, Max-Change = 0.0111, Max-Change = 0.0050, Max-Change = 0.0065, Max-Change = 0.0020, Max-Change = 0.0101, Max-Change = 0.0120, Max-Change = 0.0034, Max-Change = 0.0047, Max-Change = 0.0029, Max-Change = 0.0032, Max-Change = 0.0016, Max-Change = 0.0087, Max-Change = 0.0046, Max-Change = 0.0089, Max-Change = 0.0099, Max-Change = 0.0027, Max-Change = 0.0105, Max-Change = 0.0055, Max-Change = 0.0027, Max-Change = 0.0034, Max-Change = 0.0037, Max-Change = 0.0105, Max-Change = 0.0068, Max-Change = 0.0008, Max-Change = 0.0059, Max-Change = 0.0007, Max-Change = 0.0042, Max-Change = 0.0019, Max-Change = 0.0025, Max-Change = 0.0025, Max-Change = 0.0024, Max-Change = 0.0043, Max-Change = 0.0017, Max-Change = 0.0065, Max-Change = 0.0037, Max-Change = 0.0007, Max-Change = 0.0022, Max-Change = 0.0026, Max-Change = 0.0027, Max-Change = 0.0037, Max-Change = 0.0053, Max-Change = 0.0052, Max-Change = 0.0039, Max-Change = 0.0020, Max-Change = 0.0047, Max-Change = 0.0061, Max-Change = 0.0094, Max-Change = 0.0066, Max-Change = 0.0020, Max-Change = 0.0028, Max-Change = 0.0082, Max-Change = 0.0064, Max-Change = 0.0058, Max-Change = 0.0085, Max-Change = 0.0048, Max-Change = 0.0095, Max-Change = 0.0018, Max-Change = 0.0073, Max-Change = 0.0051, Max-Change = 0.0004, Max-Change = 0.0061, Max-Change = 0.0040, Max-Change = 0.0013, Max-Change = 0.0153, Max-Change = 0.0059, Max-Change = 0.0133, Max-Change = 0.0097, Max-Change = 0.0031, Max-Change = 0.0041, Max-Change = 0.0017, Max-Change = 0.0019, Max-Change = 0.0046, Max-Change = 0.0045, Max-Change = 0.0159, Max-Change = 0.0091, Max-Change = 0.0020, Max-Change = 0.0031, Max-Change = 0.0057, Max-Change = 0.0090, Max-Change = 0.0019, Max-Change = 0.0034, Max-Change = 0.0109, Max-Change = 0.0022, Max-Change = 0.0093, Max-Change = 0.0019, Max-Change = 0.0028, Max-Change = 0.0111, Max-Change = 0.0094, Max-Change = 0.0064, Max-Change = 0.0050, Max-Change = 0.0051, Max-Change = 0.0047, Max-Change = 0.0007, Max-Change = 0.0066, Max-Change = 0.0172, Max-Change = 0.0145, Max-Change = 0.0050, Max-Change = 0.0034, Max-Change = 0.0028, Max-Change = 0.0026, Max-Change = 0.0024, Max-Change = 0.0031, Max-Change = 0.0009, Max-Change = 0.0069, Max-Change = 0.0013, Max-Change = 0.0069, Max-Change = 0.0023, Max-Change = 0.0095, Max-Change = 0.0080, Max-Change = 0.0057, Max-Change = 0.0003, Max-Change = 0.0008, Max-Change = 0.0039, Max-Change = 0.0015, Max-Change = 0.0053, Max-Change = 0.0048, Max-Change = 0.0125, Max-Change = 0.0040, Max-Change = 0.0030, Max-Change = 0.0043, Max-Change = 0.0048, Max-Change = 0.0027, Max-Change = 0.0046, Max-Change = 0.0046, Max-Change = 0.0049, Max-Change = 0.0130, Max-Change = 0.0043, Max-Change = 0.0055, Max-Change = 0.0019, Max-Change = 0.0161, Max-Change = 0.0028, Max-Change = 0.0072, Max-Change = 0.0051, Max-Change = 0.0044, Max-Change = 0.0036, Max-Change = 0.0073, Max-Change = 0.0022, Max-Change = 0.0118, Max-Change = 0.0038, Max-Change = 0.0058, Max-Change = 0.0028, Max-Change = 0.0088, Max-Change = 0.0146, Max-Change = 0.0028, Max-Change = 0.0030, Max-Change = 0.0154, Max-Change = 0.0082, Max-Change = 0.0032, Max-Change = 0.0065, Max-Change = 0.0080, Max-Change = 0.0011, Max-Change = 0.0018, Max-Change = 0.0009, Max-Change = 0.0023, Max-Change = 0.0027, Max-Change = 0.0014, Max-Change = 0.0043, Max-Change = 0.0039, Max-Change = 0.0068, Max-Change = 0.0018, Max-Change = 0.0099, Max-Change = 0.0013, Max-Change = 0.0067, Max-Change = 0.0006, Max-Change = 0.0048, Max-Change = 0.0058, Max-Change = 0.0017, Max-Change = 0.0015, Max-Change = 0.0039, Max-Change = 0.0062, Max-Change = 0.0022, Max-Change = 0.0044, Max-Change = 0.0032, Max-Change = 0.0024, Max-Change = 0.0044, Max-Change = 0.0024, Max-Change = 0.0046, Max-Change = 0.0045, Max-Change = 0.0046, Max-Change = 0.0096, Max-Change = 0.0086, Max-Change = 0.0044, Max-Change = 0.0017, Max-Change = 0.0071, Max-Change = 0.0059, Max-Change = 0.0052, Max-Change = 0.0018, Max-Change = 0.0039, Max-Change = 0.0020, Max-Change = 0.0039, Max-Change = 0.0022, Max-Change = 0.0032, Max-Change = 0.0014, Max-Change = 0.0027, Max-Change = 0.0029, Max-Change = 0.0098, Max-Change = 0.0030, Max-Change = 0.0029, Max-Change = 0.0014, Max-Change = 0.0054, Max-Change = 0.0066, Max-Change = 0.0050, Max-Change = 0.0020, Max-Change = 0.0008, Max-Change = 0.0055, Max-Change = 0.0040, Max-Change = 0.0056, Max-Change = 0.0015, Max-Change = 0.0056, Max-Change = 0.0025, Max-Change = 0.0044, Max-Change = 0.0037, Max-Change = 0.0083, Max-Change = 0.0054, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0032, gam = 0.1057, Max-Change = 0.0011, gam = 0.0780, Max-Change = 0.0009, gam = 0.0629, Max-Change = 0.0006, gam = 0.0532, Max-Change = 0.0019, gam = 0.0464, Max-Change = 0.0014, gam = 0.0413, Max-Change = 0.0017, gam = 0.0374, Max-Change = 0.0012, gam = 0.0342, Max-Change = 0.0002, gam = 0.0316, Max-Change = 0.0008, gam = 0.0294, Max-Change = 0.0005
#> 
#> Calculating log-likelihood...
summary(LLTM)
#> 
...
#> difficultyhard     -1.033        NA      NA
#> difficultymedium    0.021        NA      NA
#> 
#> --------------
...
#> , Max-Change = 0.1898, Max-Change = 0.1542, Max-Change = 0.1238, Max-Change = 0.1052, Max-Change = 0.0832, Max-Change = 0.0682, Max-Change = 0.0546, Max-Change = 0.0453, Max-Change = 0.0382, Max-Change = 0.0320, Max-Change = 0.0259, Max-Change = 0.0210, Max-Change = 0.0165, Max-Change = 0.0145, Max-Change = 0.0165, Max-Change = 0.0130, Max-Change = 0.0091, Max-Change = 0.0158, Max-Change = 0.0076, Max-Change = 0.0091, Max-Change = 0.0129, Max-Change = 0.0052, Max-Change = 0.0108, Max-Change = 0.0142, Max-Change = 0.0053, Max-Change = 0.0020, Max-Change = 0.0072, Max-Change = 0.0029, Max-Change = 0.0018, Max-Change = 0.0045, Max-Change = 0.0045, Max-Change = 0.0098, Max-Change = 0.0033, Max-Change = 0.0033, Max-Change = 0.0083, Max-Change = 0.0044, Max-Change = 0.0111, Max-Change = 0.0050, Max-Change = 0.0065, Max-Change = 0.0020, Max-Change = 0.0101, Max-Change = 0.0120, Max-Change = 0.0034, Max-Change = 0.0047, Max-Change = 0.0029, Max-Change = 0.0032, Max-Change = 0.0016, Max-Change = 0.0087, Max-Change = 0.0046, Max-Change = 0.0089, Max-Change = 0.0099, Max-Change = 0.0027, Max-Change = 0.0105, Max-Change = 0.0055, Max-Change = 0.0027, Max-Change = 0.0034, Max-Change = 0.0037, Max-Change = 0.0105, Max-Change = 0.0068, Max-Change = 0.0008, Max-Change = 0.0059, Max-Change = 0.0007, Max-Change = 0.0042, Max-Change = 0.0019, Max-Change = 0.0025, Max-Change = 0.0025, Max-Change = 0.0024, Max-Change = 0.0043, Max-Change = 0.0017, Max-Change = 0.0065, Max-Change = 0.0037, Max-Change = 0.0007, Max-Change = 0.0022, Max-Change = 0.0026, Max-Change = 0.0027, Max-Change = 0.0037, Max-Change = 0.0053, Max-Change = 0.0052, Max-Change = 0.0039, Max-Change = 0.0020, Max-Change = 0.0047, Max-Change = 0.0061, Max-Change = 0.0094, Max-Change = 0.0066, Max-Change = 0.0020, Max-Change = 0.0028, Max-Change = 0.0082, Max-Change = 0.0064, Max-Change = 0.0058, Max-Change = 0.0085, Max-Change = 0.0048, Max-Change = 0.0095, Max-Change = 0.0018, Max-Change = 0.0073, Max-Change = 0.0051, Max-Change = 0.0004, Max-Change = 0.0061, Max-Change = 0.0040, Max-Change = 0.0013, Max-Change = 0.0338, Max-Change = 0.2000, Max-Change = 0.1639, Max-Change = 0.1307, Max-Change = 0.1042, Max-Change = 0.0833, Max-Change = 0.0667, Max-Change = 0.0546, Max-Change = 0.0430, Max-Change = 0.0354, Max-Change = 0.0284, Max-Change = 0.0240, Max-Change = 0.0205, Max-Change = 0.0160, Max-Change = 0.0454, Max-Change = 0.0016, Max-Change = 0.0102, Max-Change = 0.0065, Max-Change = 0.0066, Max-Change = 0.0047, Max-Change = 0.0101, Max-Change = 0.0070, Max-Change = 0.0050, Max-Change = 0.0040, Max-Change = 0.0059, Max-Change = 0.0036, Max-Change = 0.0045, Max-Change = 0.0046, Max-Change = 0.0060, Max-Change = 0.0092, Max-Change = 0.0032, Max-Change = 0.0056, Max-Change = 0.0106, Max-Change = 0.0076, Max-Change = 0.0142, Max-Change = 0.0024, Max-Change = 0.0061, Max-Change = 0.0053, Max-Change = 0.0032, Max-Change = 0.0138, Max-Change = 0.0069, Max-Change = 0.0064, Max-Change = 0.0127, Max-Change = 0.0117, Max-Change = 0.0027, Max-Change = 0.0057, Max-Change = 0.0071, Max-Change = 0.0077, Max-Change = 0.0037, Max-Change = 0.0023, Max-Change = 0.0055, Max-Change = 0.0068, Max-Change = 0.0036, Max-Change = 0.0023, Max-Change = 0.0069, Max-Change = 0.0106, Max-Change = 0.0048, Max-Change = 0.0092, Max-Change = 0.0045, Max-Change = 0.0055, Max-Change = 0.0034, Max-Change = 0.0033, Max-Change = 0.0073, Max-Change = 0.0063, Max-Change = 0.0087, Max-Change = 0.0111, Max-Change = 0.0035, Max-Change = 0.0068, Max-Change = 0.0057, Max-Change = 0.0028, Max-Change = 0.0035, Max-Change = 0.0075, Max-Change = 0.0032, Max-Change = 0.0022, Max-Change = 0.0033, Max-Change = 0.0132, Max-Change = 0.0048, Max-Change = 0.0042, Max-Change = 0.0100, Max-Change = 0.0035, Max-Change = 0.0154, Max-Change = 0.0051, Max-Change = 0.0076, Max-Change = 0.0029, Max-Change = 0.0061, Max-Change = 0.0049, Max-Change = 0.0030, Max-Change = 0.0094, Max-Change = 0.0053, Max-Change = 0.0110, Max-Change = 0.0074, Max-Change = 0.0027, Max-Change = 0.0023, Max-Change = 0.0058, Max-Change = 0.0044, Max-Change = 0.0027, Max-Change = 0.0039, Max-Change = 0.0060, Max-Change = 0.0037, Max-Change = 0.0046, Max-Change = 0.0030, Max-Change = 0.0058, Max-Change = 0.0054, Max-Change = 0.0095, Max-Change = 0.0051, Max-Change = 0.0032, Max-Change = 0.0038, Max-Change = 0.0074, Max-Change = 0.0015, Max-Change = 0.0064, Max-Change = 0.0051, Max-Change = 0.0039, Max-Change = 0.0009, Max-Change = 0.0007, Max-Change = 0.0058, Max-Change = 0.0004, Max-Change = 0.0068, Max-Change = 0.0069, Max-Change = 0.0081, Max-Change = 0.0040, Max-Change = 0.0022, Max-Change = 0.0063, Max-Change = 0.0075, Max-Change = 0.0083, Max-Change = 0.0026, Max-Change = 0.0062, Max-Change = 0.0022, Max-Change = 0.0018, Max-Change = 0.0036, Max-Change = 0.0119, Max-Change = 0.0027, Max-Change = 0.0058, Max-Change = 0.0043, Max-Change = 0.0018, Max-Change = 0.0064, Max-Change = 0.0046, Max-Change = 0.0021, Max-Change = 0.0098, Max-Change = 0.0066, Max-Change = 0.0020, Max-Change = 0.0025, Max-Change = 0.0021, Max-Change = 0.0027, Max-Change = 0.0026, Max-Change = 0.0006, Max-Change = 0.0036, Max-Change = 0.0052, Max-Change = 0.0068, Max-Change = 0.0070, Max-Change = 0.0030, Max-Change = 0.0077, Max-Change = 0.0083, Max-Change = 0.0036, Max-Change = 0.0038, Max-Change = 0.0070, Max-Change = 0.0139, Max-Change = 0.0108, Max-Change = 0.0047, Max-Change = 0.0051, Max-Change = 0.0040, Max-Change = 0.0011, Max-Change = 0.0053, Max-Change = 0.0050, Max-Change = 0.0019, Max-Change = 0.0006, Max-Change = 0.0033, Max-Change = 0.0027, Max-Change = 0.0019, Max-Change = 0.0144, Max-Change = 0.0037, Max-Change = 0.0025, Max-Change = 0.0019, Max-Change = 0.0031, Max-Change = 0.0043, Max-Change = 0.0073, Max-Change = 0.0070, Max-Change = 0.0063, Max-Change = 0.0035, Max-Change = 0.0047, Max-Change = 0.0040, Max-Change = 0.0051, Max-Change = 0.0027, Max-Change = 0.0128, Max-Change = 0.0101, Max-Change = 0.0140, Max-Change = 0.0038, Max-Change = 0.0099, Max-Change = 0.0086, Max-Change = 0.0089, Max-Change = 0.0079, Max-Change = 0.0027, Max-Change = 0.0035, Max-Change = 0.0005, Max-Change = 0.0070, Max-Change = 0.0050, Max-Change = 0.0041, Max-Change = 0.0033, Max-Change = 0.0121, Max-Change = 0.0034, Max-Change = 0.0011, Max-Change = 0.0049, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0021, gam = 0.1057, Max-Change = 0.0020, gam = 0.0780, Max-Change = 0.0017, gam = 0.0629, Max-Change = 0.0015, gam = 0.0532, Max-Change = 0.0005, gam = 0.0464, Max-Change = 0.0008, gam = 0.0413, Max-Change = 0.0004
#> 
#> Calculating log-likelihood...
coef(LLTM.e)
#> $Item_1
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.043         -1.022           -0.001  1 0 0 1
#> 
#> $Item_2
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.043         -1.022           -0.001  1 0 0 1

...
- technical:
  ...
  :   a `matrix` of latent trait values taken to be fixed and known.
      ...
      algorithm. Matrix input must have as many rows as there are rows
      in `data`
...
#> [1,]      0      0      0      0      0 -1.719276 -1.6680555 0.7045486
#> [2,]      0      0      0      0      1 -1.421852 -1.4651842 0.6866332
#> [3,]      0      0      0      1      0 -1.431027 -1.4555324 0.6868695
#> [4,]      0      0      0      1      1 -1.145431 -1.2703973 0.6826123
#> [5,]      0      0      1      0      0 -1.477463 -0.5519508 0.6873394
#> [6,]      0      0      1      0      1 -1.192127 -0.3709568 0.6832878
#>          SE_F2
#> [1,] 0.6813394
#> [2,] 0.6513721
#> [3,] 0.6501120
...
#> $items
#>            a1    b1    t1    t2    t3
#> Comfort 0.824 3.477 6.825 6.474 1.779
#> Work    0.818 3.217 5.280 4.274 0.969
#> Future  2.240 2.800 4.888 3.774 1.962
#> Benefit 0.696 3.583 6.555 4.725 1.743
#> 
#> $means
#> F1 
#>  0 
...
#> Latent density type: Gaussian 
#> 
#> Log-likelihood = -1601.171
#> Estimated parameters: 24 
#> AIC = 3250.343
#> BIC = 3345.653; SABIC = 3269.502
#> G2 (231) = 198.16, p = 0.9424
#> RMSEA = 0, CFI = NaN, TLI = NaN
coef(monopoly, simplify=TRUE)
#> $items
#>          omega   xi1   xi2    xi3 alpha1   tau2
#> Comfort -1.423 2.903 2.217 -1.469 -0.930  0.717
#> Work    -0.416 1.378 0.698 -2.152 -0.501 -1.132
#> Future   0.837 5.023 2.269 -1.913  0.021 -8.475
#> Benefit -1.705 1.880 0.617 -1.390 -1.417  0.702
#> 
#> $means
#> F1 
#>  0 
...
#> Future  2.799       4.031       1.524      -2.593
...
#> 2    Work 10.137       8      0.026  0.256
#> 3  Future 19.462       8      0.061  0.013
#> 4 Benefit 12.104      11      0.016  0.356
M2(unimod, type = 'C2')
#>           M2 df p RMSEA RMSEA_5 RMSEA_95 SRMSR   TLI   CFI
#> stats 18.696  2 0 0.146    0.09     0.21 0.079 0.738 0.913
fs <- fscores(unimod)
hist(fs, 20)

fscores(unimod, method = 'EAPsum', full.scores = FALSE)
#>    Sum.Scores    F1 SE_F1 observed expected std.res
#> 4           4 0.138 0.153        2    0.127   5.254
#> 5           5 0.304 0.088        1    0.765   0.269
#> 6           6 0.328 0.084        2    4.334   1.121
#> 7           7 0.352 0.126        1   13.901   3.460
#> 8           8 0.407 0.199       11   27.735   3.178
#> 9           9 0.530 0.305       32   40.628   1.354
#> 10         10 0.748 0.440       58   52.279   0.791
#> 11         11 1.053 0.605       70   63.513   0.814
#> 12         12 1.478 0.845       91   68.881   2.665
#> 13         13 2.164 1.282       56   54.419   0.214
#> 14         14 3.299 2.001       36   36.186   0.031
#> 15         15 5.109 3.236       20   20.820   0.180
...
#>  0.165  0.018  0.054  0.080  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.161  0.020  0.053  0.073  0.000  0.000 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.289  0 -1.043 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.328  0 -1.534 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.786  0 1.392 0 1
#> 
#> $Item_4
#>        a1    a2      d g u
#> par 1.037 0.615 -0.151 0 1
#> 
#> $Item_5
#>     a1    a2    d1   d2     d3
#> par  0 1.367 2.803 1.85 -0.572
#> 
#> $Item_6
#>     a1    a2    d1    d2     d3
#> par  0 0.653 2.604 0.997 -1.136
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 0.969 1.921 -0.052
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 1.065 1.022 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.403      1
...
#> Item_2 0.189       0.036
#> Item_3 0.419       0.176
#> Item_4 0.497 0.295 0.334
#> Item_5       0.626 0.392
#> Item_6       0.358 0.128
#> Item_7       0.495 0.245
#> Item_8       0.531 0.281
#> 
#> SS loadings:  0.823 1.133 
#> Proportion Var:  0.103 0.142 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.050  -0.029  -0.010  -0.003   0.022   0.058 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.003  0.015 -0.004 -0.038 -0.050 -0.023  0.023
#> Item_2  0.017        -0.011 -0.011  0.039  0.053 -0.020  0.058
#> Item_3  0.449  0.250        -0.013  0.030 -0.027  0.013  0.019
#> Item_4  0.039  0.239  0.332         0.031 -0.044  0.021 -0.023
#> Item_5  2.891  3.087  1.802  1.950        -0.043 -0.035 -0.009
#> Item_6  4.956  5.629  1.467  3.841 11.260        -0.042  0.042
#> Item_7  1.029  0.772  0.332  0.892  4.816  6.927        -0.034
#> Item_8  1.099  6.678  0.693  1.067  0.156  3.447  2.267       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.675 1.817  0 -1.284 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.342 0.106  0 -1.541 0 1
#> 
#> $Item_3
#>        a1    a2 a3    d g u
#> par 0.438 0.577  0 1.37 0 1
#> 
#> $Item_4
#>        a1    a2 a3      d g u
#> par 1.177 0.643  0 -0.147 0 1
#> 
#> $Item_5
#>        a1 a2   a3    d1    d2     d3
#> par 1.171  0 0.63 2.784 1.838 -0.559
#> 
#> $Item_6
#>        a1 a2    a3    d1    d2     d3
#> par 0.548  0 0.389 2.618 1.006 -1.138
#> 
#> $Item_7
#>       a1 a2    a3    d1     d2
#> par 0.79  0 0.567 1.929 -0.047
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.886  0 0.686 1.047 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.262 0.704       0.565
#> Item_2 0.197 0.061       0.042
#> Item_3 0.237 0.312       0.153
#> Item_4 0.543 0.297       0.383
#> Item_5 0.542       0.291 0.379
#> Item_6 0.299       0.213 0.135
#> Item_7 0.403       0.289 0.246
#> Item_8 0.435       0.337 0.303
#> 
#> SS loadings:  1.194 0.685 0.327 
#> Proportion Var:  0.149 0.086 0.041 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.045  -0.032  -0.004  -0.004   0.022   0.037 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.011  0.001 -0.003 -0.035 -0.045 -0.017  0.033
#> Item_2  0.232        -0.005 -0.019  0.011  0.036 -0.038  0.037
#> Item_3  0.003  0.049         0.003  0.020 -0.031 -0.015  0.012
#> Item_4  0.014  0.715  0.013         0.031 -0.044  0.028 -0.016
#> Item_5  2.507  0.225  0.801  1.903        -0.043  0.035 -0.011
#> Item_6  4.047  2.616  1.868  3.816 11.240        -0.042  0.037
#> Item_7  0.571  2.831  0.459  1.564  4.939  6.951        -0.037
#> Item_8  2.135  2.686  0.275  0.499  0.221  2.792  2.761       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik     X2 df    p
#> mod1 24850.79 24906.54 24898.09 24979.61 -12402.39               
#> mod3 24850.69 24920.98 24910.33 25013.11 -12396.34 12.101  6 0.06
...
#> mod.quad  19040.50 19157.83 19204.82 19462.61 -9424.250 391.241 24 0
...
#> Latent density type: Gaussian 
#> 
#> Log-likelihood = -2466.944
#> Estimated parameters: 7 
#> AIC = 4947.887
#> BIC = 4982.242; SABIC = 4960.009
...
#>  1.2529003 -0.4754270 -1.2326691 -0.1681659  0.6233618 
sum(ds)
#> [1] 4.607426e-15
...
head(cbind(fs, fs2))
#>               F1           F1
#> [1,]  2.66818086  3.599617143
#> [2,]  0.14648537  0.070499017
#> [3,]  0.06802061  0.004035063
#> [4,] -0.41577254 -0.426753403
#> [5,]  0.67027250  0.559824558
#> [6,]  0.45476978  0.353826839
...
#> 
#> Full-information item factor analysis with 1 factor(s).
#> Converged within 1e-04 tolerance after 200 EM iterations.
#> mirt version: 1.47.2 
#> M-step optimizer: BFGS 
#> EM acceleration: Ramsay 
#> Number of rectangular quadrature: 61
#> Latent density type: Gaussian 
#> 
#> Log-likelihood = -2657.868
#> Estimated parameters: 15 
#> AIC = 5345.735
#> BIC = 5419.352; SABIC = 5371.711
#> G2 (16) = 29.83, p = 0.0189
#> RMSEA = 0.029, CFI = NaN, TLI = NaN
coef(mod2PL_asym, simplify=TRUE)
#> $items
#>           a1      d g u   logS
#> Item.1 0.922  2.986 0 1  1.062
#> Item.2 2.304 -1.793 0 1 -1.556
#> Item.3 1.597  2.016 0 1  0.219
#> Item.4 0.608  2.359 0 1  1.647
#> Item.5 0.742  2.049 0 1  0.173
#> 
#> $means
#> Theta 
#>     0 
...
#> $items
#>            a      b g u     S
#> Item.1 0.922 -3.237 0 1 2.893
#> Item.2 2.304  0.778 0 1 0.211
#> Item.3 1.597 -1.263 0 1 1.245
#> Item.4 0.608 -3.882 0 1 5.193
#> Item.5 0.742 -2.762 0 1 1.189
#> 
#> $means
#> Theta 
#>     0 
...
#> mod2PL_asym 5345.735 5371.711 5373.715 5419.352 -2657.868 1.875  5 0.866
...
#> 2           2 -2.166 0.487        6    5.860   0.058
#> 3           3 -1.941 0.463        8    9.878   0.598
#> 4           4 -1.736 0.443       11   14.609   0.944
#> 5           5 -1.547 0.427       17   19.826   0.635
#> 6           6 -1.370 0.414       23   25.315   0.460
#> 7           7 -1.203 0.404       28   30.875   0.517
#> 8           8 -1.043 0.395       44   36.319   1.274
#> 9           9 -0.890 0.388       45   41.476   0.547
#> 10         10 -0.742 0.382       44   46.191   0.322
#> 11         11 -0.597 0.378       61   50.325   1.505
#> 12         12 -0.456 0.375       52   53.760   0.240
#> 13         13 -0.316 0.372       55   56.399   0.186
#> 14         14 -0.178 0.371       47   58.166   1.464
#> 15         15 -0.041 0.370       64   59.013   0.649
#> 16         16  0.096 0.371       62   58.912   0.402
#> 17         17  0.234 0.372       56   57.862   0.245
#> 18         18  0.374 0.375       53   55.889   0.386
#> 19         19  0.515 0.378       60   53.039   0.956
#> 20         20  0.660 0.382       56   49.384   0.942
#> 21         21  0.808 0.388       50   45.019   0.742
#> 22         22  0.961 0.395       28   40.060   1.905
#> 23         23  1.121 0.404       26   34.646   1.469
#> 24         24  1.288 0.415       27   28.939   0.360
#> 25         25  1.466 0.428       24   23.125   0.182
#> 26         26  1.656 0.444       20   17.417   0.619
#> 27         27  1.862 0.464       14   12.065   0.557
#> 28         28  2.089 0.489        8    7.352   0.239
#> 29         29  2.343 0.519        3    3.594   0.313
#> 30         30  2.631 0.557        2    1.092   0.869
...
#> Item_20  1  1     NA 0 1 3.715  0.832
#> Item_21  1  1     NA 0 1 3.238  1.900
#> Item_22  1  1     NA 0 1 4.410 -0.175
...
#> Item_1       1      0  1.3130277     0     1        NA          NA       1
#> Item_2       1      0 -0.5633206     0     1        NA          NA       1
#> Item_3       1      0  0.3030848     0     1        NA          NA       1
#> Item_4       1      0  0.6601365     0     1        NA          NA       1
#> Item_5       1      0  0.3926427     0     1        NA          NA       1
#> Item_6       1      0 -0.1053131     0     1        NA          NA       1
#> Item_7       1      0  1.4042418     0     1        NA          NA       1
#> Item_8       1      0 -0.1474456     0     1        NA          NA       1
#> Item_9       1      0  2.0130437     0     1        NA          NA       1
#> Item_10      0      1 -0.1405059     0     1        NA          NA       1
#> Item_11      0      1  1.2272874     0     1        NA          NA       0
#> Item_12      0      1  2.3500481     0     1        NA          NA       0
#> Item_13      0      1 -1.4294669     0     1        NA          NA       0
#> Item_14      0      1 -0.1928382     0     1        NA          NA       0
#> Item_15      0      1 -0.0979504     0     1        NA          NA       0
#> Item_16      0      1  0.6228399     0     1        NA          NA       0
#> Item_17      0      1 -0.2862911     0     1        NA          NA       0
#> Item_18      0      1 -2.5921693     0     1        NA          NA       0
#> Item_19      1      1         NA     0     1 2.8692825  0.01321673       1
#> Item_20      1      1         NA     0     1 3.7153158  0.83160160       1
#> Item_21      1      1         NA     0     1 3.2380735  1.90026467       1
#> Item_22      1      1         NA     0     1 4.4099008 -0.17458898       1
#> Item_23      1      1         NA     0     1 3.5379003  0.86646944       1
#> Item_24      1      1         NA     0     1 2.8503186  1.88966260       1
#> Item_25      1      1         NA     0     1 1.1969734 -0.13665235       1
#> Item_26      1      1         NA     0     1 1.0376402  0.97511977       1
#> Item_27      1      1         NA     0     1 1.0632489  1.81847908       1
#> Item_28      1      1         NA     0     1 0.9701855 -0.13754801       1
#> Item_29      1      1         NA     0     1 0.9015733  1.00980369       1
#> Item_30      1      1         NA     0     1 1.0147966  1.91408372       1

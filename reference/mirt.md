...
#>  0.263  0.035  0.076  0.137  0.000  0.001 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.214  0.035  0.088  0.070  0.001  0.000 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.948  0 -1.052 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.513  0 -1.443 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.986  0 1.524 0 1
#> 
#> $Item_4
#>        a1    a2     d g u
#> par 0.952 0.356 0.048 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2     d3
#> par  0 1.498 3.102 2.079 -0.377
#> 
#> $Item_6
#>     a1    a2    d1    d2     d3
#> par  0 0.422 2.343 0.988 -0.979
#> 
#> $Item_7
#>     a1    a2    d1     d2
#> par  0 0.991 2.072 -0.004
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 0.994 0.951 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.363      1
...
#> Item_2 0.289       0.083
#> Item_3 0.501       0.251
#> Item_4 0.480 0.180 0.263
#> Item_5       0.661 0.436
#> Item_6       0.241 0.058
#> Item_7       0.503 0.253
#> Item_8       0.504 0.254
#> 
#> SS loadings:  1.132 1.034 
#> Proportion Var:  0.142 0.129 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.045  -0.022  -0.005  -0.003   0.016   0.059 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.014 -0.004 -0.004  0.058 -0.022 -0.045 -0.020
#> Item_2  0.379        -0.008 -0.003 -0.032  0.041 -0.036 -0.003
#> Item_3  0.030  0.144        -0.006 -0.044 -0.014 -0.003 -0.018
#> Item_4  0.032  0.023  0.083        -0.023  0.030  0.021 -0.003
#> Item_5  6.707  2.099  3.849  1.062        -0.037  0.037 -0.033
#> Item_6  0.945  3.353  0.410  1.751  8.206         0.030  0.059
#> Item_7  3.973  2.585  0.013  0.903  5.499  3.703        -0.013
#> Item_8  0.811  0.013  0.653  0.019  2.157  6.921  0.331       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 1.191 1.474  0 -1.025 0 1
#> 
#> $Item_2
#>        a1    a2 a3      d g u
#> par 0.127 0.675  0 -1.496 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.643 0.681  0 1.507 0 1
#> 
#> $Item_4
#>       a1    a2 a3     d g u
#> par 1.18 0.534  0 0.057 0 1
#> 
#> $Item_5
#>        a1 a2    a3   d1    d2     d3
#> par 0.958  0 1.098 3.07 2.056 -0.369
#> 
#> $Item_6
#>        a1 a2    a3    d1    d2     d3
#> par 0.245  0 0.344 2.344 0.988 -0.979
#> 
#> $Item_7
#>        a1 a2    a3    d1     d2
#> par 0.575  0 0.847 2.093 -0.003
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.536  0 0.883 0.961 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.468 0.579       0.554
#> Item_2 0.069 0.368       0.140
#> Item_3 0.331 0.351       0.232
#> Item_4 0.552 0.250       0.367
#> Item_5 0.427       0.490 0.423
#> Item_6 0.140       0.196 0.058
#> Item_7 0.290       0.427 0.266
#> Item_8 0.269       0.443 0.269
#> 
#> SS loadings:  0.996 0.655 0.657 
#> Proportion Var:  0.125 0.082 0.082 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.045  -0.018  -0.008  -0.001   0.017   0.058 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1        -0.007  0.012 -0.008  0.050 -0.022 -0.044 -0.014
#> Item_2  0.103        -0.012  0.012  0.021  0.049 -0.017  0.016
#> Item_3  0.276  0.299        -0.009 -0.045 -0.015 -0.005 -0.017
#> Item_4  0.115  0.273  0.175        -0.027  0.031  0.031  0.015
#> Item_5  5.008  0.852  4.019  1.413        -0.037 -0.037 -0.033
#> Item_6  0.999  4.827  0.426  1.869  8.083         0.030  0.058
#> Item_7  3.793  0.553  0.058  1.937  5.528  3.638        -0.017
#> Item_8  0.407  0.489  0.562  0.439  2.175  6.807  0.584       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik   X2 df     p
#> mod1 24931.89 24987.64 24979.19 25060.71 -12442.94              
#> mod3 24941.84 25012.13 25001.48 25104.27 -12441.92 2.05  6 0.915
...
#> -1.56627 -0.29576  0.01268  0.29219  1.35710 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.004135   0.014492   0.285    0.775    
#> covdata$X1   0.519412   0.014554  35.689   <2e-16 ***
#> covdata$X2  -1.004469   0.014793 -67.900   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.458 on 997 degrees of freedom
#> Multiple R-squared:  0.8495, Adjusted R-squared:  0.8492 
#> F-statistic:  2814 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[2]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.29060 -0.32137 -0.01937  0.30798  1.43475 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.01064    0.01465  -0.726    0.468    
#> covdata$X1   0.51446    0.01472  34.960   <2e-16 ***
#> covdata$X2  -1.00127    0.01496 -66.940   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4631 on 997 degrees of freedom
#> Multiple R-squared:  0.8455, Adjusted R-squared:  0.8452 
#> F-statistic:  2728 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[3]]
#> 
...
#> Residuals:
#>     Min      1Q  Median      3Q     Max 
#> -1.3952 -0.3109 -0.0066  0.3247  1.4323 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.005448   0.014566   0.374    0.708    
#> covdata$X1   0.515657   0.014628  35.251   <2e-16 ***
#> covdata$X2  -1.011248   0.014869 -68.011   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4604 on 997 degrees of freedom
#> Multiple R-squared:  0.8492, Adjusted R-squared:  0.8489 
#> F-statistic:  2807 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[4]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.29375 -0.31231  0.00636  0.31321  1.29222 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.0007194  0.0142650    0.05     0.96    
#> covdata$X1   0.5115323  0.0143262   35.71   <2e-16 ***
#> covdata$X2  -1.0116957  0.0145619  -69.47   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4509 on 997 degrees of freedom
#> Multiple R-squared:  0.8542, Adjusted R-squared:  0.8539 
#> F-statistic:  2920 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[5]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.46815 -0.30331  0.01442  0.29196  1.47734 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.02539    0.01498   1.695   0.0905 .  
#> covdata$X1   0.51148    0.01504  33.997   <2e-16 ***
#> covdata$X2  -0.99677    0.01529 -65.180   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4735 on 997 degrees of freedom
#> Multiple R-squared:  0.8383, Adjusted R-squared:  0.838 
#> F-statistic:  2585 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[6]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.50781 -0.33494 -0.01261  0.30839  1.69187 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.004545   0.014683   -0.31    0.757    
#> covdata$X1   0.527369   0.014746   35.76   <2e-16 ***
#> covdata$X2  -0.986107   0.014988  -65.79   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4641 on 997 degrees of freedom
#> Multiple R-squared:  0.8431, Adjusted R-squared:  0.8428 
#> F-statistic:  2679 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[7]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.43138 -0.32430  0.00791  0.31825  1.46476 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.003998   0.014998   0.267     0.79    
#> covdata$X1   0.524375   0.015062  34.813   <2e-16 ***
#> covdata$X2  -0.979557   0.015310 -63.980   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.474 on 997 degrees of freedom
#> Multiple R-squared:  0.8357, Adjusted R-squared:  0.8353 
#> F-statistic:  2535 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[8]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.49200 -0.30213 -0.00346  0.28935  1.33393 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.02116    0.01436  -1.473    0.141    
#> covdata$X1   0.51780    0.01443  35.893   <2e-16 ***
#> covdata$X2  -0.98427    0.01466 -67.123   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.454 on 997 degrees of freedom
#> Multiple R-squared:  0.8475, Adjusted R-squared:  0.8471 
#> F-statistic:  2769 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[9]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.49822 -0.31896 -0.00028  0.29355  1.44708 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.005695   0.014417  -0.395    0.693    
#> covdata$X1   0.494606   0.014479  34.161   <2e-16 ***
#> covdata$X2  -1.001202   0.014717 -68.031   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4557 on 997 degrees of freedom
#> Multiple R-squared:  0.8477, Adjusted R-squared:  0.8474 
#> F-statistic:  2775 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[10]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.32539 -0.30338  0.00541  0.29439  1.58191 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.008114   0.014510   0.559    0.576    
#> covdata$X1   0.513082   0.014573  35.209   <2e-16 ***
#> covdata$X2  -0.994403   0.014812 -67.133   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4586 on 997 degrees of freedom
#> Multiple R-squared:  0.8465, Adjusted R-squared:  0.8462 
#> F-statistic:  2748 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
...
averageMI(par, SEpar)
#>                par SEpar       t      df     p
#> (Intercept)  0.001 0.020   0.029   45.93 0.244
#> covdata$X1   0.515 0.017  29.635 108.096     0
#> covdata$X2  -0.997 0.019 -52.794  63.079     0
...
#> Item_1           1.056          0.000             0.00  1 0 0 1
#> Item_2           1.056          0.000             0.00  1 0 0 1
#> Item_3           1.056          0.000             0.00  1 0 0 1
#> Item_4           1.056          0.000             0.00  1 0 0 1
#> Item_5           1.056          0.000             0.00  1 0 0 1
#> Item_6           1.056          0.000             0.00  1 0 0 1
#> Item_7           1.056          0.000             0.00  1 0 0 1
#> Item_8           1.056          0.000             0.00  1 0 0 1
#> Item_9           1.056          0.000             0.00  1 0 0 1
#> Item_10          1.056          0.000             0.00  1 0 0 1
#> Item_11          0.000          0.000             0.07  1 0 0 1
#> Item_12          0.000          0.000             0.07  1 0 0 1
#> Item_13          0.000          0.000             0.07  1 0 0 1
#> Item_14          0.000          0.000             0.07  1 0 0 1
#> Item_15          0.000          0.000             0.07  1 0 0 1
#> Item_16          0.000          0.000             0.07  1 0 0 1
#> Item_17          0.000          0.000             0.07  1 0 0 1
#> Item_18          0.000          0.000             0.07  1 0 0 1
#> Item_19          0.000          0.000             0.07  1 0 0 1
#> Item_20          0.000          0.000             0.07  1 0 0 1
#> Item_21          0.000         -1.005             0.00  1 0 0 1
#> Item_22          0.000         -1.005             0.00  1 0 0 1
#> Item_23          0.000         -1.005             0.00  1 0 0 1
#> Item_24          0.000         -1.005             0.00  1 0 0 1
#> Item_25          0.000         -1.005             0.00  1 0 0 1
#> Item_26          0.000         -1.005             0.00  1 0 0 1
#> Item_27          0.000         -1.005             0.00  1 0 0 1
#> Item_28          0.000         -1.005             0.00  1 0 0 1
#> Item_29          0.000         -1.005             0.00  1 0 0 1
#> Item_30          0.000         -1.005             0.00  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> par          1.056         -1.005             0.07  1  0     -999      999
#> SE           0.041          0.041             0.04 NA NA       NA       NA
#> 
#> $Item_2
#>     difficultyeasy difficultyhard difficultymedium a1  d logit(g) logit(u)
#> par          1.056         -1.005             0.07  1  0     -999      999
...
#>           AIC    SABIC       HQ      BIC    logLik     X2 df     p
#> lltm 34744.43 34751.36 34751.90 34764.07 -17368.22                
#> mod  34783.59 34837.27 34841.42 34935.73 -17360.80 14.843 27 0.972
...
itemfit(lltm)
#>       item   S_X2 df.S_X2 RMSEA.S_X2 p.S_X2
#> 1   Item_1 22.918      21      0.010  0.348
#> 2   Item_2 28.707      21      0.019  0.121
#> 3   Item_3 20.168      21      0.000  0.511
#> 4   Item_4 27.808      21      0.018  0.146
#> 5   Item_5 19.277      21      0.000  0.567
#> 6   Item_6 30.581      21      0.021  0.081
#> 7   Item_7 32.579      21      0.023  0.051
#> 8   Item_8 32.007      21      0.023  0.058
#> 9   Item_9 28.740      21      0.019  0.120
#> 10 Item_10 14.321      21      0.000  0.855
#> 11 Item_11 22.956      21      0.010  0.346
#> 12 Item_12 23.849      21      0.012  0.300
#> 13 Item_13 25.089      21      0.014  0.243
#> 14 Item_14 17.209      21      0.000  0.698
#> 15 Item_15 16.056      21      0.000  0.767
#> 16 Item_16 19.285      21      0.000  0.567
#> 17 Item_17 43.528      21      0.033  0.003
#> 18 Item_18 22.483      21      0.008  0.372
#> 19 Item_19 33.283      21      0.024  0.043
#> 20 Item_20 21.793      21      0.006  0.412
#> 21 Item_21 19.928      21      0.000  0.526
#> 22 Item_22 28.491      21      0.019  0.127
#> 23 Item_23 12.316      21      0.000  0.931
#> 24 Item_24 20.026      21      0.000  0.520
#> 25 Item_25 34.472      21      0.025  0.032
#> 26 Item_26 26.564      21      0.016  0.186
#> 27 Item_27 16.061      21      0.000  0.766
#> 28 Item_28 21.908      21      0.007  0.405
#> 29 Item_29 27.678      21      0.018  0.150
#> 30 Item_30 22.276      21      0.008  0.384
...
#>    Sum.Scores         F1     SE_F1 observed  expected     std.res
#> 0           0 -2.8204703 0.5844187        0  1.380738 1.175048253
#> 1           1 -2.5055038 0.5395155        5  4.170031 0.406436212
#> 2           2 -2.2338030 0.5041821        9  8.001266 0.353077973
#> 3           3 -1.9939657 0.4762185       10 12.507390 0.708987459
#> 4           4 -1.7780251 0.4539034       14 17.398034 0.814662379
#> 5           5 -1.5803196 0.4359599       23 22.452498 0.115545552
#> 6           6 -1.3967313 0.4214521       24 27.499916 0.667408804
#> 7           7 -1.2241903 0.4096925       42 32.402929 1.685957381
#> 8           8 -1.0603492 0.4001732       37 37.046788 0.007687034
#> 9           9 -0.9033678 0.3925162       44 41.332775 0.414870259
#> 10         10 -0.7517668 0.3864393       37 45.174578 1.216237284
#> 11         11 -0.6043254 0.3817318       50 48.496570 0.215887621
#> 12         12 -0.4600085 0.3782387       54 51.233259 0.386538251
#> 13         13 -0.3179127 0.3758484       60 53.329433 0.913438357
#> 14         14 -0.1772247 0.3744860       46 54.740674 1.181380611
#> 15         15 -0.0371872 0.3741077       60 55.434055 0.613256712
#> 16         16  0.1029300 0.3746986       58 55.388902 0.350842178
#> 17         17  0.2438568 0.3762715       64 54.597511 1.272495926
#> 18         18  0.3863501 0.3788685       52 53.065790 0.146306692
#> 19         19  0.5312232 0.3825633       44 50.813752 0.955863122
#> 20         20  0.6793798 0.3874667       54 47.875879 0.885085839
#> 21         21  0.8318568 0.3937342       44 44.301385 0.045280612
#> 22         22  0.9898796 0.4015784       39 40.154576 0.182202712
#> 23         23  1.1549364 0.4112850       21 35.515644 2.435714908
#> 24         24  1.3288832 0.4232380       27 30.482514 0.630764793
#> 25         25  1.5140938 0.4379546       23 25.174732 0.433434431
#> 26         26  1.7136811 0.4561356       20 19.740893 0.058317093
#> 27         27  1.9318308 0.4787363       16 14.371668 0.429525913
#> 28         28  2.1743115 0.5070595       14  9.320684 1.532704796
#> 29         29  2.4492563 0.5428596        7  4.932693 0.930814150
#> 30         30  2.7683207 0.5883733        2  1.662443 0.261802181
M2(lltm) # goodness of fit
#>            M2  df     p RMSEA RMSEA_5 RMSEA_95 SRMSR   TLI   CFI
#> stats 471.426 461 0.358 0.005       0    0.012 0.031 0.999 0.999
head(personfit(lltm))
#>      outfit   z.outfit     infit    z.infit         Zh
#> 1 0.5915680 -1.0667952 0.7709343 -0.9020678  0.9647218
#> 2 1.2241074  1.3353065 1.1988507  1.3144037 -1.3554669
#> 3 0.8366635 -0.3708560 0.8074470 -0.8561079  0.7572409
#> 4 0.9081542 -0.4000011 0.9441574 -0.3154130  0.3948007
#> 5 0.9128907 -0.2265561 0.9230058 -0.3682453  0.3854088
#> 6 0.7080475 -1.8441014 0.7563436 -1.7232528  1.6515451
residuals(lltm)
#> LD matrix (lower triangle) and standardized residual correlations (upper triangle)
#> 
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.096  -0.039  -0.005  -0.001   0.039   0.097 
#> 
#>         Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8 Item_9 Item_10
#> Item_1         -0.041 -0.064  0.053  0.054  0.040 -0.045  0.036 -0.041   0.043
#> Item_2   1.646        -0.059  0.072  0.027  0.028 -0.035 -0.066 -0.060  -0.036
#> Item_3   4.078  3.474        -0.056 -0.045 -0.047 -0.066 -0.038 -0.053   0.053
#> Item_4   2.832  5.159  3.183        -0.045  0.054  0.056 -0.063 -0.047   0.053
#> Item_5   2.954  0.726  2.029  2.027         0.061  0.040  0.054 -0.025   0.047
#> Item_6   1.586  0.793  2.219  2.891  3.667         0.037 -0.028 -0.084   0.045
#> Item_7   1.989  1.210  4.386  3.139  1.638  1.379         0.029 -0.047   0.042
#> Item_8   1.261  4.311  1.455  4.016  2.952  0.763  0.865        -0.057   0.034
#> Item_9   1.679  3.552  2.792  2.239  0.644  7.065  2.197  3.210         -0.061
#> Item_10  1.833  1.271  2.823  2.778  2.215  2.051  1.730  1.173  3.677        
#> Item_11  1.066  1.362  2.092  2.709  2.121  5.339  2.679  0.795  1.055   1.813
#> Item_12  1.023  0.523  1.607  2.363  0.693  2.144  0.276  0.212  3.010   1.057
#> Item_13  1.320  0.596  1.686  1.546  1.949  0.936  1.686  0.287  0.493   1.233
#> Item_14  0.966  0.422  1.410  2.709  0.296  2.349  0.388  0.352  1.685   1.871
#> Item_15  1.243  1.637  1.345  3.911  0.279  2.052  1.173  0.660  0.034   2.155
#> Item_16  1.008  8.267  1.721  3.911  0.279  1.183  0.273  0.660  0.172   1.372
#> Item_17  2.668  0.780  1.947  4.350  0.523  1.092  0.636  1.076  1.036   9.024
#> Item_18  1.900  1.695  4.353  4.066  1.774  5.864  1.914  3.273  2.906   1.791
#> Item_19  1.481  9.165  3.548  1.577  1.911  1.279  0.431  0.520  0.192   2.048
#> Item_20  1.102  0.583  1.809  1.837  1.240  0.544  1.409  2.003  3.180   0.823
#> Item_21  1.392  2.153  1.411  1.753  0.794  0.450  0.585  0.365  3.332   6.176
#> Item_22  2.071  0.733  3.051  1.780  0.264  1.258  0.435  0.745  0.951   1.377
#> Item_23  1.422  0.935  1.853  2.216  0.667  1.440  0.334  0.312  4.018   0.978
#> Item_24  2.194  0.883  8.597  2.555  1.129  5.431  1.101  1.580  5.658   2.011
#> Item_25  1.619  3.400  1.783  3.746  0.549  0.573  0.637  0.492  2.622   1.162
#> Item_26  2.417  2.727  2.228  2.262  1.308  2.714  1.203  2.646  7.863   2.179
#> Item_27  0.909  0.394  3.120  2.338  0.560  0.549  1.976  0.342  0.114   2.984
#> Item_28  2.833  1.916  2.171  5.834  2.846  1.879  1.732  3.111  3.641   2.281
#> Item_29  2.300  2.472  4.950  2.861  2.195  5.988  2.468  1.642  3.651   4.153
#> Item_30  5.234  1.876  2.658  4.052  0.692  0.815  0.661  1.307  0.664   0.770
#>         Item_11 Item_12 Item_13 Item_14 Item_15 Item_16 Item_17 Item_18 Item_19
#> Item_1   -0.033  -0.032  -0.036   0.031   0.035   0.032  -0.052  -0.044  -0.038
#> Item_2   -0.037   0.023  -0.024   0.021  -0.040  -0.091  -0.028   0.041  -0.096
#> Item_3    0.046   0.040   0.041   0.038  -0.037  -0.041  -0.044  -0.066  -0.060
#> Item_4    0.052  -0.049   0.039  -0.052  -0.063  -0.063  -0.066   0.064  -0.040
#> Item_5   -0.046   0.026  -0.044  -0.017   0.017   0.017   0.023   0.042  -0.044
#> Item_6    0.073   0.046   0.031  -0.048   0.045   0.034  -0.033   0.077  -0.036
#> Item_7    0.052   0.017   0.041   0.020  -0.034   0.017  -0.025  -0.044  -0.021
#> Item_8   -0.028  -0.015  -0.017   0.019   0.026   0.026  -0.033   0.057  -0.023
#> Item_9    0.032  -0.055   0.022  -0.041   0.006  -0.013  -0.032  -0.054  -0.014
#> Item_10   0.043  -0.033  -0.035  -0.043  -0.046  -0.037  -0.095  -0.042  -0.045
#> Item_11           0.021   0.057  -0.023   0.021  -0.024  -0.070   0.053  -0.035
#> Item_12   0.443           0.025  -0.005  -0.010   0.010   0.039   0.081  -0.025
#> Item_13   3.212   0.639          -0.016  -0.041   0.022   0.017   0.043  -0.035
#> Item_14   0.523   0.028   0.243          -0.008  -0.010   0.018   0.042  -0.024
#> Item_15   0.424   0.095   1.648   0.065          -0.033   0.015  -0.057  -0.022
#> Item_16   0.560   0.101   0.481   0.096   1.110          -0.022   0.047  -0.022
#> Item_17   4.838   1.530   0.305   0.341   0.210   0.463           0.045  -0.060
#> Item_18   2.764   6.626   1.847   1.794   3.239   2.237   1.984          -0.054
#> Item_19   1.219   0.601   1.216   0.567   0.463   0.463   3.592   2.906        
#> Item_20   0.431   0.264   1.186   0.293   2.012   0.410   5.461   1.448   2.271
#> Item_21   0.814   0.003   0.266   0.117   0.145   0.042   1.123   2.520   0.738
#> Item_22   0.489   0.205   0.229   0.063   0.263   0.167   0.354   1.532   0.773
#> Item_23   0.694   0.837   0.458   0.444   3.842   3.735   0.262   1.855   0.463
#> Item_24   1.452   4.259   1.354   0.604   1.453   2.764   4.479   2.366   0.981
#> Item_25   3.662   0.602   1.116   3.409   0.336   1.261   0.809   1.556   0.728
#> Item_26   1.885   9.494   0.949   1.113   1.414   2.494   1.933   2.846   3.007
#> Item_27   0.472   3.651   2.634   2.039   0.286   0.242   0.372   1.622   0.326
#> Item_28   2.052   1.321   3.232   1.663   2.838   1.511   2.291   3.212   2.603
#> Item_29   1.204   5.064   1.536   0.979   1.218   1.081   1.728   2.391   2.450
#> Item_30   0.943   0.962   2.770   0.063   0.853   0.112   0.296   2.262   0.593
#>         Item_20 Item_21 Item_22 Item_23 Item_24 Item_25 Item_26 Item_27 Item_28
#> Item_1    0.033   0.037   0.046   0.038   0.047   0.040   0.049   0.030   0.053
#> Item_2    0.024   0.046  -0.027  -0.031  -0.030  -0.058  -0.052   0.020  -0.044
#> Item_3    0.043  -0.038   0.055   0.043  -0.093  -0.042   0.047  -0.056  -0.047
#> Item_4   -0.043   0.042   0.042   0.047  -0.051  -0.061  -0.048  -0.048  -0.076
#> Item_5    0.035   0.028  -0.016  -0.026  -0.034  -0.023  -0.036  -0.024  -0.053
#> Item_6    0.023   0.021  -0.035   0.038   0.074   0.024   0.052  -0.023   0.043
#> Item_7    0.038   0.024   0.021   0.018   0.033  -0.025  -0.035  -0.044   0.042
#> Item_8   -0.045  -0.019  -0.027  -0.018  -0.040   0.022   0.051   0.019   0.056
#> Item_9   -0.056   0.058  -0.031  -0.063  -0.075  -0.051  -0.089  -0.011  -0.060
#> Item_10   0.029   0.079  -0.037   0.031  -0.045  -0.034  -0.047  -0.055  -0.048
#> Item_11   0.021   0.029   0.022   0.026  -0.038  -0.061   0.043   0.022  -0.045
#> Item_12  -0.016  -0.002   0.014  -0.029   0.065   0.025   0.097   0.060  -0.036
#> Item_13   0.034   0.016  -0.015   0.021   0.037   0.033  -0.031   0.051   0.057
#> Item_14  -0.017  -0.011  -0.008   0.021  -0.025  -0.058  -0.033  -0.045   0.041
#> Item_15  -0.045   0.012  -0.016  -0.062  -0.038  -0.018   0.038   0.017  -0.053
#> Item_16  -0.020  -0.006  -0.013   0.061  -0.053  -0.036  -0.050  -0.016  -0.039
#> Item_17  -0.074  -0.034   0.019  -0.016  -0.067  -0.028   0.044   0.019  -0.048
#> Item_18   0.038  -0.050   0.039   0.043   0.049   0.039  -0.053   0.040  -0.057
#> Item_19   0.048   0.027   0.028   0.022   0.031   0.027  -0.055  -0.018  -0.051
#> Item_20           0.046   0.029   0.029   0.027   0.017   0.052   0.032   0.051
#> Item_21   2.149          -0.016  -0.014   0.039  -0.040  -0.034   0.021  -0.040
#> Item_22   0.838   0.268           0.016   0.025   0.015  -0.057   0.015  -0.049
#> Item_23   0.818   0.207   0.268           0.036  -0.033  -0.042   0.016  -0.035
#> Item_24   0.706   1.545   0.615   1.309           0.027  -0.042  -0.086   0.047
#> Item_25   0.292   1.579   0.225   1.093   0.756          -0.036  -0.060   0.057
#> Item_26   2.730   1.167   3.275   1.729   1.794   1.283          -0.040  -0.048
#> Item_27   1.007   0.445   0.219   0.268   7.343   3.618   1.617          -0.089
#> Item_28   2.652   1.569   2.380   1.212   2.190   3.289   2.332   7.964        
#> Item_29   3.540   2.244   1.676   7.247   1.803   2.347   3.474   4.104   4.653
#> Item_30   2.492   0.751   0.157   2.275   0.981   1.252   1.434   0.817   1.344
#>         Item_29 Item_30
#> Item_1    0.048   0.072
#> Item_2    0.050   0.043
#> Item_3    0.070   0.052
...
#>               AIC    SABIC      HQ      BIC    logLik X2 df   p
#> lltm     34744.43 34751.36 34751.9 34764.07 -17368.22          
#> lltm.int 34744.43 34751.36 34751.9 34764.07 -17368.22  0  0 NaN
coef(lltm.int, simplify=TRUE)
#> $items
#>         (Intercept) difficultyhard difficultymedium a1 d g u
#> Item_1        1.055          0.000            0.000  1 0 0 1
#> Item_2        1.055          0.000            0.000  1 0 0 1
#> Item_3        1.055          0.000            0.000  1 0 0 1
#> Item_4        1.055          0.000            0.000  1 0 0 1
#> Item_5        1.055          0.000            0.000  1 0 0 1
#> Item_6        1.055          0.000            0.000  1 0 0 1
#> Item_7        1.055          0.000            0.000  1 0 0 1
#> Item_8        1.055          0.000            0.000  1 0 0 1
#> Item_9        1.055          0.000            0.000  1 0 0 1
#> Item_10       1.055          0.000            0.000  1 0 0 1
#> Item_11       1.055          0.000           -0.986  1 0 0 1
#> Item_12       1.055          0.000           -0.986  1 0 0 1
#> Item_13       1.055          0.000           -0.986  1 0 0 1
#> Item_14       1.055          0.000           -0.986  1 0 0 1
#> Item_15       1.055          0.000           -0.986  1 0 0 1
#> Item_16       1.055          0.000           -0.986  1 0 0 1
#> Item_17       1.055          0.000           -0.986  1 0 0 1
#> Item_18       1.055          0.000           -0.986  1 0 0 1
#> Item_19       1.055          0.000           -0.986  1 0 0 1
#> Item_20       1.055          0.000           -0.986  1 0 0 1
#> Item_21       1.055         -2.061            0.000  1 0 0 1
#> Item_22       1.055         -2.061            0.000  1 0 0 1
#> Item_23       1.055         -2.061            0.000  1 0 0 1
#> Item_24       1.055         -2.061            0.000  1 0 0 1
#> Item_25       1.055         -2.061            0.000  1 0 0 1
#> Item_26       1.055         -2.061            0.000  1 0 0 1
#> Item_27       1.055         -2.061            0.000  1 0 0 1
#> Item_28       1.055         -2.061            0.000  1 0 0 1
#> Item_29       1.055         -2.061            0.000  1 0 0 1
#> Item_30       1.055         -2.061            0.000  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> $items
#>         difficultyeasy difficultyhard difficultymedium a1     d g u
#> Item_1           0.000          0.000             0.00  1 0.981 0 1
#> Item_2           0.000          0.000             0.00  1 1.009 0 1
#> Item_3           0.000          0.000             0.00  1 1.154 0 1
#> Item_4           0.000          0.000             0.00  1 1.160 0 1
#> Item_5           1.044          0.000             0.00  1 0.000 0 1
#> Item_6           1.044          0.000             0.00  1 0.000 0 1
#> Item_7           1.044          0.000             0.00  1 0.000 0 1
#> Item_8           1.044          0.000             0.00  1 0.000 0 1
#> Item_9           1.044          0.000             0.00  1 0.000 0 1
#> Item_10          1.044          0.000             0.00  1 0.000 0 1
#> Item_11          0.000          0.000             0.07  1 0.000 0 1
#> Item_12          0.000          0.000             0.07  1 0.000 0 1
#> Item_13          0.000          0.000             0.07  1 0.000 0 1
#> Item_14          0.000          0.000             0.07  1 0.000 0 1
#> Item_15          0.000          0.000             0.07  1 0.000 0 1
#> Item_16          0.000          0.000             0.07  1 0.000 0 1
#> Item_17          0.000          0.000             0.07  1 0.000 0 1
#> Item_18          0.000          0.000             0.07  1 0.000 0 1
#> Item_19          0.000          0.000             0.07  1 0.000 0 1
#> Item_20          0.000          0.000             0.07  1 0.000 0 1
#> Item_21          0.000         -1.005             0.00  1 0.000 0 1
#> Item_22          0.000         -1.005             0.00  1 0.000 0 1
#> Item_23          0.000         -1.005             0.00  1 0.000 0 1
#> Item_24          0.000         -1.005             0.00  1 0.000 0 1
#> Item_25          0.000         -1.005             0.00  1 0.000 0 1
#> Item_26          0.000         -1.005             0.00  1 0.000 0 1
#> Item_27          0.000         -1.005             0.00  1 0.000 0 1
#> Item_28          0.000         -1.005             0.00  1 0.000 0 1
#> Item_29          0.000         -1.005             0.00  1 0.000 0 1
#> Item_30          0.000         -1.005             0.00  1 0.000 0 1
#> 
#> $means
#> F1 
#>  0 
...
#>             AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> lltm   34744.43 34751.36 34751.90 34764.07 -17368.22               
#> lltm.4 34747.44 34761.29 34762.36 34786.70 -17365.72 4.998  4 0.287
...
#> , Max-Change = 0.1902, Max-Change = 0.1594, Max-Change = 0.1293, Max-Change = 0.1048, Max-Change = 0.0834, Max-Change = 0.0684, Max-Change = 0.0569, Max-Change = 0.0473, Max-Change = 0.0392, Max-Change = 0.0350, Max-Change = 0.0273, Max-Change = 0.0231, Max-Change = 0.0194, Max-Change = 0.0142, Max-Change = 0.0154, Max-Change = 0.0107, Max-Change = 0.0064, Max-Change = 0.0095, Max-Change = 0.0073, Max-Change = 0.0088, Max-Change = 0.0077, Max-Change = 0.0091, Max-Change = 0.0132, Max-Change = 0.0107, Max-Change = 0.0132, Max-Change = 0.0025, Max-Change = 0.0022, Max-Change = 0.0056, Max-Change = 0.0045, Max-Change = 0.0042, Max-Change = 0.0021, Max-Change = 0.0041, Max-Change = 0.0023, Max-Change = 0.0068, Max-Change = 0.0015, Max-Change = 0.0033, Max-Change = 0.0071, Max-Change = 0.0018, Max-Change = 0.0051, Max-Change = 0.0051, Max-Change = 0.0027, Max-Change = 0.0036, Max-Change = 0.0019, Max-Change = 0.0120, Max-Change = 0.0022, Max-Change = 0.0027, Max-Change = 0.0021, Max-Change = 0.0027, Max-Change = 0.0077, Max-Change = 0.0036, Max-Change = 0.0071, Max-Change = 0.0045, Max-Change = 0.0029, Max-Change = 0.0052, Max-Change = 0.0033, Max-Change = 0.0069, Max-Change = 0.0010, Max-Change = 0.0091, Max-Change = 0.0078, Max-Change = 0.0089, Max-Change = 0.0044, Max-Change = 0.0015, Max-Change = 0.0047, Max-Change = 0.0018, Max-Change = 0.0028, Max-Change = 0.0112, Max-Change = 0.0084, Max-Change = 0.0064, Max-Change = 0.0095, Max-Change = 0.0020, Max-Change = 0.0061, Max-Change = 0.0047, Max-Change = 0.0063, Max-Change = 0.0034, Max-Change = 0.0035, Max-Change = 0.0050, Max-Change = 0.0058, Max-Change = 0.0037, Max-Change = 0.0034, Max-Change = 0.0074, Max-Change = 0.0100, Max-Change = 0.0055, Max-Change = 0.0060, Max-Change = 0.0098, Max-Change = 0.0099, Max-Change = 0.0060, Max-Change = 0.0135, Max-Change = 0.0079, Max-Change = 0.0041, Max-Change = 0.0021, Max-Change = 0.0056, Max-Change = 0.0054, Max-Change = 0.0021, Max-Change = 0.0030, Max-Change = 0.0037, Max-Change = 0.0103, Max-Change = 0.0011, Max-Change = 0.0062, Max-Change = 0.0045, Max-Change = 0.0063, Max-Change = 0.0017, Max-Change = 0.0069, Max-Change = 0.0043, Max-Change = 0.0024, Max-Change = 0.0104, Max-Change = 0.0047, Max-Change = 0.0018, Max-Change = 0.0044, Max-Change = 0.0058, Max-Change = 0.0030, Max-Change = 0.0032, Max-Change = 0.0021, Max-Change = 0.0103, Max-Change = 0.0072, Max-Change = 0.0062, Max-Change = 0.0025, Max-Change = 0.0009, Max-Change = 0.0039, Max-Change = 0.0119, Max-Change = 0.0033, Max-Change = 0.0061, Max-Change = 0.0035, Max-Change = 0.0009, Max-Change = 0.0070, Max-Change = 0.0088, Max-Change = 0.0046, Max-Change = 0.0026, Max-Change = 0.0139, Max-Change = 0.0029, Max-Change = 0.0035, Max-Change = 0.0077, Max-Change = 0.0027, Max-Change = 0.0125, Max-Change = 0.0036, Max-Change = 0.0039, Max-Change = 0.0035, Max-Change = 0.0042, Max-Change = 0.0012, Max-Change = 0.0121, Max-Change = 0.0042, Max-Change = 0.0031, Max-Change = 0.0023, Max-Change = 0.0097, Max-Change = 0.0029, Max-Change = 0.0026, Max-Change = 0.0110, Max-Change = 0.0015, Max-Change = 0.0028, Max-Change = 0.0060, Max-Change = 0.0063, Max-Change = 0.0075, Max-Change = 0.0056, Max-Change = 0.0171, Max-Change = 0.0028, Max-Change = 0.0018, Max-Change = 0.0014, Max-Change = 0.0075, Max-Change = 0.0006, Max-Change = 0.0045, Max-Change = 0.0043, Max-Change = 0.0026, Max-Change = 0.0028, Max-Change = 0.0090, Max-Change = 0.0047, Max-Change = 0.0008, Max-Change = 0.0060, Max-Change = 0.0100, Max-Change = 0.0113, Max-Change = 0.0038, Max-Change = 0.0107, Max-Change = 0.0011, Max-Change = 0.0126, Max-Change = 0.0024, Max-Change = 0.0097, Max-Change = 0.0020, Max-Change = 0.0041, Max-Change = 0.0014, Max-Change = 0.0035, Max-Change = 0.0090, Max-Change = 0.0062, Max-Change = 0.0033, Max-Change = 0.0050, Max-Change = 0.0033, Max-Change = 0.0025, Max-Change = 0.0103, Max-Change = 0.0154, Max-Change = 0.0100, Max-Change = 0.0041, Max-Change = 0.0031, Max-Change = 0.0139, Max-Change = 0.0030, Max-Change = 0.0028, Max-Change = 0.0042, Max-Change = 0.0060, Max-Change = 0.0058, Max-Change = 0.0037, Max-Change = 0.0071, Max-Change = 0.0005, Max-Change = 0.0084, Max-Change = 0.0034, Max-Change = 0.0060, Max-Change = 0.0040, Max-Change = 0.0052, Max-Change = 0.0026, Max-Change = 0.0073, Max-Change = 0.0035, Max-Change = 0.0122, Max-Change = 0.0068, Max-Change = 0.0042, Max-Change = 0.0023, Max-Change = 0.0089, Max-Change = 0.0065, Max-Change = 0.0019, Max-Change = 0.0020, Max-Change = 0.0048, Max-Change = 0.0061, Max-Change = 0.0070, Max-Change = 0.0096, Max-Change = 0.0039, Max-Change = 0.0031, Max-Change = 0.0051, Max-Change = 0.0054, Max-Change = 0.0077, Max-Change = 0.0021, Max-Change = 0.0011, Max-Change = 0.0019, Max-Change = 0.0050, Max-Change = 0.0048, Max-Change = 0.0045, Max-Change = 0.0041, Max-Change = 0.0029, Max-Change = 0.0030, Max-Change = 0.0039, Max-Change = 0.0042, Max-Change = 0.0045, Max-Change = 0.0048, Max-Change = 0.0108, Max-Change = 0.0015, Max-Change = 0.0104, Max-Change = 0.0040, Max-Change = 0.0091, Max-Change = 0.0139, Max-Change = 0.0057, Max-Change = 0.0054, Max-Change = 0.0036, Max-Change = 0.0021, Max-Change = 0.0029, Max-Change = 0.0085, Max-Change = 0.0080, Max-Change = 0.0032, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0061, gam = 0.1057, Max-Change = 0.0034, gam = 0.0780, Max-Change = 0.0050, gam = 0.0629, Max-Change = 0.0008, gam = 0.0532, Max-Change = 0.0009, gam = 0.0464, Max-Change = 0.0009
#> 
#> Calculating log-likelihood...
summary(LLTM)
#> 
...
#> difficultyeasy      1.063        NA      NA
#> difficultyhard     -0.997        NA      NA
#> difficultymedium    0.078        NA      NA
#> 
#> --------------
...
#> , Max-Change = 0.1902, Max-Change = 0.1594, Max-Change = 0.1293, Max-Change = 0.1048, Max-Change = 0.0834, Max-Change = 0.0684, Max-Change = 0.0569, Max-Change = 0.0473, Max-Change = 0.0392, Max-Change = 0.0350, Max-Change = 0.0273, Max-Change = 0.0231, Max-Change = 0.0194, Max-Change = 0.0142, Max-Change = 0.0154, Max-Change = 0.0107, Max-Change = 0.0064, Max-Change = 0.0095, Max-Change = 0.0073, Max-Change = 0.0088, Max-Change = 0.0077, Max-Change = 0.0091, Max-Change = 0.0132, Max-Change = 0.0107, Max-Change = 0.0132, Max-Change = 0.0025, Max-Change = 0.0022, Max-Change = 0.0056, Max-Change = 0.0045, Max-Change = 0.0042, Max-Change = 0.0021, Max-Change = 0.0041, Max-Change = 0.0023, Max-Change = 0.0068, Max-Change = 0.0015, Max-Change = 0.0033, Max-Change = 0.0071, Max-Change = 0.0018, Max-Change = 0.0051, Max-Change = 0.0051, Max-Change = 0.0027, Max-Change = 0.0036, Max-Change = 0.0019, Max-Change = 0.0120, Max-Change = 0.0022, Max-Change = 0.0027, Max-Change = 0.0021, Max-Change = 0.0027, Max-Change = 0.0077, Max-Change = 0.0036, Max-Change = 0.0071, Max-Change = 0.0045, Max-Change = 0.0029, Max-Change = 0.0052, Max-Change = 0.0033, Max-Change = 0.0069, Max-Change = 0.0010, Max-Change = 0.0091, Max-Change = 0.0078, Max-Change = 0.0089, Max-Change = 0.0044, Max-Change = 0.0015, Max-Change = 0.0047, Max-Change = 0.0018, Max-Change = 0.0028, Max-Change = 0.0112, Max-Change = 0.0084, Max-Change = 0.0064, Max-Change = 0.0095, Max-Change = 0.0020, Max-Change = 0.0061, Max-Change = 0.0047, Max-Change = 0.0063, Max-Change = 0.0034, Max-Change = 0.0035, Max-Change = 0.0050, Max-Change = 0.0058, Max-Change = 0.0037, Max-Change = 0.0034, Max-Change = 0.0074, Max-Change = 0.0100, Max-Change = 0.0055, Max-Change = 0.0060, Max-Change = 0.0098, Max-Change = 0.0099, Max-Change = 0.0060, Max-Change = 0.0135, Max-Change = 0.0079, Max-Change = 0.0041, Max-Change = 0.0021, Max-Change = 0.0056, Max-Change = 0.0054, Max-Change = 0.0021, Max-Change = 0.0030, Max-Change = 0.0037, Max-Change = 0.0103, Max-Change = 0.0011, Max-Change = 0.0062, Max-Change = 0.0045, Max-Change = 0.0380, Max-Change = 0.2000, Max-Change = 0.1637, Max-Change = 0.1295, Max-Change = 0.1042, Max-Change = 0.0829, Max-Change = 0.0664, Max-Change = 0.0533, Max-Change = 0.0425, Max-Change = 0.0336, Max-Change = 0.0270, Max-Change = 0.0213, Max-Change = 0.0171, Max-Change = 0.0140, Max-Change = 0.0115, Max-Change = 0.0114, Max-Change = 0.0146, Max-Change = 0.0082, Max-Change = 0.0068, Max-Change = 0.0026, Max-Change = 0.0042, Max-Change = 0.0049, Max-Change = 0.0052, Max-Change = 0.0064, Max-Change = 0.0027, Max-Change = 0.0035, Max-Change = 0.0041, Max-Change = 0.0051, Max-Change = 0.0047, Max-Change = 0.0077, Max-Change = 0.0046, Max-Change = 0.0031, Max-Change = 0.0073, Max-Change = 0.0064, Max-Change = 0.0070, Max-Change = 0.0055, Max-Change = 0.0056, Max-Change = 0.0082, Max-Change = 0.0061, Max-Change = 0.0069, Max-Change = 0.0095, Max-Change = 0.0076, Max-Change = 0.0041, Max-Change = 0.0079, Max-Change = 0.0081, Max-Change = 0.0041, Max-Change = 0.0039, Max-Change = 0.0030, Max-Change = 0.0115, Max-Change = 0.0044, Max-Change = 0.0054, Max-Change = 0.0062, Max-Change = 0.0031, Max-Change = 0.0050, Max-Change = 0.0083, Max-Change = 0.0107, Max-Change = 0.0034, Max-Change = 0.0088, Max-Change = 0.0105, Max-Change = 0.0043, Max-Change = 0.0043, Max-Change = 0.0103, Max-Change = 0.0073, Max-Change = 0.0103, Max-Change = 0.0054, Max-Change = 0.0077, Max-Change = 0.0066, Max-Change = 0.0111, Max-Change = 0.0081, Max-Change = 0.0082, Max-Change = 0.0100, Max-Change = 0.0026, Max-Change = 0.0153, Max-Change = 0.0129, Max-Change = 0.0034, Max-Change = 0.0055, Max-Change = 0.0124, Max-Change = 0.0091, Max-Change = 0.0050, Max-Change = 0.0044, Max-Change = 0.0023, Max-Change = 0.0065, Max-Change = 0.0085, Max-Change = 0.0022, Max-Change = 0.0072, Max-Change = 0.0134, Max-Change = 0.0039, Max-Change = 0.0051, Max-Change = 0.0145, Max-Change = 0.0068, Max-Change = 0.0050, Max-Change = 0.0123, Max-Change = 0.0055, Max-Change = 0.0086, Max-Change = 0.0042, Max-Change = 0.0023, Max-Change = 0.0034, Max-Change = 0.0093, Max-Change = 0.0062, Max-Change = 0.0015, Max-Change = 0.0033, Max-Change = 0.0046, Max-Change = 0.0058, Max-Change = 0.0043, Max-Change = 0.0026, Max-Change = 0.0020, Max-Change = 0.0046, Max-Change = 0.0076, Max-Change = 0.0054, Max-Change = 0.0042, Max-Change = 0.0094, Max-Change = 0.0030, Max-Change = 0.0071, Max-Change = 0.0029, Max-Change = 0.0064, Max-Change = 0.0106, Max-Change = 0.0020, Max-Change = 0.0074, Max-Change = 0.0058, Max-Change = 0.0102, Max-Change = 0.0084, Max-Change = 0.0013, Max-Change = 0.0020, Max-Change = 0.0013, Max-Change = 0.0104, Max-Change = 0.0045, Max-Change = 0.0061, Max-Change = 0.0094, Max-Change = 0.0059, Max-Change = 0.0043, Max-Change = 0.0096, Max-Change = 0.0014, Max-Change = 0.0039, Max-Change = 0.0032, Max-Change = 0.0019, Max-Change = 0.0052, Max-Change = 0.0031, Max-Change = 0.0060, Max-Change = 0.0015, Max-Change = 0.0038, Max-Change = 0.0022, Max-Change = 0.0070, Max-Change = 0.0055, Max-Change = 0.0054, Max-Change = 0.0024, Max-Change = 0.0051, Max-Change = 0.0058, Max-Change = 0.0042, Max-Change = 0.0087, Max-Change = 0.0095, Max-Change = 0.0044, Max-Change = 0.0033, Max-Change = 0.0062, Max-Change = 0.0088, Max-Change = 0.0060, Max-Change = 0.0039, Max-Change = 0.0061, Max-Change = 0.0044, Max-Change = 0.0015, Max-Change = 0.0137, Max-Change = 0.0040, Max-Change = 0.0023, Max-Change = 0.0037, Max-Change = 0.0112, Max-Change = 0.0050, Max-Change = 0.0023, Max-Change = 0.0082, Max-Change = 0.0049, Max-Change = 0.0026, Max-Change = 0.0039, Max-Change = 0.0082, Max-Change = 0.0122, Max-Change = 0.0013, Max-Change = 0.0097, Max-Change = 0.0006, Max-Change = 0.0055, Max-Change = 0.0012, Max-Change = 0.0055, Max-Change = 0.0060, Max-Change = 0.0037, Max-Change = 0.0112, Max-Change = 0.0030, Max-Change = 0.0046, Max-Change = 0.0052, Max-Change = 0.0037, Max-Change = 0.0024, Max-Change = 0.0021, Max-Change = 0.0031, Max-Change = 0.0019, Max-Change = 0.0075, Max-Change = 0.0029, Max-Change = 0.0073, Max-Change = 0.0015, Max-Change = 0.0072, Max-Change = 0.0047, Max-Change = 0.0141, Max-Change = 0.0021, Max-Change = 0.0073, Max-Change = 0.0120, Max-Change = 0.0095, Max-Change = 0.0030, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0038, gam = 0.1057, Max-Change = 0.0007, gam = 0.0780, Max-Change = 0.0024, gam = 0.0629, Max-Change = 0.0009, gam = 0.0532, Max-Change = 0.0012, gam = 0.0464, Max-Change = 0.0022, gam = 0.0413, Max-Change = 0.0012, gam = 0.0374, Max-Change = 0.0010, gam = 0.0342, Max-Change = 0.0008, gam = 0.0316, Max-Change = 0.0022, gam = 0.0294, Max-Change = 0.0004, gam = 0.0276, Max-Change = 0.0004, gam = 0.0260, Max-Change = 0.0002
#> 
#> Calculating log-likelihood...
coef(LLTM.e)
#> $Item_1
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.087         -0.995            0.087  1 0 0 1
#> 
#> $Item_2
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.087         -0.995            0.087  1 0 0 1

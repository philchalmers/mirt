...
#>  0.255  0.036  0.084  0.118  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.257  0.036  0.124  0.076  0.000  0.000 
...
#> $Item_1
#>        a1 a2      d g u
#> par 1.263  0 -0.933 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.605  0 -1.462 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.952  0 1.561 0 1
#> 
#> $Item_4
#>      a1    a2     d g u
#> par 1.3 0.247 0.017 0 1
#> 
#> $Item_5
#>     a1   a2    d1    d2     d3
#> par  0 1.45 2.989 2.008 -0.408
#> 
#> $Item_6
#>     a1   a2    d1    d2     d3
#> par  0 0.53 2.474 0.999 -1.006
#> 
#> $Item_7
#>     a1    a2    d1    d2
#> par  0 1.029 2.052 0.003
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 1.017 0.967 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.495      1
...
#> Item_2 0.335       0.112
#> Item_3 0.488       0.238
#> Item_4 0.603 0.115 0.377
#> Item_5       0.649 0.421
#> Item_6       0.297 0.088
#> Item_7       0.517 0.268
#> Item_8       0.513 0.263
#> 
#> SS loadings:  1.069 1.053 
#> Proportion Var:  0.134 0.132 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.062  -0.029  -0.007  -0.008   0.013   0.031 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.006  0.003 -0.018  0.024 -0.062  0.027  0.024
#> Item_2  0.064         0.009 -0.010 -0.039  0.024 -0.029  0.003
#> Item_3  0.017  0.172         0.010 -0.045 -0.052 -0.035 -0.004
#> Item_4  0.661  0.183  0.199        -0.017  0.008 -0.018  0.025
#> Item_5  1.154  3.031  4.015  0.556         0.031  0.023 -0.029
#> Item_6  7.670  1.135  5.461  0.126  5.823        -0.021 -0.046
#> Item_7  1.454  1.682  2.409  0.642  2.188  1.685        -0.015
#> Item_8  1.114  0.017  0.026  1.284  1.677  4.275  0.458       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.812 0.841  0 -0.905 0 1
#> 
#> $Item_2
#>        a1   a2 a3      d g u
#> par 0.255 0.63  0 -1.487 0 1
#> 
#> $Item_3
#>        a1    a2 a3     d g u
#> par 0.463 1.095  0 1.676 0 1
#> 
#> $Item_4
#>        a1    a2 a3     d g u
#> par 1.017 0.889  0 0.021 0 1
#> 
#> $Item_5
#>        a1 a2    a3    d1    d2     d3
#> par 1.276  0 1.044 3.168 2.134 -0.432
#> 
#> $Item_6
#>        a1 a2    a3    d1    d2     d3
#> par 0.428  0 0.313 2.475 0.999 -1.006
#> 
#> $Item_7
#>        a1 a2    a3   d1    d2
#> par 0.845  0 0.548 2.04 0.002
#> 
#> $Item_8
#>        a1 a2    a3     d g u
#> par 0.975  0 0.275 0.968 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.393 0.407       0.321
#> Item_2 0.139 0.344       0.137
#> Item_3 0.223 0.527       0.328
#> Item_4 0.468 0.409       0.387
#> Item_5 0.538       0.441 0.484
#> Item_6 0.240       0.175 0.088
#> Item_7 0.427       0.277 0.259
#> Item_8 0.492       0.139 0.262
#> 
#> SS loadings:  1.215 0.729 0.321 
#> Proportion Var:  0.152 0.091 0.04 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.063  -0.017   0.000  -0.002   0.012   0.041 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.008 -0.004  0.002 -0.022 -0.063  0.017 -0.002
#> Item_2  0.137        -0.013 -0.006  0.037  0.034 -0.016  0.011
#> Item_3  0.040  0.341         0.005  0.041 -0.048  0.035  0.005
#> Item_4  0.011  0.063  0.042        -0.012  0.011 -0.014  0.009
#> Item_5  0.944  2.665  3.407  0.312         0.029 -0.022 -0.026
#> Item_6  8.032  2.274  4.629  0.241  5.215        -0.020 -0.043
#> Item_7  0.559  0.535  2.464  0.419  1.880  1.632         0.016
#> Item_8  0.011  0.251  0.041  0.161  1.399  3.767  0.488       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df    p
#> mod1 24818.32 24874.07 24865.62 24947.14 -12386.16              
#> mod3 24821.44 24891.73 24881.08 24983.86 -12381.72 8.886  6 0.18
...
#> -1.51715 -0.27600 -0.00923  0.28992  1.45095 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.009596   0.014271   0.672    0.501    
#> covdata$X1   0.497012   0.014333  34.677   <2e-16 ***
#> covdata$X2  -1.004831   0.014568 -68.973   <2e-16 ***
#> ---
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.29521 -0.31811 -0.00641  0.31530  1.49713 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.00749    0.01451   0.516    0.606    
#> covdata$X1   0.52679    0.01457  36.150   <2e-16 ***
#> covdata$X2  -0.99881    0.01481 -67.433   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.38005 -0.31935 -0.00718  0.30172  1.34147 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.005826   0.014613  -0.399     0.69    
#> covdata$X1   0.509155   0.014676  34.694   <2e-16 ***
#> covdata$X2  -1.001304   0.014917 -67.124   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4619 on 997 degrees of freedom
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.42790 -0.30009 -0.01746  0.30969  2.04347 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.008014   0.014636   0.548    0.584    
#> covdata$X1   0.509279   0.014699  34.647   <2e-16 ***
#> covdata$X2  -1.005494   0.014941 -67.297   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4626 on 997 degrees of freedom
...
#> Residuals:
#>     Min      1Q  Median      3Q     Max 
#> -1.3595 -0.2976  0.0102  0.3087  1.4935 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.01036    0.01379   0.751    0.453    
#> covdata$X1   0.50944    0.01385  36.773   <2e-16 ***
#> covdata$X2  -1.00822    0.01408 -71.598   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.436 on 997 degrees of freedom
#> Multiple R-squared:  0.8615, Adjusted R-squared:  0.8612 
#> F-statistic:  3100 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[6]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.55599 -0.30506 -0.00032  0.30476  1.41553 
#> 
#> Coefficients:
#>              Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.002062   0.014240  -0.145    0.885    
#> covdata$X1   0.508827   0.014301  35.579   <2e-16 ***
#> covdata$X2  -1.024959   0.014537 -70.508   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4501 on 997 degrees of freedom
#> Multiple R-squared:  0.8569, Adjusted R-squared:  0.8567 
#> F-statistic:  2986 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[7]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.46529 -0.31420  0.00307  0.30738  1.49231 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.01444    0.01475   0.979    0.328    
#> covdata$X1   0.52911    0.01482  35.712   <2e-16 ***
#> covdata$X2  -0.99333    0.01506 -65.959   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4663 on 997 degrees of freedom
#> Multiple R-squared:  0.8436, Adjusted R-squared:  0.8433 
#> F-statistic:  2688 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[8]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.32412 -0.32755  0.00084  0.32692  1.28293 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.00179    0.01424  -0.126      0.9    
#> covdata$X1   0.53345    0.01430  37.297   <2e-16 ***
#> covdata$X2  -1.00264    0.01454 -68.967   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4501 on 997 degrees of freedom
#> Multiple R-squared:  0.8549, Adjusted R-squared:  0.8546 
#> F-statistic:  2937 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[9]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.48951 -0.32234 -0.00898  0.31631  1.33942 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept) -0.01887    0.01456  -1.297    0.195    
#> covdata$X1   0.51046    0.01462  34.920   <2e-16 ***
#> covdata$X2  -1.00630    0.01486 -67.726   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4601 on 997 degrees of freedom
#> Multiple R-squared:  0.8479, Adjusted R-squared:  0.8476 
#> F-statistic:  2778 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
#> [[10]]
#> 
...
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -1.51721 -0.31299 -0.00203  0.29572  1.25877 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)    
#> (Intercept)  0.01057    0.01402   0.754    0.451    
#> covdata$X1   0.50216    0.01408  35.670   <2e-16 ***
#> covdata$X2  -0.98769    0.01431 -69.024   <2e-16 ***
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Residual standard error: 0.4431 on 997 degrees of freedom
#> Multiple R-squared:  0.8528, Adjusted R-squared:  0.8525 
#> F-statistic:  2888 on 2 and 997 DF,  p-value: < 2.2e-16
#> 
#> 
...
averageMI(par, SEpar)
#>                par SEpar       t     df     p
#> (Intercept)  0.003 0.018   0.178 70.787 0.215
#> covdata$X1   0.514 0.019  26.793 47.905     0
#> covdata$X2  -1.003 0.018 -55.893 81.355     0
...
#> Item_1           1.069          0.000            0.000  1 0 0 1
#> Item_2           1.069          0.000            0.000  1 0 0 1
#> Item_3           1.069          0.000            0.000  1 0 0 1
#> Item_4           1.069          0.000            0.000  1 0 0 1
#> Item_5           1.069          0.000            0.000  1 0 0 1
#> Item_6           1.069          0.000            0.000  1 0 0 1
#> Item_7           1.069          0.000            0.000  1 0 0 1
#> Item_8           1.069          0.000            0.000  1 0 0 1
#> Item_9           1.069          0.000            0.000  1 0 0 1
#> Item_10          1.069          0.000            0.000  1 0 0 1
#> Item_11          0.000          0.000            0.044  1 0 0 1
#> Item_12          0.000          0.000            0.044  1 0 0 1
#> Item_13          0.000          0.000            0.044  1 0 0 1
#> Item_14          0.000          0.000            0.044  1 0 0 1
#> Item_15          0.000          0.000            0.044  1 0 0 1
#> Item_16          0.000          0.000            0.044  1 0 0 1
#> Item_17          0.000          0.000            0.044  1 0 0 1
#> Item_18          0.000          0.000            0.044  1 0 0 1
#> Item_19          0.000          0.000            0.044  1 0 0 1
#> Item_20          0.000          0.000            0.044  1 0 0 1
#> Item_21          0.000         -0.975            0.000  1 0 0 1
#> Item_22          0.000         -0.975            0.000  1 0 0 1
#> Item_23          0.000         -0.975            0.000  1 0 0 1
#> Item_24          0.000         -0.975            0.000  1 0 0 1
#> Item_25          0.000         -0.975            0.000  1 0 0 1
#> Item_26          0.000         -0.975            0.000  1 0 0 1
#> Item_27          0.000         -0.975            0.000  1 0 0 1
#> Item_28          0.000         -0.975            0.000  1 0 0 1
#> Item_29          0.000         -0.975            0.000  1 0 0 1
#> Item_30          0.000         -0.975            0.000  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> par          1.069         -0.975            0.044  1  0     -999      999
...
#>           AIC    SABIC       HQ      BIC    logLik     X2 df     p
#> lltm 35161.44 35168.37 35168.90 35181.07 -17576.72                
#> mod  35179.97 35233.65 35237.79 35332.11 -17558.99 35.473 27 0.127
...
itemfit(lltm)
#>       item   S_X2 df.S_X2 RMSEA.S_X2 p.S_X2
#> 1   Item_1 12.790      19      0.000  0.849
#> 2   Item_2 28.176      19      0.022  0.080
#> 3   Item_3 22.001      19      0.013  0.284
#> 4   Item_4 26.873      19      0.020  0.108
#> 5   Item_5 16.815      19      0.000  0.602
#> 6   Item_6 34.297      19      0.028  0.017
#> 7   Item_7 12.007      19      0.000  0.885
#> 8   Item_8 28.096      19      0.022  0.082
#> 9   Item_9 15.778      19      0.000  0.672
#> 10 Item_10 25.532      19      0.019  0.144
#> 11 Item_11 27.534      20      0.019  0.121
#> 12 Item_12 34.776      20      0.027  0.021
#> 13 Item_13 27.552      20      0.019  0.120
#> 14 Item_14 22.093      20      0.010  0.336
#> 15 Item_15 18.870      20      0.000  0.530
#> 16 Item_16 22.656      20      0.012  0.306
#> 17 Item_17 14.558      20      0.000  0.801
#> 18 Item_18 30.934      20      0.023  0.056
#> 19 Item_19 20.032      20      0.001  0.456
#> 20 Item_20 21.469      20      0.009  0.370
#> 21 Item_21 23.103      19      0.015  0.233
#> 22 Item_22 29.626      19      0.024  0.057
#> 23 Item_23 29.483      19      0.024  0.059
#> 24 Item_24 29.954      19      0.024  0.052
#> 25 Item_25 23.286      19      0.015  0.225
#> 26 Item_26 13.497      19      0.000  0.812
#> 27 Item_27 28.404      19      0.022  0.076
#> 28 Item_28 16.949      19      0.000  0.593
#> 29 Item_29 24.258      19      0.017  0.186
#> 30 Item_30 14.387      19      0.000  0.761
...
#>    Sum.Scores          F1     SE_F1 observed   expected    std.res
#> 0           0 -2.68316396 0.5501582        1  0.8036063 0.21908155
#> 1           1 -2.40068977 0.5138992        1  2.7512697 1.05581167
#> 2           2 -2.15186488 0.4846464        5  5.8205248 0.34010315
#> 3           3 -1.92865819 0.4609752        7  9.8336336 0.90362176
#> 4           4 -1.72520486 0.4417276       17 14.5662806 0.63767026
#> 5           5 -1.53717148 0.4260061       21 19.7909761 0.27176984
#> 6           6 -1.36130064 0.4131261       29 25.2914400 0.73742614
#> 7           7 -1.19509516 0.4025681       29 30.8661575 0.33589769
#> 8           8 -1.03660052 0.3939378       34 36.3287447 0.38636402
#> 9           9 -0.88425357 0.3869350       43 41.5079889 0.23158275
#> 10         10 -0.73677590 0.3813320       45 46.2484306 0.18357600
#> 11         11 -0.59309696 0.3769566       52 50.4115619 0.22372021
#> 12         12 -0.45229745 0.3736809       67 53.8774409 1.78778405
#> 13         13 -0.31356620 0.3714128       54 56.5464619 0.33863704
#> 14         14 -0.17616624 0.3700908       56 58.3410563 0.30649593
#> 15         15 -0.03940677 0.3696795       59 59.2071621 0.02692299
#> 16         16  0.09738134 0.3701684       53 59.1153604 0.79537491
#> 17         17  0.23486839 0.3715707       52 58.0616274 0.79550816
#> 18         18  0.37374880 0.3739244       61 56.0676851 0.65871034
#> 19         19  0.51476585 0.3772941       58 53.1809667 0.66081792
#> 20         20  0.65874014 0.3817754       48 49.4742511 0.20959544
#> 21         21  0.80660431 0.3875002       42 45.0450787 0.45370635
#> 22         22  0.95944719 0.3946457       37 40.0151432 0.47664579
#> 23         23  1.11857207 0.4034463       34 34.5299469 0.09018502
#> 24         24  1.28557600 0.4142100       26 28.7590983 0.51449309
#> 25         25  1.46246005 0.4273423       18 22.8976425 1.02350907
#> 26         26  1.65178592 0.4433768       23 17.1686107 1.40735760
#> 27         27  1.85690167 0.4630166       19 11.8261871 2.08606422
#> 28         28  2.08226913 0.4871832        6  7.1565735 0.43233527
#> 29         29  2.33393553 0.5170613        2  3.4674441 0.78805556
#> 30         30  2.62018733 0.5540995        1  1.0416481 0.04080697
M2(lltm) # goodness of fit
#>            M2  df     p RMSEA RMSEA_5 RMSEA_95 SRMSR   TLI CFI
#> stats 432.949 461 0.822     0       0    0.007 0.029 1.003   1
head(personfit(lltm))
#>      outfit   z.outfit     infit     z.infit         Zh
#> 1 0.4058921 -1.3954752 0.6230513 -1.27464026 1.24229659
#> 2 0.6357571 -1.6421789 0.7340362 -1.65368669 1.53942083
#> 3 0.5536868 -0.9258872 0.7061780 -0.94591930 0.94323985
#> 4 1.0096418  0.1431036 0.9727477 -0.05144665 0.06963461
#> 5 0.4471489 -1.4603255 0.6592744 -1.31080327 1.28805326
#> 6 0.4451712 -1.4899366 0.6534538 -1.35729599 1.31803883
residuals(lltm)
#> LD matrix (lower triangle) and standardized residual correlations (upper triangle)
#> 
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.102  -0.051  -0.014  -0.002   0.047   0.112 
#> 
#>         Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8 Item_9 Item_10
#> Item_1         -0.096 -0.081  0.059 -0.056 -0.066 -0.074 -0.052 -0.056  -0.056
#> Item_2   9.169         0.059  0.066  0.062  0.074  0.066 -0.063 -0.062  -0.078
#> Item_3   6.568  3.511         0.054  0.026  0.045  0.015 -0.028 -0.015   0.021
#> Item_4   3.434  4.363  2.919         0.022  0.061 -0.021  0.052 -0.021   0.027
#> Item_5   3.125  3.814  0.689  0.473        -0.040 -0.027 -0.023 -0.038  -0.032
#> Item_6   4.418  5.423  2.056  3.714  1.600         0.040  0.036  0.042  -0.041
#> Item_7   5.508  4.409  0.224  0.450  0.752  1.617        -0.073 -0.036   0.038
#> Item_8   2.742  3.994  0.790  2.684  0.535  1.303  5.340         0.023   0.024
#> Item_9   3.125  3.873  0.234  0.448  1.471  1.792  1.264  0.531         -0.032
#> Item_10  3.146  6.127  0.457  0.733  1.041  1.642  1.425  0.583  1.041        
#> Item_11  2.529  5.691  0.187  0.826  0.676  1.271  0.145  0.291  0.392   2.539
#> Item_12  5.640  4.309  3.182  2.404  3.168  7.268  1.760  1.939  2.475   5.196
#> Item_13  3.249  4.600  0.859  5.431  0.967  1.876  2.748  1.176  2.647   1.475
#> Item_14  4.029  6.122  5.573  3.447  1.742  2.063  1.184  1.260  2.047   1.361
#> Item_15  4.891  3.784  0.747  1.189  0.842  2.286  0.861  1.300  0.933   1.237
#> Item_16  3.363  7.119  2.827  3.151  1.987  2.885  1.834  1.741  1.745   1.672
#> Item_17  2.681  5.368  0.827  0.378  0.464  1.265  0.219  1.009  2.023   2.039
#> Item_18  2.445  5.964  0.520  0.376  1.250  1.282  0.029  1.601  0.443   0.580
#> Item_19  2.918  4.548  2.149  0.295  0.363  1.265  1.014  0.259  0.231   0.742
#> Item_20  3.661  4.136  0.787  0.992  1.202  2.840  1.231  3.497  0.874   1.186
#> Item_21  3.384  7.753  1.070  2.483  0.263  1.678  0.017  0.337  0.715   0.544
#> Item_22  2.656  4.303  5.856  6.316  0.767  1.383  5.823  2.104  4.610   0.533
#> Item_23  3.377  4.348  0.874  2.190  3.642  2.195  3.010  1.681  1.609   0.771
#> Item_24  7.064  7.505  5.647  4.805  5.254  5.463  5.138  4.095  6.210   5.761
#> Item_25  5.843  5.453  2.604  3.060  2.785  4.334  3.613  3.156  3.126   3.423
#> Item_26  4.729  7.318  3.048  3.041  7.006  3.712  2.395  2.989  4.430   4.240
#> Item_27  6.935 10.193  6.450  6.799  5.930  5.855  5.327  6.612  5.930   6.477
#> Item_28  2.461  4.117  0.627  0.518  2.625  1.231  0.055  0.366  1.337   0.588
#> Item_29  3.979  3.617  1.632  1.195  6.960  5.752  0.465  0.730  0.764   0.899
#> Item_30  3.675  3.882  1.041  2.293  0.933  4.082  0.797  1.062  0.910   1.929
#>         Item_11 Item_12 Item_13 Item_14 Item_15 Item_16 Item_17 Item_18 Item_19
#> Item_1   -0.050  -0.075  -0.057  -0.063  -0.070   0.058  -0.052   0.049  -0.054
#> Item_2   -0.075  -0.066   0.068   0.078  -0.062   0.084   0.073  -0.077  -0.067
#> Item_3   -0.014  -0.056   0.029   0.075  -0.027   0.053   0.029   0.023   0.046
#> Item_4   -0.029  -0.049   0.074   0.059  -0.034   0.056  -0.019  -0.019  -0.017
#> Item_5   -0.026  -0.056   0.031   0.042  -0.029   0.045   0.022  -0.035  -0.019
#> Item_6   -0.036  -0.085  -0.043  -0.045   0.048   0.054   0.036   0.036   0.036
#> Item_7   -0.012  -0.042  -0.052   0.034   0.029  -0.043   0.015   0.005   0.032
#> Item_8   -0.017  -0.044   0.034  -0.035   0.036   0.042   0.032  -0.040   0.016
#> Item_9   -0.020   0.050   0.051   0.045  -0.031  -0.042   0.045   0.021   0.015
#> Item_10  -0.050  -0.072   0.038  -0.037   0.035   0.041   0.045  -0.024  -0.027
#> Item_11          -0.067  -0.030  -0.035   0.054  -0.038  -0.050   0.011  -0.015
#> Item_12   4.459          -0.052  -0.061  -0.043  -0.063   0.041  -0.043  -0.047
#> Item_13   0.925   2.702           0.041  -0.039   0.059  -0.026   0.055  -0.027
#> Item_14   1.246   3.682   1.665          -0.052   0.054  -0.045   0.047   0.062
#> Item_15   2.912   1.827   1.504   2.750           0.054  -0.026  -0.038   0.045
#> Item_16   1.415   3.952   3.426   2.920   2.890           0.078   0.044   0.061
#> Item_17   2.466   1.688   0.690   2.061   0.678   6.085           0.010   0.046
#> Item_18   0.121   1.864   3.063   2.177   1.414   1.973   0.106          -0.008
#> Item_19   0.218   2.225   0.716   3.783   2.013   3.737   2.093   0.063        
#> Item_20   2.222   1.773   1.769   2.248   1.975   2.240   1.507   0.652   1.476
#> Item_21   2.264   1.642   2.375   7.563   2.026   1.684   0.136   0.609   1.043
#> Item_22   2.756   4.840   0.768   2.747   1.500   1.707   0.381   0.756   0.942
#> Item_23   0.559   3.106   0.968   2.031   1.431   2.017   1.392   0.582   0.942
#> Item_24   4.396   5.873   5.171   5.658   4.250   5.696   3.835   3.843   3.998
#> Item_25   2.943   4.783   7.487   4.841   2.985   4.676   2.748   4.408   2.975
#> Item_26   2.635   4.526   2.800   3.126   3.546   6.758   3.761   2.497  11.436
#> Item_27   6.573   8.080  12.544   5.857   6.718   5.917  11.649   5.403   5.964
#> Item_28   1.412   1.484   2.601   1.771   0.694   1.775   4.791   0.039   2.220
#> Item_29   0.803   1.955   1.216   1.979   1.966   2.043   3.159   0.485   0.434
#> Item_30   2.102   1.895   4.624   2.447   7.552   3.085   0.817   1.054   0.817
#>         Item_20 Item_21 Item_22 Item_23 Item_24 Item_25 Item_26 Item_27 Item_28
#> Item_1   -0.061  -0.058  -0.052   0.058  -0.084   0.076   0.069   0.083   0.050
#> Item_2   -0.064   0.088   0.066  -0.066  -0.087   0.074   0.086  -0.101   0.064
#> Item_3   -0.028   0.033  -0.077  -0.030   0.075  -0.051   0.055   0.080  -0.025
#> Item_4    0.032   0.050  -0.079   0.047   0.069   0.055  -0.055  -0.082  -0.023
#> Item_5   -0.035  -0.016   0.028   0.060   0.072  -0.053   0.084  -0.077   0.051
#> Item_6   -0.053   0.041  -0.037  -0.047  -0.074   0.066   0.061  -0.077   0.035
#> Item_7   -0.035   0.004  -0.076  -0.055  -0.072   0.060   0.049  -0.073   0.007
#> Item_8   -0.059   0.018   0.046   0.041  -0.064   0.056  -0.055   0.081   0.019
#> Item_9   -0.030   0.027  -0.068  -0.040   0.079  -0.056  -0.067  -0.077   0.037
#> Item_10   0.034   0.023   0.023   0.028   0.076   0.059   0.065   0.080  -0.024
#> Item_11  -0.047   0.048  -0.053   0.024   0.066   0.054   0.051  -0.081  -0.038
#> Item_12  -0.042  -0.041  -0.070   0.056   0.077  -0.069  -0.067  -0.090   0.039
#> Item_13  -0.042   0.049   0.028   0.031   0.072  -0.087   0.053   0.112  -0.051
#> Item_14  -0.047   0.087  -0.052   0.045  -0.075   0.070  -0.056   0.077   0.042
#> Item_15  -0.044   0.045   0.039   0.038  -0.065   0.055   0.060  -0.082   0.026
#> Item_16  -0.047   0.041   0.041   0.045   0.075   0.068   0.082  -0.077   0.042
#> Item_17   0.039   0.012   0.020   0.037  -0.062   0.052  -0.061   0.108   0.069
#> Item_18   0.026  -0.025  -0.027  -0.024  -0.062   0.066  -0.050  -0.074  -0.006
#> Item_19  -0.038   0.032   0.031   0.031  -0.063  -0.055   0.107  -0.077   0.047
#> Item_20           0.029  -0.051   0.043  -0.064  -0.062   0.058  -0.095  -0.043
#> Item_21   0.845           0.032   0.057  -0.065   0.066   0.053   0.076  -0.004
#> Item_22   2.603   0.997          -0.041  -0.078  -0.057  -0.080   0.075  -0.026
#> Item_23   1.890   3.257   1.694           0.071   0.076   0.086   0.076  -0.022
#> Item_24   4.136   4.162   6.095   5.041           0.074   0.089  -0.102  -0.062
#> Item_25   3.815   4.358   3.214   5.817   5.405          -0.078  -0.102   0.060
#> Item_26   3.388   2.780   6.324   7.359   7.988   6.023           0.089   0.049
#> Item_27   8.967   5.709   5.700   5.715  10.496  10.472   7.980          -0.074
#> Item_28   1.891   0.018   0.680   0.491   3.851   3.558   2.438   5.474        
#> Item_29   0.927   0.482   0.892   1.836   4.891   2.946   4.114   6.595   0.578
#> Item_30   2.275   0.952   4.229   1.365   4.813   3.055   3.710   6.800   1.036
#>         Item_29 Item_30
#> Item_1   -0.063  -0.061
#> Item_2   -0.060  -0.062
#> Item_3    0.040   0.032
...
#>               AIC    SABIC      HQ      BIC    logLik X2 df   p
#> lltm     35161.44 35168.37 35168.9 35181.07 -17576.72          
#> lltm.int 35161.44 35168.37 35168.9 35181.07 -17576.72  0  0 NaN
...
#> Item_9        1.069          0.000            0.000  1 0 0 1
#> Item_10       1.069          0.000            0.000  1 0 0 1
#> Item_11       1.069          0.000           -1.025  1 0 0 1
#> Item_12       1.069          0.000           -1.025  1 0 0 1
#> Item_13       1.069          0.000           -1.025  1 0 0 1
#> Item_14       1.069          0.000           -1.025  1 0 0 1
#> Item_15       1.069          0.000           -1.025  1 0 0 1
#> Item_16       1.069          0.000           -1.025  1 0 0 1
#> Item_17       1.069          0.000           -1.025  1 0 0 1
#> Item_18       1.069          0.000           -1.025  1 0 0 1
#> Item_19       1.069          0.000           -1.025  1 0 0 1
#> Item_20       1.069          0.000           -1.025  1 0 0 1
#> Item_21       1.069         -2.044            0.000  1 0 0 1
#> Item_22       1.069         -2.044            0.000  1 0 0 1
#> Item_23       1.069         -2.044            0.000  1 0 0 1
#> Item_24       1.069         -2.044            0.000  1 0 0 1
#> Item_25       1.069         -2.044            0.000  1 0 0 1
#> Item_26       1.069         -2.044            0.000  1 0 0 1
#> Item_27       1.069         -2.044            0.000  1 0 0 1
#> Item_28       1.069         -2.044            0.000  1 0 0 1
#> Item_29       1.069         -2.044            0.000  1 0 0 1
#> Item_30       1.069         -2.044            0.000  1 0 0 1
#> 
#> $means
#> F1 
#>  0 
...
#> $items
#>         difficultyeasy difficultyhard difficultymedium a1     d g u
#> Item_1           0.000          0.000            0.000  1 0.946 0 1
#> Item_2           0.000          0.000            0.000  1 1.228 0 1
#> Item_3           0.000          0.000            0.000  1 1.087 0 1
#> Item_4           0.000          0.000            0.000  1 1.115 0 1
#> Item_5           1.054          0.000            0.000  1 0.000 0 1
#> Item_6           1.054          0.000            0.000  1 0.000 0 1
#> Item_7           1.054          0.000            0.000  1 0.000 0 1
#> Item_8           1.054          0.000            0.000  1 0.000 0 1
#> Item_9           1.054          0.000            0.000  1 0.000 0 1
#> Item_10          1.054          0.000            0.000  1 0.000 0 1
#> Item_11          0.000          0.000            0.044  1 0.000 0 1
#> Item_12          0.000          0.000            0.044  1 0.000 0 1
#> Item_13          0.000          0.000            0.044  1 0.000 0 1
#> Item_14          0.000          0.000            0.044  1 0.000 0 1
#> Item_15          0.000          0.000            0.044  1 0.000 0 1
#> Item_16          0.000          0.000            0.044  1 0.000 0 1
#> Item_17          0.000          0.000            0.044  1 0.000 0 1
#> Item_18          0.000          0.000            0.044  1 0.000 0 1
#> Item_19          0.000          0.000            0.044  1 0.000 0 1
#> Item_20          0.000          0.000            0.044  1 0.000 0 1
#> Item_21          0.000         -0.974            0.000  1 0.000 0 1
#> Item_22          0.000         -0.974            0.000  1 0.000 0 1
#> Item_23          0.000         -0.974            0.000  1 0.000 0 1
#> Item_24          0.000         -0.974            0.000  1 0.000 0 1
#> Item_25          0.000         -0.974            0.000  1 0.000 0 1
#> Item_26          0.000         -0.974            0.000  1 0.000 0 1
#> Item_27          0.000         -0.974            0.000  1 0.000 0 1
#> Item_28          0.000         -0.974            0.000  1 0.000 0 1
#> Item_29          0.000         -0.974            0.000  1 0.000 0 1
#> Item_30          0.000         -0.974            0.000  1 0.000 0 1
#> 
#> $means
#> F1 
#>  0 
...
#>             AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> lltm   35161.44 35168.37 35168.90 35181.07 -17576.72               
#> lltm.4 35161.83 35175.68 35176.75 35201.09 -17572.92 7.612  4 0.107
...
#> , Max-Change = 0.1914, Max-Change = 0.1536, Max-Change = 0.1267, Max-Change = 0.1021, Max-Change = 0.0825, Max-Change = 0.0686, Max-Change = 0.0558, Max-Change = 0.0464, Max-Change = 0.0376, Max-Change = 0.0329, Max-Change = 0.0266, Max-Change = 0.0228, Max-Change = 0.0194, Max-Change = 0.0146, Max-Change = 0.0156, Max-Change = 0.0097, Max-Change = 0.0086, Max-Change = 0.0079, Max-Change = 0.0099, Max-Change = 0.0073, Max-Change = 0.0035, Max-Change = 0.0062, Max-Change = 0.0035, Max-Change = 0.0074, Max-Change = 0.0037, Max-Change = 0.0059, Max-Change = 0.0027, Max-Change = 0.0026, Max-Change = 0.0042, Max-Change = 0.0024, Max-Change = 0.0044, Max-Change = 0.0042, Max-Change = 0.0052, Max-Change = 0.0065, Max-Change = 0.0041, Max-Change = 0.0045, Max-Change = 0.0043, Max-Change = 0.0062, Max-Change = 0.0029, Max-Change = 0.0148, Max-Change = 0.0023, Max-Change = 0.0020, Max-Change = 0.0033, Max-Change = 0.0049, Max-Change = 0.0068, Max-Change = 0.0059, Max-Change = 0.0041, Max-Change = 0.0025, Max-Change = 0.0102, Max-Change = 0.0070, Max-Change = 0.0068, Max-Change = 0.0108, Max-Change = 0.0060, Max-Change = 0.0050, Max-Change = 0.0007, Max-Change = 0.0013, Max-Change = 0.0072, Max-Change = 0.0026, Max-Change = 0.0066, Max-Change = 0.0040, Max-Change = 0.0035, Max-Change = 0.0034, Max-Change = 0.0017, Max-Change = 0.0026, Max-Change = 0.0072, Max-Change = 0.0021, Max-Change = 0.0037, Max-Change = 0.0041, Max-Change = 0.0018, Max-Change = 0.0074, Max-Change = 0.0056, Max-Change = 0.0027, Max-Change = 0.0067, Max-Change = 0.0059, Max-Change = 0.0029, Max-Change = 0.0064, Max-Change = 0.0027, Max-Change = 0.0031, Max-Change = 0.0058, Max-Change = 0.0016, Max-Change = 0.0053, Max-Change = 0.0072, Max-Change = 0.0033, Max-Change = 0.0039, Max-Change = 0.0022, Max-Change = 0.0007, Max-Change = 0.0051, Max-Change = 0.0033, Max-Change = 0.0080, Max-Change = 0.0002, Max-Change = 0.0058, Max-Change = 0.0062, Max-Change = 0.0022, Max-Change = 0.0057, Max-Change = 0.0069, Max-Change = 0.0036, Max-Change = 0.0060, Max-Change = 0.0029, Max-Change = 0.0026, Max-Change = 0.0039, Max-Change = 0.0142, Max-Change = 0.0108, Max-Change = 0.0024, Max-Change = 0.0101, Max-Change = 0.0058, Max-Change = 0.0080, Max-Change = 0.0059, Max-Change = 0.0011, Max-Change = 0.0055, Max-Change = 0.0038, Max-Change = 0.0031, Max-Change = 0.0012, Max-Change = 0.0074, Max-Change = 0.0028, Max-Change = 0.0057, Max-Change = 0.0069, Max-Change = 0.0070, Max-Change = 0.0064, Max-Change = 0.0039, Max-Change = 0.0012, Max-Change = 0.0027, Max-Change = 0.0029, Max-Change = 0.0040, Max-Change = 0.0031, Max-Change = 0.0044, Max-Change = 0.0040, Max-Change = 0.0026, Max-Change = 0.0018, Max-Change = 0.0026, Max-Change = 0.0034, Max-Change = 0.0029, Max-Change = 0.0092, Max-Change = 0.0052, Max-Change = 0.0072, Max-Change = 0.0030, Max-Change = 0.0015, Max-Change = 0.0042, Max-Change = 0.0041, Max-Change = 0.0068, Max-Change = 0.0067, Max-Change = 0.0040, Max-Change = 0.0008, Max-Change = 0.0054, Max-Change = 0.0008, Max-Change = 0.0022, Max-Change = 0.0097, Max-Change = 0.0041, Max-Change = 0.0014, Max-Change = 0.0065, Max-Change = 0.0128, Max-Change = 0.0059, Max-Change = 0.0111, Max-Change = 0.0069, Max-Change = 0.0059, Max-Change = 0.0047, Max-Change = 0.0112, Max-Change = 0.0089, Max-Change = 0.0058, Max-Change = 0.0044, Max-Change = 0.0021, Max-Change = 0.0044, Max-Change = 0.0032, Max-Change = 0.0052, Max-Change = 0.0034, Max-Change = 0.0073, Max-Change = 0.0074, Max-Change = 0.0015, Max-Change = 0.0042, Max-Change = 0.0078, Max-Change = 0.0019, Max-Change = 0.0010, Max-Change = 0.0019, Max-Change = 0.0037, Max-Change = 0.0066, Max-Change = 0.0107, Max-Change = 0.0013, Max-Change = 0.0127, Max-Change = 0.0075, Max-Change = 0.0040, Max-Change = 0.0003, Max-Change = 0.0085, Max-Change = 0.0007, Max-Change = 0.0012, Max-Change = 0.0088, Max-Change = 0.0020, Max-Change = 0.0090, Max-Change = 0.0015, Max-Change = 0.0067, Max-Change = 0.0012, Max-Change = 0.0121, Max-Change = 0.0010, Max-Change = 0.0071, Max-Change = 0.0065, Max-Change = 0.0031, Max-Change = 0.0042, Max-Change = 0.0032, Max-Change = 0.0100, Max-Change = 0.0011, Max-Change = 0.0041, Max-Change = 0.0022, Max-Change = 0.0057, Max-Change = 0.0016, Max-Change = 0.0028, Max-Change = 0.0030, Max-Change = 0.0025, Max-Change = 0.0005, Max-Change = 0.0103, Max-Change = 0.0012, Max-Change = 0.0074, Max-Change = 0.0019, Max-Change = 0.0052, Max-Change = 0.0005, Max-Change = 0.0028, Max-Change = 0.0085, Max-Change = 0.0041, Max-Change = 0.0038, Max-Change = 0.0068, Max-Change = 0.0020, Max-Change = 0.0031, Max-Change = 0.0114, Max-Change = 0.0035, Max-Change = 0.0040, Max-Change = 0.0013, Max-Change = 0.0029, Max-Change = 0.0033, Max-Change = 0.0023, Max-Change = 0.0058, Max-Change = 0.0055, Max-Change = 0.0048, Max-Change = 0.0108, Max-Change = 0.0015, Max-Change = 0.0056, Max-Change = 0.0039, Max-Change = 0.0090, Max-Change = 0.0031, Max-Change = 0.0071, Max-Change = 0.0039, Max-Change = 0.0075, Max-Change = 0.0018, Max-Change = 0.0013, Max-Change = 0.0027, Max-Change = 0.0031, Max-Change = 0.0068, Max-Change = 0.0023, Max-Change = 0.0053, Max-Change = 0.0187, Max-Change = 0.0102, Max-Change = 0.0051, Max-Change = 0.0064, Max-Change = 0.0102, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0024, gam = 0.1057, Max-Change = 0.0009, gam = 0.0780, Max-Change = 0.0017, gam = 0.0629, Max-Change = 0.0004, gam = 0.0532, Max-Change = 0.0012, gam = 0.0464, Max-Change = 0.0010, gam = 0.0413, Max-Change = 0.0007, gam = 0.0374, Max-Change = 0.0008
#> 
#> Calculating log-likelihood...
summary(LLTM)
#> 
...
#> difficultyeasy      1.070        NA      NA
#> difficultyhard     -0.972        NA      NA
#> difficultymedium    0.046        NA      NA
#> 
#> --------------
...
#> , Max-Change = 0.1914, Max-Change = 0.1536, Max-Change = 0.1267, Max-Change = 0.1021, Max-Change = 0.0825, Max-Change = 0.0686, Max-Change = 0.0558, Max-Change = 0.0464, Max-Change = 0.0376, Max-Change = 0.0329, Max-Change = 0.0266, Max-Change = 0.0228, Max-Change = 0.0194, Max-Change = 0.0146, Max-Change = 0.0156, Max-Change = 0.0097, Max-Change = 0.0086, Max-Change = 0.0079, Max-Change = 0.0099, Max-Change = 0.0073, Max-Change = 0.0035, Max-Change = 0.0062, Max-Change = 0.0035, Max-Change = 0.0074, Max-Change = 0.0037, Max-Change = 0.0059, Max-Change = 0.0027, Max-Change = 0.0026, Max-Change = 0.0042, Max-Change = 0.0024, Max-Change = 0.0044, Max-Change = 0.0042, Max-Change = 0.0052, Max-Change = 0.0065, Max-Change = 0.0041, Max-Change = 0.0045, Max-Change = 0.0043, Max-Change = 0.0062, Max-Change = 0.0029, Max-Change = 0.0148, Max-Change = 0.0023, Max-Change = 0.0020, Max-Change = 0.0033, Max-Change = 0.0049, Max-Change = 0.0068, Max-Change = 0.0059, Max-Change = 0.0041, Max-Change = 0.0025, Max-Change = 0.0102, Max-Change = 0.0070, Max-Change = 0.0068, Max-Change = 0.0108, Max-Change = 0.0060, Max-Change = 0.0050, Max-Change = 0.0007, Max-Change = 0.0013, Max-Change = 0.0072, Max-Change = 0.0026, Max-Change = 0.0066, Max-Change = 0.0040, Max-Change = 0.0035, Max-Change = 0.0034, Max-Change = 0.0017, Max-Change = 0.0026, Max-Change = 0.0072, Max-Change = 0.0021, Max-Change = 0.0037, Max-Change = 0.0041, Max-Change = 0.0018, Max-Change = 0.0074, Max-Change = 0.0056, Max-Change = 0.0027, Max-Change = 0.0067, Max-Change = 0.0059, Max-Change = 0.0029, Max-Change = 0.0064, Max-Change = 0.0027, Max-Change = 0.0031, Max-Change = 0.0058, Max-Change = 0.0016, Max-Change = 0.0053, Max-Change = 0.0072, Max-Change = 0.0033, Max-Change = 0.0039, Max-Change = 0.0022, Max-Change = 0.0007, Max-Change = 0.0051, Max-Change = 0.0033, Max-Change = 0.0080, Max-Change = 0.0002, Max-Change = 0.0058, Max-Change = 0.0062, Max-Change = 0.0022, Max-Change = 0.0057, Max-Change = 0.0069, Max-Change = 0.0036, Max-Change = 0.0060, Max-Change = 0.0029, Max-Change = 0.0026, Max-Change = 0.0299, Max-Change = 0.2000, Max-Change = 0.1639, Max-Change = 0.1292, Max-Change = 0.1037, Max-Change = 0.0829, Max-Change = 0.0664, Max-Change = 0.0535, Max-Change = 0.0437, Max-Change = 0.0355, Max-Change = 0.0283, Max-Change = 0.0235, Max-Change = 0.0175, Max-Change = 0.0152, Max-Change = 0.0153, Max-Change = 0.0231, Max-Change = 0.0063, Max-Change = 0.0045, Max-Change = 0.0074, Max-Change = 0.0044, Max-Change = 0.0056, Max-Change = 0.0098, Max-Change = 0.0075, Max-Change = 0.0089, Max-Change = 0.0108, Max-Change = 0.0033, Max-Change = 0.0033, Max-Change = 0.0062, Max-Change = 0.0066, Max-Change = 0.0032, Max-Change = 0.0053, Max-Change = 0.0077, Max-Change = 0.0038, Max-Change = 0.0057, Max-Change = 0.0071, Max-Change = 0.0045, Max-Change = 0.0057, Max-Change = 0.0061, Max-Change = 0.0061, Max-Change = 0.0074, Max-Change = 0.0060, Max-Change = 0.0066, Max-Change = 0.0060, Max-Change = 0.0051, Max-Change = 0.0044, Max-Change = 0.0030, Max-Change = 0.0045, Max-Change = 0.0051, Max-Change = 0.0025, Max-Change = 0.0069, Max-Change = 0.0128, Max-Change = 0.0046, Max-Change = 0.0040, Max-Change = 0.0050, Max-Change = 0.0057, Max-Change = 0.0039, Max-Change = 0.0118, Max-Change = 0.0069, Max-Change = 0.0013, Max-Change = 0.0098, Max-Change = 0.0022, Max-Change = 0.0044, Max-Change = 0.0037, Max-Change = 0.0042, Max-Change = 0.0016, Max-Change = 0.0075, Max-Change = 0.0030, Max-Change = 0.0032, Max-Change = 0.0015, Max-Change = 0.0054, Max-Change = 0.0126, Max-Change = 0.0052, Max-Change = 0.0021, Max-Change = 0.0019, Max-Change = 0.0039, Max-Change = 0.0047, Max-Change = 0.0017, Max-Change = 0.0019, Max-Change = 0.0037, Max-Change = 0.0034, Max-Change = 0.0032, Max-Change = 0.0063, Max-Change = 0.0045, Max-Change = 0.0045, Max-Change = 0.0030, Max-Change = 0.0101, Max-Change = 0.0064, Max-Change = 0.0066, Max-Change = 0.0053, Max-Change = 0.0060, Max-Change = 0.0033, Max-Change = 0.0017, Max-Change = 0.0057, Max-Change = 0.0090, Max-Change = 0.0031, Max-Change = 0.0090, Max-Change = 0.0023, Max-Change = 0.0039, Max-Change = 0.0068, Max-Change = 0.0060, Max-Change = 0.0010, Max-Change = 0.0057, Max-Change = 0.0067, Max-Change = 0.0083, Max-Change = 0.0023, Max-Change = 0.0111, Max-Change = 0.0054, Max-Change = 0.0019, Max-Change = 0.0048, Max-Change = 0.0041, Max-Change = 0.0031, Max-Change = 0.0006, Max-Change = 0.0029, Max-Change = 0.0027, Max-Change = 0.0039, Max-Change = 0.0027, Max-Change = 0.0057, Max-Change = 0.0057, Max-Change = 0.0110, Max-Change = 0.0085, Max-Change = 0.0038, Max-Change = 0.0022, Max-Change = 0.0019, Max-Change = 0.0063, Max-Change = 0.0008, Max-Change = 0.0045, Max-Change = 0.0031, Max-Change = 0.0067, Max-Change = 0.0115, Max-Change = 0.0080, Max-Change = 0.0109, Max-Change = 0.0121, Max-Change = 0.0054, Max-Change = 0.0061, Max-Change = 0.0035, Max-Change = 0.0059, Max-Change = 0.0068, Max-Change = 0.0051, Max-Change = 0.0044, Max-Change = 0.0056, Max-Change = 0.0012, Max-Change = 0.0063, Max-Change = 0.0033, Max-Change = 0.0112, Max-Change = 0.0041, Max-Change = 0.0027, Max-Change = 0.0042, Max-Change = 0.0075, Max-Change = 0.0049, Max-Change = 0.0047, Max-Change = 0.0068, Max-Change = 0.0030, Max-Change = 0.0051, Max-Change = 0.0024, Max-Change = 0.0057, Max-Change = 0.0050, Max-Change = 0.0002, Max-Change = 0.0052, Max-Change = 0.0055, Max-Change = 0.0037, Max-Change = 0.0029, Max-Change = 0.0027, Max-Change = 0.0012, Max-Change = 0.0041, Max-Change = 0.0054, Max-Change = 0.0045, Max-Change = 0.0024, Max-Change = 0.0076, Max-Change = 0.0037, Max-Change = 0.0038, Max-Change = 0.0011, Max-Change = 0.0031, Max-Change = 0.0027, Max-Change = 0.0102, Max-Change = 0.0067, Max-Change = 0.0052, Max-Change = 0.0031, Max-Change = 0.0067, Max-Change = 0.0038, Max-Change = 0.0037, Max-Change = 0.0032, Max-Change = 0.0042, Max-Change = 0.0063, Max-Change = 0.0016, Max-Change = 0.0034, Max-Change = 0.0044, Max-Change = 0.0095, Max-Change = 0.0022, Max-Change = 0.0031, Max-Change = 0.0012, Max-Change = 0.0093, Max-Change = 0.0037, Max-Change = 0.0012, Max-Change = 0.0037, Max-Change = 0.0020, Max-Change = 0.0027, Max-Change = 0.0040, Max-Change = 0.0106, Max-Change = 0.0037, Max-Change = 0.0047, Max-Change = 0.0016, gam = 0.0000, Max-Change = 0.0000, gam = 0.1778, Max-Change = 0.0040, gam = 0.1057, Max-Change = 0.0020, gam = 0.0780, Max-Change = 0.0043, gam = 0.0629, Max-Change = 0.0012, gam = 0.0532, Max-Change = 0.0010, gam = 0.0464, Max-Change = 0.0003, gam = 0.0413, Max-Change = 0.0012, gam = 0.0374, Max-Change = 0.0013, gam = 0.0342, Max-Change = 0.0010, gam = 0.0316, Max-Change = 0.0009, gam = 0.0294, Max-Change = 0.0004
#> 
#> Calculating log-likelihood...
coef(LLTM.e)
#> $Item_1
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.095         -1.018            0.054  1 0 0 1
#> 
#> $Item_2
#>     difficultyeasy difficultyhard difficultymedium a1 d g u
#> par          1.095         -1.018            0.054  1 0 0 1

...
#>  0.265  0.027  0.088  0.134  0.000  0.000 
...
#> TOTAL:   Data  Estep  Mstep     SE   Post 
#>  0.204  0.026  0.081  0.075  0.000  0.001 
...
#> $Item_1
#>       a1 a2      d g u
#> par 1.27  0 -0.919 0 1
#> 
#> $Item_2
#>        a1 a2      d g u
#> par 0.461  0 -1.459 0 1
#> 
#> $Item_3
#>        a1 a2     d g u
#> par 0.996  0 1.392 0 1
#> 
#> $Item_4
#>        a1    a2      d g u
#> par 1.035 0.349 -0.059 0 1
#> 
#> $Item_5
#>     a1    a2    d1    d2     d3
#> par  0 1.798 3.279 2.178 -0.559
#> 
#> $Item_6
#>     a1    a2    d1    d2    d3
#> par  0 0.481 2.692 1.081 -0.96
#> 
#> $Item_7
#>     a1    a2    d1    d2
#> par  0 0.908 1.942 -0.09
#> 
#> $Item_8
#>     a1    a2     d g u
#> par  0 0.897 0.986 0 1
#> 
#> $GroupPars
#>     MEAN_1 MEAN_2 COV_11 COV_21 COV_22
#> par      0      0      1  0.482      1
...
#> Item_2 0.262       0.068
#> Item_3 0.505       0.255
#> Item_4 0.512 0.173 0.292
#> Item_5       0.726 0.527
#> Item_6       0.272 0.074
#> Item_7       0.471 0.222
#> Item_8       0.466 0.217
#> 
#> SS loadings:  0.943 1.07 
#> Proportion Var:  0.118 0.134 
#> 
#> Factor correlations: 
#> 
#>       F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.054  -0.023  -0.002  -0.001   0.023   0.051 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1         0.002 -0.017 -0.002  0.023 -0.014 -0.013 -0.005
#> Item_2  0.006         0.040 -0.002 -0.051  0.034 -0.041 -0.047
#> Item_3  0.587  3.132         0.003  0.023 -0.018  0.036 -0.043
#> Item_4  0.007  0.005  0.013        -0.054  0.041  0.016 -0.022
#> Item_5  1.086  5.276  1.065  5.922        -0.033 -0.026  0.035
#> Item_6  0.420  2.368  0.654  3.420  6.470         0.023  0.051
#> Item_7  0.347  3.327  2.549  0.532  2.653  2.135         0.022
#> Item_8  0.050  4.505  3.642  0.984  2.467  5.212  1.000       
...
#> $Item_1
#>        a1    a2 a3      d g u
#> par 0.809 0.663  0 -0.854 0 1
#> 
#> $Item_2
#>        a1   a2 a3      d g u
#> par 0.146 0.79  0 -1.569 0 1
#> 
#> $Item_3
#>        a1   a2 a3     d g u
#> par 0.679 0.75  0 1.404 0 1
#> 
#> $Item_4
#>       a1    a2 a3      d g u
#> par 1.28 0.674  0 -0.057 0 1
#> 
#> $Item_5
#>        a1 a2    a3    d1    d2     d3
#> par 1.278  0 1.095 3.177 2.107 -0.537
#> 
#> $Item_6
#>        a1 a2    a3   d1    d2     d3
#> par 0.338  0 0.326 2.69 1.081 -0.956
#> 
#> $Item_7
#>        a1 a2    a3    d1     d2
#> par 0.671  0 0.648 1.961 -0.086
#> 
#> $Item_8
#>       a1 a2    a3     d g u
#> par 0.52  0 0.993 1.056 0 1
#> 
#> $GroupPars
...
summary(mod3)
#>            G    F1    F2    h2
#> Item_1 0.405 0.332       0.274
#> Item_2 0.078 0.420       0.182
#> Item_3 0.343 0.379       0.261
#> Item_4 0.573 0.302       0.419
#> Item_5 0.534       0.457 0.494
#> Item_6 0.191       0.185 0.071
#> Item_7 0.346       0.334 0.231
#> Item_8 0.255       0.487 0.303
#> 
#> SS loadings:  1.122 0.521 0.592 
#> Proportion Var:  0.14 0.065 0.074 
#> 
#> Factor correlations: 
#> 
#>    G F1 F2
...
#> Upper triangle summary:
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  -0.056  -0.023  -0.010  -0.001   0.022   0.050 
#> 
#>        Item_1 Item_2 Item_3 Item_4 Item_5 Item_6 Item_7 Item_8
#> Item_1        -0.009  0.005  0.008  0.023 -0.015 -0.014  0.014
#> Item_2  0.166         0.016 -0.013 -0.033  0.042  0.037 -0.027
#> Item_3  0.057  0.491        -0.011  0.021 -0.018  0.035 -0.028
#> Item_4  0.121  0.313  0.260        -0.056  0.042 -0.017  0.006
#> Item_5  1.047  2.212  0.901  6.259        -0.032 -0.026 -0.035
#> Item_6  0.440  3.605  0.672  3.450  6.322         0.023  0.050
#> Item_7  0.415  2.678  2.447  0.554  2.652  2.154        -0.022
#> Item_8  0.385  1.452  1.577  0.080  2.471  4.920  0.993       
anova(mod1,mod3)
#>           AIC    SABIC       HQ      BIC    logLik    X2 df     p
#> mod1 24916.56 24972.31 24963.86 25045.38 -12435.28               
#> mod3 24918.86 24989.15 24978.50 25081.29 -12430.43 9.698  6 0.138

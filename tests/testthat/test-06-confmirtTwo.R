...
test_that('confirmatory mods', {
    ...
    expect_class(mod1b, 'SingleGroupClass')
    ...
    expect_class(mod.quad, 'SingleGroupClass')
    ...
    expect_class(mod.combo, 'SingleGroupClass')
    ...
    expect_class(mod.combob, 'SingleGroupClass')

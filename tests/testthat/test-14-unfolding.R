...
test_that('GGUM', {
    ...
    fs <- fscores(mod2)
    expect_equal(as.vector(fs[1:6]), c(c(0.206416357734296,-1.2301835217175,-1.74276391715017,-1.74276391715017,0.544202269069832,-0.417442879912055)), tolerance = 1e-1)

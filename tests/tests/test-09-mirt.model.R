...
test_that('syntax', {
    ...
    expect_equal(mod2values(mod6)$value, c(1.043037,0,1.885188,0,1,1.043037,0,0.7985937,0,1,0,0.9906269,1.452324,0,1,0,0.9906269,0.5183299,0,1,0,0.9906269,1.981578,0,1,0,0,1,0.9999997,1),
                 tolerance = 1e-2)

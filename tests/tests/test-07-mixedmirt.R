...
test_that('polytomous', {
    ...
    expect_equal(cfs, c(1.0458,4.8686,4.0177,5.7195,2.6404,2.314,2.9668,-1.4691,-1.5549,-1.3834,1.2377,0.8783,1.597,2.9332,2.4585,3.4079,0.9035,0.647,1.1601,-2.2763,-2.6721,-1.8805,2.2356,5.1481,2.1737,-1.9378,1.1222,3.3691,0.9976,0.8133,1.1819,-1.7041,0,1,0.003),
                 tolerance = 1e-2)

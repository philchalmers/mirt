...
test_that('dich data', {
    ...
    ifit <- suppressWarnings(itemfit(mod1, digits = 20))
    ...
    cfs <- as.numeric(do.call(c, coef(simmod, digits=4)))
    cfs <- cfs[cfs != 0 & cfs != 1]
    expect_equal(cfs, c(1.1234,0.3098,-1.1358,0.8326,0.4819,0.232,1.3035,0.2981,1.1337,0.947,0.6705,-2.2982,1.0704,0.5185,0.4815,1.1162,0.4233,0.5898,1.0682,0.543,-0.6582,1.1688,0.6157,-0.5181,0.9157,0.487,-0.4848,1.1206,0.5928,-0.9723,1.0095,0.5492,-0.4864,1.0397,0.4951,-1.0031,0.9732,0.311,-0.7224,1.178,0.5228,0.0338,0.8942,0.477,0.8883,0.9172,0.5442,-0.0578,0.6707),
                 tolerance = 1e-2)
})

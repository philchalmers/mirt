...
test_that('dich data', {
    ...
    cfs <- as.numeric(do.call(c, coef(simmod, digits=4)))
    cfs <- cfs[cfs != 0 & cfs != 1]
    expect_equal(cfs, c(1.0149,0.3524,-1.1191,1.0059,0.367,0.3238,0.9751,0.4177,1.0756,0.9357,0.6421,-2.262,1.0085,0.7556,0.5104,0.93,0.5292,0.4097,1.145,0.5178,-0.6561,0.9185,0.59,-0.6172,0.8763,0.4253,-0.5544,1.025,0.6572,-0.9658,1.103,0.4656,-0.5422,1.1056,0.6408,-0.9886,1.0986,0.4648,-0.7034,1.0294,0.3837,-0.0146,0.9467,0.4413,0.8386,1.0023,0.6011,-0.0736,0.6697),
                 tolerance = 1e-2)
})
